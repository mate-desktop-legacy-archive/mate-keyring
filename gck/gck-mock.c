...
gck_mock_C_Initialize (CK_VOID_PTR pInitArgs)
{
	...
	gck_attributes_add_string (attrs, CKA_MATE_UNIQUE, "unique1");
	...
	gck_attributes_add_string (attrs, CKA_VALUE, "value");
	gck_attributes_add_string (attrs, CKA_MATE_UNIQUE, "unique2");
	...
	gck_attributes_add_string (attrs, CKA_VALUE, "value");
	gck_attributes_add_string (attrs, CKA_MATE_UNIQUE, "unique3");
	...
	gck_attributes_add_boolean (attrs, CKA_PRIVATE, CK_FALSE);
	gck_attributes_add_string (attrs, CKA_VALUE, "value");
	gck_attributes_add_string (attrs, CKA_MATE_UNIQUE, "unique4");
