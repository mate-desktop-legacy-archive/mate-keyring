...
void testing__setup__load_slots(int *__unused, gconstpointer __data)
{
 ...
 do { if (!(module)) g_printerr ("error: %s\n", err && err->message ? err->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((module) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 20, ((const char*) (__PRETTY_FUNCTION__)), "(module) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&err); } while(0);

 slots = gck_module_get_slots (module, (!(0)));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (slots != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 23, ((const char*) (__PRETTY_FUNCTION__)), "slots != NULL"); } while (0);
...
void testing__test__slot_info(int *__unused, gconstpointer __data)
{
 ...
 slots = gck_module_get_slots (module, (0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (2 == g_list_length (slots) && "wrong number of slots returned") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 44, ((const char*) (__PRETTY_FUNCTION__)), "2 == g_list_length (slots) && \"wrong number of slots returned\""); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((slots->data)); GType __t = ((gck_slot_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) && "missing slot one") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 45, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_SLOT (slots->data) && \"missing slot one\""); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((slots->next->data)); GType __t = ((gck_slot_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) && "missing slot two") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 46, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_SLOT (slots->next->data) && \"missing slot two\""); } while (0);

 for (l = slots; l; l = ((l) ? (((GList *)(l))->next) : ((void *)0))) {
  info = gck_slot_get_info (((((GckSlot*) g_type_check_instance_cast ((GTypeInstance*) ((l->data)), ((gck_slot_get_type())))))));
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (info != ((void *)0) && "no slot info") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 50, ((const char*) (__PRETTY_FUNCTION__)), "info != NULL && \"no slot info\""); } while (0);

  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST MANUFACTURER") && __builtin_constant_p (info->manufacturer_id) && (__s1_len = __builtin_strlen ("TEST MANUFACTURER"), __s2_len = __builtin_strlen (info->manufacturer_id), (!((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((info->manufacturer_id) + 1) - (size_t)(const void *)(info->manufacturer_id) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST MANUFACTURER", info->manufacturer_id) : (__builtin_constant_p ("TEST MANUFACTURER") && ((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) && (__s1_len = __builtin_strlen ("TEST MANUFACTURER"), __s1_len < 4) ? (__builtin_constant_p (info->manufacturer_id) && ((size_t)(const void *)((info->manufacturer_id) + 1) - (size_t)(const void *)(info->manufacturer_id) == 1) ? __builtin_strcmp ("TEST MANUFACTURER", info->manufacturer_id) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (info->manufacturer_id); register int __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (info->manufacturer_id) && ((size_t)(const void *)((info->manufacturer_id) + 1) - (size_t)(const void *)(info->manufacturer_id) == 1) && (__s2_len = __builtin_strlen (info->manufacturer_id), __s2_len < 4) ? (__builtin_constant_p ("TEST MANUFACTURER") && ((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) ? __builtin_strcmp ("TEST MANUFACTURER", info->manufacturer_id) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST MANUFACTURER"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (info->manufacturer_id))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (info->manufacturer_id))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (info->manufacturer_id))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (info->manufacturer_id))[3]); } } __result; }))) : __builtin_strcmp ("TEST MANUFACTURER", info->manufacturer_id)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 52, ((const char*) (__PRETTY_FUNCTION__)), "strcmp(\"TEST MANUFACTURER\", info->manufacturer_id) == 0"); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST SLOT") && __builtin_constant_p (info->slot_description) && (__s1_len = __builtin_strlen ("TEST SLOT"), __s2_len = __builtin_strlen (info->slot_description), (!((size_t)(const void *)(("TEST SLOT") + 1) - (size_t)(const void *)("TEST SLOT") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((info->slot_description) + 1) - (size_t)(const void *)(info->slot_description) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST SLOT", info->slot_description) : (__builtin_constant_p ("TEST SLOT") && ((size_t)(const void *)(("TEST SLOT") + 1) - (size_t)(const void *)("TEST SLOT") == 1) && (__s1_len = __builtin_strlen ("TEST SLOT"), __s1_len < 4) ? (__builtin_constant_p (info->slot_description) && ((size_t)(const void *)((info->slot_description) + 1) - (size_t)(const void *)(info->slot_description) == 1) ? __builtin_strcmp ("TEST SLOT", info->slot_description) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (info->slot_description); register int __result = (((__const unsigned char *) (__const char *) ("TEST SLOT"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST SLOT"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST SLOT"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST SLOT"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (info->slot_description) && ((size_t)(const void *)((info->slot_description) + 1) - (size_t)(const void *)(info->slot_description) == 1) && (__s2_len = __builtin_strlen (info->slot_description), __s2_len < 4) ? (__builtin_constant_p ("TEST SLOT") && ((size_t)(const void *)(("TEST SLOT") + 1) - (size_t)(const void *)("TEST SLOT") == 1) ? __builtin_strcmp ("TEST SLOT", info->slot_description) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST SLOT"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (info->slot_description))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (info->slot_description))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (info->slot_description))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (info->slot_description))[3]); } } __result; }))) : __builtin_strcmp ("TEST SLOT", info->slot_description)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 53, ((const char*) (__PRETTY_FUNCTION__)), "strcmp(\"TEST SLOT\", info->slot_description) == 0"); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (55 == info->hardware_version_major) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 54, ((const char*) (__PRETTY_FUNCTION__)), "55 == info->hardware_version_major"); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (155 == info->hardware_version_minor) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 55, ((const char*) (__PRETTY_FUNCTION__)), "155 == info->hardware_version_minor"); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (65 == info->firmware_version_major) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 56, ((const char*) (__PRETTY_FUNCTION__)), "65 == info->firmware_version_major"); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (165 == info->firmware_version_minor) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 57, ((const char*) (__PRETTY_FUNCTION__)), "165 == info->firmware_version_minor"); } while (0);

  if (info->flags & (1UL << 0)) {
   token = gck_slot_get_token_info (slot);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (token != ((void *)0) && "no token info") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 61, ((const char*) (__PRETTY_FUNCTION__)), "token != NULL && \"no token info\""); } while (0);

   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST MANUFACTURER") && __builtin_constant_p (token->manufacturer_id) && (__s1_len = __builtin_strlen ("TEST MANUFACTURER"), __s2_len = __builtin_strlen (token->manufacturer_id), (!((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((token->manufacturer_id) + 1) - (size_t)(const void *)(token->manufacturer_id) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST MANUFACTURER", token->manufacturer_id) : (__builtin_constant_p ("TEST MANUFACTURER") && ((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) && (__s1_len = __builtin_strlen ("TEST MANUFACTURER"), __s1_len < 4) ? (__builtin_constant_p (token->manufacturer_id) && ((size_t)(const void *)((token->manufacturer_id) + 1) - (size_t)(const void *)(token->manufacturer_id) == 1) ? __builtin_strcmp ("TEST MANUFACTURER", token->manufacturer_id) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (token->manufacturer_id); register int __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST MANUFACTURER"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (token->manufacturer_id) && ((size_t)(const void *)((token->manufacturer_id) + 1) - (size_t)(const void *)(token->manufacturer_id) == 1) && (__s2_len = __builtin_strlen (token->manufacturer_id), __s2_len < 4) ? (__builtin_constant_p ("TEST MANUFACTURER") && ((size_t)(const void *)(("TEST MANUFACTURER") + 1) - (size_t)(const void *)("TEST MANUFACTURER") == 1) ? __builtin_strcmp ("TEST MANUFACTURER", token->manufacturer_id) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST MANUFACTURER"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (token->manufacturer_id))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (token->manufacturer_id))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (token->manufacturer_id))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (token->manufacturer_id))[3]); } } __result; }))) : __builtin_strcmp ("TEST MANUFACTURER", token->manufacturer_id)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "strcmp (\"TEST MANUFACTURER\", token->manufacturer_id) == 0"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST LABEL") && __builtin_constant_p (token->label) && (__s1_len = __builtin_strlen ("TEST LABEL"), __s2_len = __builtin_strlen (token->label), (!((size_t)(const void *)(("TEST LABEL") + 1) - (size_t)(const void *)("TEST LABEL") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((token->label) + 1) - (size_t)(const void *)(token->label) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST LABEL", token->label) : (__builtin_constant_p ("TEST LABEL") && ((size_t)(const void *)(("TEST LABEL") + 1) - (size_t)(const void *)("TEST LABEL") == 1) && (__s1_len = __builtin_strlen ("TEST LABEL"), __s1_len < 4) ? (__builtin_constant_p (token->label) && ((size_t)(const void *)((token->label) + 1) - (size_t)(const void *)(token->label) == 1) ? __builtin_strcmp ("TEST LABEL", token->label) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (token->label); register int __result = (((__const unsigned char *) (__const char *) ("TEST LABEL"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST LABEL"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST LABEL"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST LABEL"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (token->label) && ((size_t)(const void *)((token->label) + 1) - (size_t)(const void *)(token->label) == 1) && (__s2_len = __builtin_strlen (token->label), __s2_len < 4) ? (__builtin_constant_p ("TEST LABEL") && ((size_t)(const void *)(("TEST LABEL") + 1) - (size_t)(const void *)("TEST LABEL") == 1) ? __builtin_strcmp ("TEST LABEL", token->label) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST LABEL"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (token->label))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (token->label))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (token->label))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (token->label))[3]); } } __result; }))) : __builtin_strcmp ("TEST LABEL", token->label)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "strcmp (\"TEST LABEL\", token->label) == 0"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST MODEL") && __builtin_constant_p (token->model) && (__s1_len = __builtin_strlen ("TEST MODEL"), __s2_len = __builtin_strlen (token->model), (!((size_t)(const void *)(("TEST MODEL") + 1) - (size_t)(const void *)("TEST MODEL") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((token->model) + 1) - (size_t)(const void *)(token->model) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST MODEL", token->model) : (__builtin_constant_p ("TEST MODEL") && ((size_t)(const void *)(("TEST MODEL") + 1) - (size_t)(const void *)("TEST MODEL") == 1) && (__s1_len = __builtin_strlen ("TEST MODEL"), __s1_len < 4) ? (__builtin_constant_p (token->model) && ((size_t)(const void *)((token->model) + 1) - (size_t)(const void *)(token->model) == 1) ? __builtin_strcmp ("TEST MODEL", token->model) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (token->model); register int __result = (((__const unsigned char *) (__const char *) ("TEST MODEL"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MODEL"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST MODEL"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST MODEL"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (token->model) && ((size_t)(const void *)((token->model) + 1) - (size_t)(const void *)(token->model) == 1) && (__s2_len = __builtin_strlen (token->model), __s2_len < 4) ? (__builtin_constant_p ("TEST MODEL") && ((size_t)(const void *)(("TEST MODEL") + 1) - (size_t)(const void *)("TEST MODEL") == 1) ? __builtin_strcmp ("TEST MODEL", token->model) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST MODEL"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (token->model))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (token->model))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (token->model))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (token->model))[3]); } } __result; }))) : __builtin_strcmp ("TEST MODEL", token->model)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 65, ((const char*) (__PRETTY_FUNCTION__)), "strcmp (\"TEST MODEL\", token->model) == 0"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("TEST SERIAL") && __builtin_constant_p (token->serial_number) && (__s1_len = __builtin_strlen ("TEST SERIAL"), __s2_len = __builtin_strlen (token->serial_number), (!((size_t)(const void *)(("TEST SERIAL") + 1) - (size_t)(const void *)("TEST SERIAL") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((token->serial_number) + 1) - (size_t)(const void *)(token->serial_number) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("TEST SERIAL", token->serial_number) : (__builtin_constant_p ("TEST SERIAL") && ((size_t)(const void *)(("TEST SERIAL") + 1) - (size_t)(const void *)("TEST SERIAL") == 1) && (__s1_len = __builtin_strlen ("TEST SERIAL"), __s1_len < 4) ? (__builtin_constant_p (token->serial_number) && ((size_t)(const void *)((token->serial_number) + 1) - (size_t)(const void *)(token->serial_number) == 1) ? __builtin_strcmp ("TEST SERIAL", token->serial_number) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (token->serial_number); register int __result = (((__const unsigned char *) (__const char *) ("TEST SERIAL"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST SERIAL"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("TEST SERIAL"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("TEST SERIAL"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (token->serial_number) && ((size_t)(const void *)((token->serial_number) + 1) - (size_t)(const void *)(token->serial_number) == 1) && (__s2_len = __builtin_strlen (token->serial_number), __s2_len < 4) ? (__builtin_constant_p ("TEST SERIAL") && ((size_t)(const void *)(("TEST SERIAL") + 1) - (size_t)(const void *)("TEST SERIAL") == 1) ? __builtin_strcmp ("TEST SERIAL", token->serial_number) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("TEST SERIAL"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (token->serial_number))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (token->serial_number))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (token->serial_number))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (token->serial_number))[3]); } } __result; }))) : __builtin_strcmp ("TEST SERIAL", token->serial_number)))); }) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 66, ((const char*) (__PRETTY_FUNCTION__)), "strcmp (\"TEST SERIAL\", token->serial_number) == 0"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (1 == token->max_session_count) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 67, ((const char*) (__PRETTY_FUNCTION__)), "1 == token->max_session_count"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (2 == token->session_count) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 68, ((const char*) (__PRETTY_FUNCTION__)), "2 == token->session_count"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (3 == token->max_rw_session_count) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 69, ((const char*) (__PRETTY_FUNCTION__)), "3 == token->max_rw_session_count"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (4 == token->rw_session_count) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "4 == token->rw_session_count"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (5 == token->max_pin_len) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 71, ((const char*) (__PRETTY_FUNCTION__)), "5 == token->max_pin_len"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (6 == token->min_pin_len) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 72, ((const char*) (__PRETTY_FUNCTION__)), "6 == token->min_pin_len"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (7 == token->total_public_memory) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "7 == token->total_public_memory"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (8 == token->free_public_memory) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "8 == token->free_public_memory"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (9 == token->total_private_memory) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 75, ((const char*) (__PRETTY_FUNCTION__)), "9 == token->total_private_memory"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (10 == token->free_private_memory) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 76, ((const char*) (__PRETTY_FUNCTION__)), "10 == token->free_private_memory"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (75 == token->hardware_version_major) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "75 == token->hardware_version_major"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (175 == token->hardware_version_minor) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "175 == token->hardware_version_minor"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (85 == token->firmware_version_major) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "85 == token->firmware_version_major"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (185 == token->firmware_version_minor) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 80, ((const char*) (__PRETTY_FUNCTION__)), "185 == token->firmware_version_minor"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (927623999 == token->utc_time) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 81, ((const char*) (__PRETTY_FUNCTION__)), "927623999 == token->utc_time"); } while (0);
...
void testing__test__slot_props(int *__unused, gconstpointer __data)
{
 ...
 g_object_get (slot, "module", &mod, "handle", &slot_id, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mod == module) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 98, ((const char*) (__PRETTY_FUNCTION__)), "mod == module"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (slot_id == 52) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 99, ((const char*) (__PRETTY_FUNCTION__)), "slot_id == 52"); } while (0);
...
void testing__test__slot_equals_hash(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (hash != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 112, ((const char*) (__PRETTY_FUNCTION__)), "hash != 0"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gck_slot_equal (slot, slot)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 114, ((const char*) (__PRETTY_FUNCTION__)), "gck_slot_equal (slot, slot)"); } while (0);

 other_mod = gck_module_new (gck_module_get_functions (module), 0);
 other_slot = g_object_new ((gck_slot_get_type()), "module", other_mod, "handle", gck_slot_get_handle (slot), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gck_slot_equal (slot, other_slot)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 118, ((const char*) (__PRETTY_FUNCTION__)), "gck_slot_equal (slot, other_slot)"); } while (0);
 g_object_unref (other_mod);
 g_object_unref (other_slot);

 obj = g_object_new (((GType) ((20) << (2))), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gck_slot_equal (slot, obj)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 123, ((const char*) (__PRETTY_FUNCTION__)), "!gck_slot_equal (slot, obj)"); } while (0);
 g_object_unref (obj);

 other_slot = g_object_new ((gck_slot_get_type()), "module", module, "handle", 8909, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gck_slot_equal (slot, obj)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "!gck_slot_equal (slot, obj)"); } while (0);
 g_object_unref (other_slot);
}
...
void testing__test__slot_mechanisms(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (2 == ((mechs)->len) && "wrong number of mech types returned") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 138, ((const char*) (__PRETTY_FUNCTION__)), "2 == gck_mechanisms_length (mechs) && \"wrong number of mech types returned\""); } while (0);

 for (i = 0; i < ((mechs)->len); ++i) {

  info = gck_slot_get_mechanism_info (slot, ((((CK_MECHANISM_TYPE*) (void *) (mechs)->data) [(i)])));
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (info != ((void *)0) && "no mech info returned") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "info != NULL && \"no mech info returned\""); } while (0);

  gck_mechanism_info_free (info);
 }

 (g_array_free(mechs, (!(0))));
}
...
void testing__test__token_info_match_null(int *__unused, gconstpointer __data)
{
 ...
 token = gck_slot_get_token_info (slot);
 match = (GckTokenInfo *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (GckTokenInfo); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (2147483647 * 2U + 1U) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));


 ret = _gck_token_info_match (match, token);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 162, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);
...
void testing__test__token_info_match_label(int *__unused, gconstpointer __data)
{
 ...
 ret = _gck_token_info_match (match, token);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 181, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);
...
void testing__test__token_info_match_different(int *__unused, gconstpointer __data)
{
 ...
 ret = _gck_token_info_match (match, token);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-slot.c", 200, ((const char*) (__PRETTY_FUNCTION__)), "!ret"); } while (0);
