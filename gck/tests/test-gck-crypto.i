...
# 1 "./../gck-test.h" 1
# 30 "test-gck.h" 2
# 12 "test-gck-crypto.c" 2

static GckModule *module = ((void *)0);
static GckSession *session = ((void *)0);
static GckSession *session_with_auth = ((void *)0);
...
void testing__setup__crypto_session(int *__unused, gconstpointer __data)
{
 ...
 do { if (!(module)) g_printerr ("error: %s\n", err && err->message ? err->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((module) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 32, ((const char*) (__PRETTY_FUNCTION__)), "(module) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&err); } while(0);

 slots = gck_module_get_slots (module, (!(0)));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (slots != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 35, ((const char*) (__PRETTY_FUNCTION__)), "slots != NULL"); } while (0);

 session = gck_slot_open_session (slots->data, 0, ((void *)0), &err);
 do { if (!(session)) g_printerr ("error: %s\n", err && err->message ? err->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((session) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 38, ((const char*) (__PRETTY_FUNCTION__)), "(session) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&err); } while(0);

 slot = gck_session_get_slot (session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (slot) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 41, ((const char*) (__PRETTY_FUNCTION__)), "slot"); } while (0);

 session_with_auth = gck_session_from_handle (slot, gck_session_get_handle (session), GCK_SESSION_AUTHENTICATE);
 g_signal_connect_data ((session_with_auth), ("discard-handle"), (((GCallback) (on_discard_handle_ignore))), (((void *)0)), ((void *)0), (GConnectFlags) 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (session_with_auth) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 45, ((const char*) (__PRETTY_FUNCTION__)), "session_with_auth"); } while (0);
...
find_key (GckSession *session, CK_ATTRIBUTE_TYPE method, CK_MECHANISM_TYPE mech)
{
 GList *objects, *l;
 GckAttributes *attrs;
 GckObject *object = ((void *)0);
 CK_MECHANISM_TYPE_PTR mechs;
 gsize n_mechs;

 attrs = gck_attributes_new ();
 gck_attributes_add_boolean (attrs, method, (!(0)));
 objects = gck_session_find_objects (session, attrs, ((void *)0), ((void *)0));
 gck_attributes_unref (attrs);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (objects) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "objects"); } while (0);

 for (l = objects; l; l = ((l) ? (((GList *)(l))->next) : ((void *)0))) {
  if (mech) {
   mechs = gck_object_get_data (l->data, ((1UL << 30) | 0x600UL), ((void *)0), &n_mechs, ((void *)0));
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mechs) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 84, ((const char*) (__PRETTY_FUNCTION__)), "mechs"); } while (0);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_mechs == sizeof (CK_MECHANISM_TYPE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 85, ((const char*) (__PRETTY_FUNCTION__)), "n_mechs == sizeof (CK_MECHANISM_TYPE)"); } while (0);
...
find_key_with_value (GckSession *session, const gchar *value)
{
 ...
 attrs = gck_attributes_new ();
 gck_attributes_add_string (attrs, (0x11UL), value);
 objects = gck_session_find_objects (session, attrs, ((void *)0), ((void *)0));
 gck_attributes_unref (attrs);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (objects) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 110, ((const char*) (__PRETTY_FUNCTION__)), "objects"); } while (0);
...
check_key_with_value (GckSession *session, GckObject *key, CK_OBJECT_CLASS klass, const gchar *value)
{
 ...
 attrs = gck_object_get (key, ((void *)0), ((void *)0), (0UL), (0x11UL), (2147483647L * 2UL + 1UL));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attrs) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "attrs"); } while (0);

 if (!gck_attributes_find_ulong (attrs, (0UL), &check))
  do { g_assertion_message (((gchar*) 0), "test-gck-crypto.c", 128, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == klass) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 129, ((const char*) (__PRETTY_FUNCTION__)), "check == klass"); } while (0);

 attr = gck_attributes_find (attrs, (0x11UL));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 132, ((const char*) (__PRETTY_FUNCTION__)), "attr"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gck_attribute_is_invalid (attr)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 133, ((const char*) (__PRETTY_FUNCTION__)), "!gck_attribute_is_invalid (attr)"); } while (0);
 do { guint64 __n1 = ((guint)(attr->length)), __n2 = ((guint)(strlen (value))); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(attr->length)" " " "==" " " "(guint)(strlen (value))", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr->value, value, attr->length) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 135, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr->value, value, attr->length) == 0"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((module)); GType __t = ((gck_module_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_MODULE (module)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gck_object_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_OBJECT (object)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 145, ((const char*) (__PRETTY_FUNCTION__)), "password"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!*password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 146, ((const char*) (__PRETTY_FUNCTION__)), "!*password"); } while (0);
...
{
 GckMechanism mech = { (((unsigned long) (1UL << 31)) | 1), ((void *)0), 0 };
 GError *error = ((void *)0);
 ...
 key = find_key (session, (0x104UL), (((unsigned long) (1UL << 31)) | 1));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (key) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "key"); } while (0);


 output = gck_session_encrypt (session, key, (((unsigned long) (1UL << 31)) | 1), (const guchar*)"blah blah", 10, &n_output, ((void *)0), &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 167, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_output == 10) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 168, ((const char*) (__PRETTY_FUNCTION__)), "n_output == 10"); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("BLAH BLAH"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 169, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"BLAH BLAH\"", __s1, "==", __s2); } while (0);
 g_free (output);


 gck_session_encrypt_async (session, key, &mech, (const guchar*)"second chance", 14, ((void *)0), fetch_async_result, &result);

 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);


 output = gck_session_encrypt_finish (session, result, &n_output, &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 180, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_output == 14) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 181, ((const char*) (__PRETTY_FUNCTION__)), "n_output == 14"); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("SECOND CHANCE"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"SECOND CHANCE\"", __s1, "==", __s2); } while (0);
 g_free (output);
...
void testing__test__decrypt(int *__unused, gconstpointer __data)
{
 ...
 key = find_key (session, (0x105UL), (((unsigned long) (1UL << 31)) | 1));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (key) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 200, ((const char*) (__PRETTY_FUNCTION__)), "key"); } while (0);


 output = gck_session_decrypt (session, key, (((unsigned long) (1UL << 31)) | 1), (const guchar*)"FRY???", 7, &n_output, ((void *)0), &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 204, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_output == 7) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 205, ((const char*) (__PRETTY_FUNCTION__)), "n_output == 7"); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("fry???"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 206, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"fry???\"", __s1, "==", __s2); } while (0);
 g_free (output);


 gck_session_decrypt_async (session, key, &mech, (const guchar*)"FAT CHANCE", 11, ((void *)0), fetch_async_result, &result);

 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 213, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);


 output = gck_session_decrypt_finish (session, result, &n_output, &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 217, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_output == 11) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 218, ((const char*) (__PRETTY_FUNCTION__)), "n_output == 11"); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("fat chance"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 219, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"fat chance\"", __s1, "==", __s2); } while (0);
 g_free (output);
...
void testing__test__login_context_specific(int *__unused, gconstpointer __data)
{
 ...
 key = find_key (session, (0x108UL), (((unsigned long) (1UL << 31)) | 2));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (key) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 237, ((const char*) (__PRETTY_FUNCTION__)), "key"); } while (0);


 output = gck_session_sign (session, key, (((unsigned long) (1UL << 31)) | 2), (const guchar*)"TV Monster", 11, &n_output, ((void *)0), &error);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (error && error->code == (0x101UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 241, ((const char*) (__PRETTY_FUNCTION__)), "error && error->code == CKR_USER_NOT_LOGGED_IN"); } while (0);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 242, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 242, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (output == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "output == NULL"); } while (0);
...
{
 GckMechanism mech = { (((unsigned long) (1UL << 31)) | 2), "my-prefix:", 10 };
 GError *error = ((void *)0);
 GAsyncResult *result = ((void *)0);
 GckObject *key;
 guchar *output;
 ...
 g_signal_connect_data ((module), ("authenticate-object"), (((GCallback) (authenticate_object))), (((void *)0)), ((void *)0), (GConnectFlags) 0);


 key = find_key (session_with_auth, (0x108UL), (((unsigned long) (1UL << 31)) | 2));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (key) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 262, ((const char*) (__PRETTY_FUNCTION__)), "key"); } while (0);


 output = gck_session_sign (session_with_auth, key, (((unsigned long) (1UL << 31)) | 2), (const guchar*)"Labarbara", 10, &n_output, ((void *)0), &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 266, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { guint64 __n1 = (n_output), __n2 = (24); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 267, ((const char*) (__PRETTY_FUNCTION__)), "n_output" " " "==" " " "24", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("signed-prefix:Labarbara"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 268, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"signed-prefix:Labarbara\"", __s1, "==", __s2); } while (0);
 g_free (output);


 gck_session_sign_async (session_with_auth, key, &mech, (const guchar*)"Conrad", 7, ((void *)0), fetch_async_result, &result);

 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 275, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);


 output = gck_session_sign_finish (session_with_auth, result, &n_output, &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 279, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { guint64 __n1 = (n_output), __n2 = (17); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 280, ((const char*) (__PRETTY_FUNCTION__)), "n_output" " " "==" " " "17", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = ((gchar*)output), *__s2 = ("my-prefix:Conrad"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-gck-crypto.c", 281, ((const char*) (__PRETTY_FUNCTION__)), "(gchar*)output" " " "==" " " "\"my-prefix:Conrad\"", __s1, "==", __s2); } while (0);
 g_free (output);
...
void testing__test__verify(int *__unused, gconstpointer __data)
{
 ...
 key = find_key (session, (0x10aUL), (((unsigned long) (1UL << 31)) | 2));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (key) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 301, ((const char*) (__PRETTY_FUNCTION__)), "key"); } while (0);


 ret = gck_session_verify (session, key, (((unsigned long) (1UL << 31)) | 2), (const guchar*)"Labarbara", 10,
                            (const guchar*)"signed-prefix:Labarbara", 24, ((void *)0), &error);
 do { if (!(ret)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 306, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);


 ret = gck_session_verify_full (session, key, &mech, (const guchar*)"Labarbara", 10,
                                 (const guchar*)"my-prefix:Loborboro", 20, ((void *)0), &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 311, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 311, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);


 gck_session_verify_async (session, key, &mech, (const guchar*)"Labarbara", 10,
                            (const guchar*)"my-prefix:Labarbara", 20, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 317, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 ret = gck_session_verify_finish (session, result, &error);
 do { if (!(ret)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 319, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 g_object_unref (result);


 result = ((void *)0);
 gck_session_verify_async (session, key, &mech, (const guchar*)"Labarbara", 10,
                            (const guchar*)"my-prefix:Labarxoro", 20, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 327, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 ret = gck_session_verify_finish (session, result, &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 329, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 329, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 g_object_unref (result);
...
{
 GckMechanism mech = { (((unsigned long) (1UL << 31)) | 3), "generate", 9 };
 ...
 gck_attributes_add_ulong (pub_attrs, (0UL), (2UL));
 prv_attrs = gck_attributes_new ();
 gck_attributes_add_ulong (prv_attrs, (0UL), (3UL));


 ret = gck_session_generate_key_pair_full (session, &mech, pub_attrs, prv_attrs,
                                            &pub_key, &prv_key, ((void *)0), &error);
 do { if (!(ret)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 352, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 g_object_unref (pub_key);
 g_object_unref (prv_key);


 mech.type = 0;
 pub_key = prv_key = ((void *)0);
 ret = gck_session_generate_key_pair_full (session, &mech, pub_attrs, prv_attrs,
                                            &pub_key, &prv_key, ((void *)0), &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 361, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 361, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (pub_key == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 362, ((const char*) (__PRETTY_FUNCTION__)), "pub_key == NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (prv_key == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 363, ((const char*) (__PRETTY_FUNCTION__)), "prv_key == NULL"); } while (0);


 mech.type = (((unsigned long) (1UL << 31)) | 3);
 gck_session_generate_key_pair_async (session, &mech, pub_attrs, prv_attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 369, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 ret = gck_session_generate_key_pair_finish (session, result, &pub_key, &prv_key, &error);
 do { if (!(ret)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 371, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 g_object_unref (result);
 g_object_unref (pub_key);
 g_object_unref (prv_key);
 ...
 gck_session_generate_key_pair_async (session, &mech, pub_attrs, prv_attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 382, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 ret = gck_session_generate_key_pair_finish (session, result, &pub_key, &prv_key, &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((ret) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 384, ((const char*) (__PRETTY_FUNCTION__)), "(ret) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 384, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 g_object_unref (result);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (pub_key == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 386, ((const char*) (__PRETTY_FUNCTION__)), "pub_key == NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (prv_key == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 387, ((const char*) (__PRETTY_FUNCTION__)), "prv_key == NULL"); } while (0);
...
{
 GckMechanism mech = { (((unsigned long) (1UL << 31)) | 4), "wrap", 4 };
 GError *error = ((void *)0);
 GAsyncResult *result = ((void *)0);
 ...
 wrapper = find_key (session, (0x106UL), 0);
 wrapped = find_key_with_value (session, "value");


 output = gck_session_wrap_key (session, wrapper, (((unsigned long) (1UL << 31)) | 4), wrapped, &n_output, ((void *)0), &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 407, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (output) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 408, ((const char*) (__PRETTY_FUNCTION__)), "output"); } while (0);
 do { guint64 __n1 = ((guint)(n_output)), __n2 = ((guint)(5)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 409, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(n_output)" " " "==" " " "(guint)(5)", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (output, "value", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 410, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (output, \"value\", 5) == 0"); } while (0);
 g_free (output);


 output = gck_session_wrap_key_full (session, wrapper, &mech, wrapped, &n_output, ((void *)0), &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 415, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { guint64 __n1 = ((guint)(n_output)), __n2 = ((guint)(5)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 416, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(n_output)" " " "==" " " "(guint)(5)", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (output, "value", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 417, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (output, \"value\", 5) == 0"); } while (0);
 g_free (output);
 ...
 n_output = 0;
 output = gck_session_wrap_key_full (session, wrapper, &mech, wrapped, &n_output, ((void *)0), &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 424, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 424, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 do { guint64 __n1 = ((guint)(n_output)), __n2 = ((guint)(0)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 425, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(n_output)" " " "==" " " "(guint)(0)", __n1, "==", __n2, 'i'); } while (0);


 mech.type = (((unsigned long) (1UL << 31)) | 4);
 gck_session_wrap_key_async (session, wrapper, &mech, wrapped, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 431, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 output = gck_session_wrap_key_finish (session, result, &n_output, &error);
 do { if (!(output)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 433, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { guint64 __n1 = ((guint)(n_output)), __n2 = ((guint)(5)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 434, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(n_output)" " " "==" " " "(guint)(5)", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (output, "value", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 435, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (output, \"value\", 5) == 0"); } while (0);
 g_object_unref (result);
 g_free (output);
 ...
 gck_session_wrap_key_async (session, wrapper, &mech, wrapped, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 445, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 output = gck_session_wrap_key_finish (session, result, &n_output, &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((output) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 447, ((const char*) (__PRETTY_FUNCTION__)), "(output) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 447, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 do { guint64 __n1 = ((guint)(n_output)), __n2 = ((guint)(0)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-gck-crypto.c", 448, ((const char*) (__PRETTY_FUNCTION__)), "(guint)(n_output)" " " "==" " " "(guint)(0)", __n1, "==", __n2, 'i'); } while (0);
 g_object_unref (result);
...
void testing__test__unwrap_key(int *__unused, gconstpointer __data)
{
 ...
 wrapper = find_key (session, (0x107UL), 0);
 attrs = gck_attributes_new ();
 gck_attributes_add_ulong (attrs, (0UL), (4UL));


 unwrapped = gck_session_unwrap_key_full (session, wrapper, &mech, "special", 7, attrs, ((void *)0), &error);
 do { if (!(unwrapped)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((unwrapped) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 469, ((const char*) (__PRETTY_FUNCTION__)), "(unwrapped) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((unwrapped)); GType __t = ((gck_object_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 470, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_OBJECT (unwrapped)"); } while (0);
 check_key_with_value (session, unwrapped, (4UL), "special");
 g_object_unref (unwrapped);


 mech.type = 0;
 unwrapped = gck_session_unwrap_key_full (session, wrapper, &mech, "special", 7, attrs, ((void *)0), &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((unwrapped) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 477, ((const char*) (__PRETTY_FUNCTION__)), "(unwrapped) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 477, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);


 mech.type = (((unsigned long) (1UL << 31)) | 4);
 gck_session_unwrap_key_async (session, wrapper, &mech, "special", 7, attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 483, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 unwrapped = gck_session_unwrap_key_finish (session, result, &error);
 do { if (!(unwrapped)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((unwrapped) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 485, ((const char*) (__PRETTY_FUNCTION__)), "(unwrapped) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((unwrapped)); GType __t = ((gck_object_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 486, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_OBJECT (unwrapped)"); } while (0);
 check_key_with_value (session, unwrapped, (4UL), "special");
 g_object_unref (unwrapped);
 g_object_unref (result);
 ...
 result = ((void *)0);
 mech.type = 0;
 gck_session_unwrap_key_async (session, wrapper, &mech, "special", 6, attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 496, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 unwrapped = gck_session_unwrap_key_finish (session, result, &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((unwrapped) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 498, ((const char*) (__PRETTY_FUNCTION__)), "(unwrapped) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 498, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 g_object_unref (result);
...
{
 GckMechanism mech = { (((unsigned long) (1UL << 31)) | 5), "derive", 6 };
 GError *error = ((void *)0);
 GAsyncResult *result = ((void *)0);
 GckObject *wrapper, *derived;
 GckAttributes *attrs;

 wrapper = find_key (session, (0x10cUL), 0);
 attrs = gck_attributes_new ();
 gck_attributes_add_ulong (attrs, (0UL), (4UL));


 derived = gck_session_derive_key_full (session, wrapper, &mech, attrs, ((void *)0), &error);
 do { if (!(derived)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((derived) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 519, ((const char*) (__PRETTY_FUNCTION__)), "(derived) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((derived)); GType __t = ((gck_object_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 520, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_OBJECT (derived)"); } while (0);
 check_key_with_value (session, derived, (4UL), "derived");
 g_object_unref (derived);


 mech.type = 0;
 derived = gck_session_derive_key_full (session, wrapper, &mech, attrs, ((void *)0), &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((derived) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 527, ((const char*) (__PRETTY_FUNCTION__)), "(derived) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 527, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);


 mech.type = (((unsigned long) (1UL << 31)) | 5);
 gck_session_derive_key_async (session, wrapper, &mech, attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 533, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 derived = gck_session_derive_key_finish (session, result, &error);
 do { if (!(derived)) g_printerr ("error: %s\n", error && error->message ? error->message : ""); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((derived) ? (!(0)) : (0) && "should have succeeded") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 535, ((const char*) (__PRETTY_FUNCTION__)), "(derived) ? TRUE : FALSE && \"should have succeeded\""); } while (0); g_clear_error (&error); } while(0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((derived)); GType __t = ((gck_object_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 536, ((const char*) (__PRETTY_FUNCTION__)), "GCK_IS_OBJECT (derived)"); } while (0);
 check_key_with_value (session, derived, (4UL), "derived");
 g_object_unref (derived);
 g_object_unref (result);
 ...
 gck_session_derive_key_async (session, wrapper, &mech, attrs, ((void *)0), fetch_async_result, &result);
 testing_wait_until (500);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 546, ((const char*) (__PRETTY_FUNCTION__)), "result != NULL"); } while (0);
 derived = gck_session_derive_key_finish (session, result, &error);
 do { do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((derived) ? (0) : (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 548, ((const char*) (__PRETTY_FUNCTION__)), "(derived) ? FALSE : TRUE"); } while (0); do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((error) && (error)->message && "error should be set") _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-gck-crypto.c", 548, ((const char*) (__PRETTY_FUNCTION__)), "(error) && (error)->message && \"error should be set\""); } while (0); g_clear_error (&error); } while (0);
 g_object_unref (result);
