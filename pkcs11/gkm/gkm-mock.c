...
gkm_mock_C_Initialize (CK_VOID_PTR pInitArgs)
{
	...
	gkm_template_set_string (attrs, CKA_MATE_UNIQUE, "unique1");
	...
	gkm_template_set_string (attrs, CKA_VALUE, "value");
	gkm_template_set_string (attrs, CKA_MATE_UNIQUE, "unique2");
	...
	gkm_template_set_string (attrs, CKA_VALUE, "value");
	gkm_template_set_string (attrs, CKA_MATE_UNIQUE, "unique3");
	...
	gkm_template_set_boolean (attrs, CKA_PRIVATE, CK_FALSE);
	gkm_template_set_string (attrs, CKA_VALUE, "value");
	gkm_template_set_string (attrs, CKA_MATE_UNIQUE, "unique4");
