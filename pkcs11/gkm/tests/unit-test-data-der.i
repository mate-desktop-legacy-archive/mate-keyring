# 1 "unit-test-data-der.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-data-der.c"
# 24 "unit-test-data-der.c"
# 1 "../../../config.h" 1
# 25 "unit-test-data-der.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-data-der.c" 2

# 1 "./../../gkm/gkm-crypto.h" 1
# 25 "./../../gkm/gkm-crypto.h"
# 1 "./../../gkm/gkm-types.h" 1
# 25 "./../../gkm/gkm-types.h"
...
# 28 "./../../gkm/gkm-crypto.h" 2

# 1 "../../../egg/egg-padding.h" 1
# 28 "../../../egg/egg-padding.h"
...
# 29 "unit-test-data-der.c" 2
# 1 "./../../gkm/gkm-data-asn1.h" 1
# 30 "./../../gkm/gkm-data-asn1.h"
gboolean gkm_data_asn1_read_mpi (GNode *asn,
                                                                gcry_mpi_t *mpi);

gboolean gkm_data_asn1_write_mpi (GNode *asn,
                                                                gcry_mpi_t mpi);
# 30 "unit-test-data-der.c" 2
# 1 "./../../gkm/gkm-data-der.h" 1
# 30 "./../../gkm/gkm-data-der.h"
...
# 32 "unit-test-data-der.c" 2


# 1 "../../../egg/egg-asn1-defs.h" 1
# 27 "../../../egg/egg-asn1-defs.h"
# 1 "/usr/include/libtasn1.h" 1 3 4
# 50 "/usr/include/libtasn1.h" 3 4
  typedef int asn1_retCode;
# 116 "/usr/include/libtasn1.h" 3 4
...
# 162 "/usr/include/libtasn1.h" 3 4
  extern asn1_retCode
  ...
  extern asn1_retCode asn1_delete_structure (ASN1_TYPE * structure);
  ...
  extern const char *asn1_find_structure_from_oid (ASN1_TYPE
           definitions,
           const char
           *oidValue);

  extern const char *asn1_check_version (const char *req_version);

  extern const char *asn1_strerror (asn1_retCode error);

  extern void asn1_perror (asn1_retCode error);
  ...
  extern void asn1_bit_der (const unsigned char *str, int bit_len,
         unsigned char *der, int *der_len);
...
# 305 "/usr/include/libtasn1.h" 3 4
  extern const char *libtasn1_strerror (asn1_retCode error)
    __attribute__ ((deprecated));


  extern void
    libtasn1_perror (asn1_retCode error) __attribute__ ((deprecated));
# 28 "../../../egg/egg-asn1-defs.h" 2

extern const ASN1_ARRAY_TYPE pkix_asn1_tab[];
extern const ASN1_ARRAY_TYPE pk_asn1_tab[];
# 35 "unit-test-data-der.c" 2
# 1 "../../../egg/egg-openssl.h" 1
# 29 "../../../egg/egg-openssl.h"
...
# 37 "unit-test-data-der.c" 2
# 45 "unit-test-data-der.c"
static GNode *certificate = ((void *)0);
static guchar *certificate_data = ((void *)0);
static gsize n_certificate_data = 0;

static GNode *certificate2 = ((void *)0);
static guchar *certificate2_data = ((void *)0);
static gsize n_certificate2_data = 0;

const gchar *rsapub = "(public-key (rsa" " (n #00AE4B381CF43F7DC24CF90827325E2FB2EB57EDDE29562DF391C8942AA8E6423410E2D3FE26381F9DE0395E74BF2D17621AE46992C72CF895F6FA5FBE98054FBF#)" " (e #010001#)))";



const gchar *rsaprv = "(private-key (rsa" " (n #00B78758D55EBFFAB61D07D0DC49B5309A6F1DA2AE51C275DFC2370959BB81AC0C39093B1C618E396161A0DECEB8768D0FFB14F197B96C3DA14190EE0F20D51315#)" " (e #010001#)" " (d #108BCAC5FDD35812981E6EC5957D98E2AB76E4064C47B861D27C2CC322C50792313C852B4164A035B42D261F1A09F9FFE8F477F9F78FF2EABBDA6BA875C671D7#)" " (p #00C357F11B19A18C66573D25D1E466D9AB8BCDDCDFE0B2E80BD46712C4BEC18EB7#)" " (q #00F0843B90A60EF7034CA4BE80414ED9497CABCC685143B388013FF989CBB0E093#)" " (u #12F2555F52EB56329A991CF0404B51C68AC921AD370A797860F550415FF987BD#)))";
...
const gchar *dsapub = "(public-key (dsa" " (p ##)" " (q #00FA214A1385C21BFEBAADAB240A2430C607D56271#)" " (g ##)" " (y ##)))";





const gchar *dsaprv = "(private-key (dsa" "  (p ##)" "  (q #00FA214A1385C21BFEBAADAB240A2430C607D56271#)" "  (g ##)" "  (y ##)" "  (x #00876F84F709D51108DFB0CBFA1F1C569C09C413EC#)))";
...
compare_keys (gcry_sexp_t key, gcry_sexp_t sexp)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't get key id for private key" && p == hash1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't get key id for private key\" && p == hash1"); } while (0);
 p = gcry_pk_get_keygrip (sexp, hash2);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't get key id for parsed private key" && p == hash2) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't get key id for parsed private key\" && p == hash2"); } while (0);
...
test_der_public (gcry_sexp_t key)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't encode public key" && data != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 103, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't encode public key\" && data != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("encoding is empty" && n_data > 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "\"encoding is empty\" && n_data > 0"); } while (0);


 ret = gkm_data_der_read_public_key (data, n_data, &sexp);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't decode public key" && ret == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 108, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't decode public key\" && ret == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("parsed key is empty" && sexp != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 109, ((const char*) (__PRETTY_FUNCTION__)), "\"parsed key is empty\" && sexp != NULL"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("key parsed differently" && compare_keys (key, sexp)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 112, ((const char*) (__PRETTY_FUNCTION__)), "\"key parsed differently\" && compare_keys (key, sexp)"); } while (0);
}
...
void testing__setup__preload(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (certificate) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "certificate"); } while (0);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (certificate2) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 123, ((const char*) (__PRETTY_FUNCTION__)), "certificate2"); } while (0);
}
...
void testing__test__der_rsa_public(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&key, ((void *)0), rsapub, strlen (rsapub));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);
...
void testing__test__der_dsa_public(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&key, ((void *)0), dsapub, strlen (dsapub));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);
...
test_der_private (gcry_sexp_t key)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't encode private key" && data != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 169, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't encode private key\" && data != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("encoding is empty" && n_data > 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 170, ((const char*) (__PRETTY_FUNCTION__)), "\"encoding is empty\" && n_data > 0"); } while (0);


 ret = gkm_data_der_read_private_key (data, n_data, &sexp);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't decode private key" && ret == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 174, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't decode private key\" && ret == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("parsed key is empty" && sexp != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 175, ((const char*) (__PRETTY_FUNCTION__)), "\"parsed key is empty\" && sexp != NULL"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("key parsed differently" && compare_keys (key, sexp)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 178, ((const char*) (__PRETTY_FUNCTION__)), "\"key parsed differently\" && compare_keys (key, sexp)"); } while (0);
...
void testing__test__der_rsa_private(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&key, ((void *)0), rsaprv, strlen (rsaprv));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);
...
void testing__test__der_dsa_private(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&key, ((void *)0), dsaprv, strlen (dsaprv));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);
...
void testing__test__der_dsa_private_parts(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&skey, ((void *)0), dsaprv, strlen (dsaprv));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);


 params = gkm_data_der_write_private_key_dsa_params (skey, &n_params);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("didn't encode dsa params" && params != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 218, ((const char*) (__PRETTY_FUNCTION__)), "\"didn't encode dsa params\" && params != NULL"); } while (0);
 key = gkm_data_der_write_private_key_dsa_part (skey, &n_key);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("didn't encode dsa key" && key != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "\"didn't encode dsa key\" && key != NULL"); } while (0);


 result = gkm_data_der_read_private_key_dsa_parts (key, n_key, params, n_params, &pkey);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't parse dsa parts" && result == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 224, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't parse dsa parts\" && result == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("parsing dsa parts resulted in null key" && pkey != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 225, ((const char*) (__PRETTY_FUNCTION__)), "\"parsing dsa parts resulted in null key\" && pkey != NULL"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("key parsed differently" && compare_keys (skey, pkey)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 228, ((const char*) (__PRETTY_FUNCTION__)), "\"key parsed differently\" && compare_keys (skey, pkey)"); } while (0);

 egg_secure_free (params);
 egg_secure_free (key);
}

const gchar *certpub = "(public-key (rsa " "(n ##) " "(e #010001#) ) )";
...
void testing__test__read_public_key_info(int *__unused, gconstpointer __data)
{
 ...
 data = egg_asn1x_get_raw_element (egg_asn1x_node (certificate, "tbsCertificate", "subjectPublicKeyInfo", ((void *)0)), &n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 248, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);

 res = gkm_data_der_read_public_key_info (data, n_data, &sexp);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 251, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sexp != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 252, ((const char*) (__PRETTY_FUNCTION__)), "sexp != NULL"); } while (0);

 if (!gcry_pk_get_keygrip (sexp, hash))
  do { g_assertion_message (((gchar*) 0), "unit-test-data-der.c", 255, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);

 gcry = gcry_sexp_sscan (&match, ((void *)0), certpub, strlen (certpub));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "gcry == 0"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (compare_keys (sexp, match)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 260, ((const char*) (__PRETTY_FUNCTION__)), "compare_keys (sexp, match)"); } while (0);
...
void testing__test__read_certificate(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 272, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (asn != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 273, ((const char*) (__PRETTY_FUNCTION__)), "asn != NULL"); } while (0);
...
void testing__test__write_certificate(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 284, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data == n_certificate_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 285, ((const char*) (__PRETTY_FUNCTION__)), "n_data == n_certificate_data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (data, certificate_data, n_data) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 286, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (data, certificate_data, n_data) == 0"); } while (0);
 g_free (data);
}
                                   ...
                                   GHashTable *headers, gpointer user_data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_quark_try_string ("CERTIFICATE") == type) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 300, ((const char*) (__PRETTY_FUNCTION__)), "g_quark_try_string (\"CERTIFICATE\") == type"); } while (0);


 res = gkm_data_der_read_certificate (data, n_data, &asn1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 304, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 keydata = egg_asn1x_encode (egg_asn1x_node (asn1, "tbsCertificate", "subjectPublicKeyInfo", ((void *)0)), ((void *)0), &n_keydata);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (keydata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 308, ((const char*) (__PRETTY_FUNCTION__)), "keydata"); } while (0);


 res = gkm_data_der_read_public_key_info (keydata, n_keydata, &sexp);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS || res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 312, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS || res == GKM_DATA_UNRECOGNIZED"); } while (0);
...
void testing__test__read_ca_certificates_public_key_info(int *__unused, gconstpointer __data)
{
 ...
 egg_openssl_pem_parse (data, n_data, on_ca_certificate_public_key_info, ((void *)0));
 g_free (data);
}
...
find_extension (GNode *asn, const guchar *data, gsize n_data, const gchar *oid, gsize *n_extension)
{
 ...
 for (index = 1; (!(0)); ++index) {
  ...
  node = egg_asn1x_node (asn, "tbsCertificate", "extensions", index, "extnID", ((void *)0));
  if (node == ((void *)0))
   return ((void *)0);

  exoid = egg_asn1x_get_oid_as_string (node);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (exoid) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 348, ((const char*) (__PRETTY_FUNCTION__)), "exoid"); } while (0);

  if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (exoid) && __builtin_constant_p (oid) && (__s1_len = __builtin_strlen (exoid), __s2_len = __builtin_strlen (oid), (!((size_t)(const void *)((exoid) + 1) - (size_t)(const void *)(exoid) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((oid) + 1) - (size_t)(const void *)(oid) == 1) || __s2_len >= 4)) ? __builtin_strcmp (exoid, oid) : (__builtin_constant_p (exoid) && ((size_t)(const void *)((exoid) + 1) - (size_t)(const void *)(exoid) == 1) && (__s1_len = __builtin_strlen (exoid), __s1_len < 4) ? (__builtin_constant_p (oid) && ((size_t)(const void *)((oid) + 1) - (size_t)(const void *)(oid) == 1) ? __builtin_strcmp (exoid, oid) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (oid); register int __result = (((__const unsigned char *) (__const char *) (exoid))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (exoid))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (exoid))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (exoid))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (oid) && ((size_t)(const void *)((oid) + 1) - (size_t)(const void *)(oid) == 1) && (__s2_len = __builtin_strlen (oid), __s2_len < 4) ? (__builtin_constant_p (exoid) && ((size_t)(const void *)((exoid) + 1) - (size_t)(const void *)(exoid) == 1) ? __builtin_strcmp (exoid, oid) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (exoid); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (oid))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (oid))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (oid))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (oid))[3]); } } __result; }))) : __builtin_strcmp (exoid, oid)))); }) == 0) {
   g_free (exoid);
   node = egg_asn1x_node (asn, "tbsCertificate", "extensions", index, "extnValue", ((void *)0));
   value = egg_asn1x_get_raw_value (node, n_extension);
   do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 354, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
   return value;
  }
 ...
 do { g_assertion_message (((gchar*) 0), "unit-test-data-der.c", 361, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
}
...
void testing__test__read_basic_constraints(int *__unused, gconstpointer __data)
{
 ...
 extension = egg_asn1x_get_raw_value (egg_asn1x_node (certificate, "tbsCertificate", "extensions", 1, "extnValue", ((void *)0)),
                                        &n_extension);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (extension) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 374, ((const char*) (__PRETTY_FUNCTION__)), "extension"); } while (0);

 res = gkm_data_der_read_basic_constraints (extension, n_extension, &is_ca, &path_len);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 377, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (is_ca == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 378, ((const char*) (__PRETTY_FUNCTION__)), "is_ca == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (path_len == -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 379, ((const char*) (__PRETTY_FUNCTION__)), "path_len == -1"); } while (0);
}
...
void testing__test__read_key_usage(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (extension) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 390, ((const char*) (__PRETTY_FUNCTION__)), "extension"); } while (0);

 res = gkm_data_der_read_key_usage (extension, n_extension, &key_usage);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 393, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { guint64 __n1 = (key_usage), __n2 = (0x01); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-data-der.c", 394, ((const char*) (__PRETTY_FUNCTION__)), "key_usage" " " "==" " " "0x01", __n1, "==", __n2, 'i'); } while (0);
}
...
void testing__test__read_enhanced_usage(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (extension) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 405, ((const char*) (__PRETTY_FUNCTION__)), "extension"); } while (0);

 res = gkm_data_der_read_enhanced_usage (extension, n_extension, &usages);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 408, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
...
void testing__test__read_all_pkcs8(int *__unused, gconstpointer __data)
{
 ...
 dir = g_dir_open (testing_data_directory (), 0, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (dir) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 423, ((const char*) (__PRETTY_FUNCTION__)), "dir"); } while (0);
 ...
 for(;;) {
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 435, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_sexp_parse_key (sexp, ((void *)0), ((void *)0), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 437, ((const char*) (__PRETTY_FUNCTION__)), "gkm_sexp_parse_key (sexp, NULL, NULL, NULL)"); } while (0);
  gcry_sexp_release (sexp);
  g_free (data);
 }
...
void testing__test__read_pkcs8_bad_password(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 454, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);
...
void testing__test__write_pkcs8_plain(int *__unused, gconstpointer __data)
{
 ...
 gcry = gcry_sexp_sscan (&sexp, ((void *)0), rsaprv, strlen (rsaprv));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);

 data = gkm_data_der_write_private_pkcs8_plain (sexp, &n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 473, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 474, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);

 res = gkm_data_der_read_private_pkcs8_plain (data, n_data, &check);
 egg_secure_free (data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 478, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 479, ((const char*) (__PRETTY_FUNCTION__)), "check"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (compare_keys (sexp, check)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 481, ((const char*) (__PRETTY_FUNCTION__)), "compare_keys (sexp, check)"); } while (0);
 gcry_sexp_release (sexp);
 ...
 gcry = gcry_sexp_sscan (&sexp, ((void *)0), dsaprv, strlen (dsaprv));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gcry == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "gcry == 0"); return; }; }while (0);

 data = gkm_data_der_write_private_pkcs8_plain (sexp, &n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 492, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 493, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);

 res = gkm_data_der_read_private_pkcs8_plain (data, n_data, &check);
 egg_secure_free (data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 497, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 498, ((const char*) (__PRETTY_FUNCTION__)), "check"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (compare_keys (sexp, check)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 500, ((const char*) (__PRETTY_FUNCTION__)), "compare_keys (sexp, check)"); } while (0);
 gcry_sexp_release (sexp);
 gcry_sexp_release (check);
}
...
void testing__test__write_pkcs8_encrypted(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 520, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 521, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);

 res = gkm_data_der_read_private_pkcs8_crypted (data, n_data, "testo", 5, &check);
 g_free (data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 525, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 526, ((const char*) (__PRETTY_FUNCTION__)), "check"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (compare_keys (sexp, check)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 528, ((const char*) (__PRETTY_FUNCTION__)), "compare_keys (sexp, check)"); } while (0);
 gcry_sexp_release (sexp);
 gcry_sexp_release (check);
 ...
 data = gkm_data_der_write_private_pkcs8_crypted (sexp, "testo", 5, &n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 539, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 540, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);

 res = gkm_data_der_read_private_pkcs8_crypted (data, n_data, "testo", 5, &check);
 g_free (data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 544, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 545, ((const char*) (__PRETTY_FUNCTION__)), "check"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (compare_keys (sexp, check)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-der.c", 547, ((const char*) (__PRETTY_FUNCTION__)), "compare_keys (sexp, check)"); } while (0);
 gcry_sexp_release (sexp);
 gcry_sexp_release (check);
}
