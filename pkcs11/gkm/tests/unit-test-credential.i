# 1 "unit-test-credential.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-credential.c"
# 24 "unit-test-credential.c"
# 1 "test-suite.h" 1
...
# 26 "unit-test-credential.c" 2
# 1 "mock-locked-object.h" 1
# 27 "mock-locked-object.h"
# 1 "./../gkm-object.h" 1
# 27 "./../gkm-object.h"
# 1 "../../../pkcs11/pkcs11.h" 1
# 28 "./../gkm-object.h" 2
...
gboolean gkm_object_has_attribute_boolean (GkmObject *self,
                                                          ...
                                                          CK_ATTRIBUTE_TYPE type,
                                                          gboolean value);
# 28 "mock-locked-object.h" 2
# 37 "mock-locked-object.h"
...
gboolean gkm_credential_for_each (GkmSession *self,
                                                                  ...
                                                                  gpointer user_data);
# 30 "unit-test-credential.c" 2
# 1 "./../../gkm/gkm-object.h" 1
# 31 "unit-test-credential.c" 2
...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 33 "unit-test-credential.c" 2
# 1 "./../../gkm/gkm-module.h" 1
# 34 "unit-test-credential.c" 2
...
void testing__setup__credential_setup(int *__unused, gconstpointer __data)
{
 ...
 session = test_module_open_session ((!(0)));

 rv = gkm_module_C_Login (module, gkm_session_get_handle (session), (1UL), ((void *)0), 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 48, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 object = mock_locked_object_new (module, gkm_module_get_manager (module));
 gkm_object_expose (object, (!(0)));
}
...
void testing__test__credential_create(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  ...
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 202), &locked, sizeof (locked) },
  { (0x11UL), "mock", 4 },
 };
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (handle != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 80, ((const char*) (__PRETTY_FUNCTION__)), "handle != 0"); } while (0);

 rv = gkm_session_C_DestroyObject (session, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 83, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
}
...
void testing__test__credential_create_missing_pin(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x101UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_USER_NOT_LOGGED_IN"); } while (0);
}
...
void testing__test__credential_create_no_object(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (handle != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 120, ((const char*) (__PRETTY_FUNCTION__)), "handle != 0"); } while (0);

 attr.type = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 202);
 attr.pValue = &objhand;
 attr.ulValueLen = sizeof (objhand);
 rv = gkm_session_C_GetAttributeValue (session, handle, &attr, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 126, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (objhand == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "objhand == 0"); } while (0);
}
...
void testing__test__credential_create_invalid_object(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x82UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 146, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OBJECT_HANDLE_INVALID"); } while (0);
}
...
void testing__test__credential_get_attributes(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 166, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (handle != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 167, ((const char*) (__PRETTY_FUNCTION__)), "handle != 0"); } while (0);

 check.type = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 202);
 check.pValue = &value;
 check.ulValueLen = sizeof (value);

 rv = gkm_session_C_GetAttributeValue (session, handle, &check, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 174, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == sizeof (value)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 175, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == sizeof (value)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value == locked) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "value == locked"); } while (0);
}
...
void testing__test__credential_object_property(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, ((void *)0), object, (guchar*)"mock", 4, &auth);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 186, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (auth) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 187, ((const char*) (__PRETTY_FUNCTION__)), "auth"); } while (0);

 g_object_get (auth, "object", &check, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 190, ((const char*) (__PRETTY_FUNCTION__)), "check == object"); } while (0);
 g_object_unref (check);

 check = gkm_credential_get_object (auth);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 194, ((const char*) (__PRETTY_FUNCTION__)), "check == object"); } while (0);
...
void testing__test__credential_login_property(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, ((void *)0), object, (guchar*)"mock", 4, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 208, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (cred) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 209, ((const char*) (__PRETTY_FUNCTION__)), "cred"); } while (0);

 g_object_get (cred, "secret", &check, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 212, ((const char*) (__PRETTY_FUNCTION__)), "check"); } while (0);
 password = gkm_secret_get_password (check, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_password == 4) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 214, ((const char*) (__PRETTY_FUNCTION__)), "n_password == 4"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (password, "mock", 4) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 215, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (password, \"mock\", 4) == 0"); } while (0);
 g_object_unref (check);

 check = gkm_credential_get_secret (cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_password == 4) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 219, ((const char*) (__PRETTY_FUNCTION__)), "n_password == 4"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (password, "mock", 4) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (password, \"mock\", 4) == 0"); } while (0);

 secret = gkm_secret_new ((guchar*)"xxx", -1);
 gkm_credential_set_secret (cred, secret);
 check = gkm_credential_get_secret (cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 225, ((const char*) (__PRETTY_FUNCTION__)), "check == secret"); } while (0);
...
void testing__test__credential_data(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, ((void *)0), object, (guchar*)"mock", 4, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 250, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (cred) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 251, ((const char*) (__PRETTY_FUNCTION__)), "cred"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_credential_peek_data (cred, type) == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 253, ((const char*) (__PRETTY_FUNCTION__)), "gkm_credential_peek_data (cred, type) == NULL"); } while (0);

 gkm_credential_set_data (cred, type, "one");

 check = gkm_credential_pop_data (cred, type);
 do { const char *__s1 = ("one"), *__s2 = (check); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-credential.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "\"one\"" " " "==" " " "check", __s1, "==", __s2); } while (0);
 g_free (check);

 do { const char *__s1 = ("one"), *__s2 = (gkm_credential_peek_data (cred, type)); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-credential.c", 261, ((const char*) (__PRETTY_FUNCTION__)), "\"one\"" " " "==" " " "gkm_credential_peek_data (cred, type)", __s1, "==", __s2); } while (0);

 gkm_credential_set_data (cred, type, "ONE");
 do { const char *__s1 = ("ONE"), *__s2 = (gkm_credential_peek_data (cred, type)); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-credential.c", 264, ((const char*) (__PRETTY_FUNCTION__)), "\"ONE\"" " " "==" " " "gkm_credential_peek_data (cred, type)", __s1, "==", __s2); } while (0);

 gkm_credential_set_data (cred, 0, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_credential_peek_data (cred, 0) == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 267, ((const char*) (__PRETTY_FUNCTION__)), "gkm_credential_peek_data (cred, 0) == NULL"); } while (0);
...
void testing__test__credential_connect_object(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, ((void *)0), ((void *)0), (guchar*)"mock", 4, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 278, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (cred) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 279, ((const char*) (__PRETTY_FUNCTION__)), "cred"); } while (0);

 gkm_credential_connect (cred, object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_credential_get_object (cred) == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-credential.c", 282, ((const char*) (__PRETTY_FUNCTION__)), "gkm_credential_get_object (cred) == object"); } while (0);
