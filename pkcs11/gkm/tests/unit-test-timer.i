...
# 26 "unit-test-timer.c" 2

# 1 "./../../gkm/gkm-timer.h" 1
# 27 "./../../gkm/gkm-timer.h"
# 1 "./../../gkm/gkm-types.h" 1
# 28 "./../../gkm/gkm-timer.h" 2
...
timer_callback (GkmTimer *timer, gpointer user_data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 51, ((const char*) (__PRETTY_FUNCTION__)), "timer"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer == *value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 52, ((const char*) (__PRETTY_FUNCTION__)), "timer == *value"); } while (0);
 *value = ((void *)0);
}
...
void testing__test__timer_simple(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 66, ((const char*) (__PRETTY_FUNCTION__)), "timer == NULL"); } while (0);
}
...
void testing__test__timer_cancel(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "timer != NULL"); } while (0);
}
...
void testing__test__timer_immediate(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 97, ((const char*) (__PRETTY_FUNCTION__)), "timer != NULL"); } while (0);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "timer == NULL"); } while (0);
}

static GkmTimer *timer_last = ((void *)0);
...
multiple_callback (GkmTimer *timer, gpointer user_data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 114, ((const char*) (__PRETTY_FUNCTION__)), "timer"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer != timer_last) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 115, ((const char*) (__PRETTY_FUNCTION__)), "timer != timer_last"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value == timer_check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 116, ((const char*) (__PRETTY_FUNCTION__)), "value == timer_check"); } while (0);
 timer_last = timer;
 timer_check += 1;
}
...
void testing__test__timer_multiple(int *__unused, gconstpointer __data)
{
 ...
 gkm_timer_start (module, 1, multiple_callback, ((gpointer) (1)));
 gkm_timer_start (module, 3, multiple_callback, ((gpointer) (3)));
 gkm_timer_start (module, 2, multiple_callback, ((gpointer) (2)));
 gkm_timer_start (module, 0, multiple_callback, ((gpointer) (0)));

 test_module_leave ();
 testing_wait_until (3500);
 test_module_enter ();

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (timer_check == 4) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-timer.c", 135, ((const char*) (__PRETTY_FUNCTION__)), "timer_check == 4"); } while (0);
}

void testing__test__timer_outstanding(int *__unused, gconstpointer __data)
{

 gkm_timer_start (module, 5, timer_callback, ((void *)0));
 gkm_timer_start (module, 10, timer_callback, ((void *)0));
 gkm_timer_start (module, 1, timer_callback, ((void *)0));
}
