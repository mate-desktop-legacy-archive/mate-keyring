...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 30 "unit-test-object.c" 2
# 1 "./../../gkm/gkm-module.h" 1
# 31 "unit-test-object.c" 2
...
{
 CK_BBOOL token;
 CK_ATTRIBUTE attr = { (1UL), &token, sizeof (token) };
 CK_RV rv;
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 69, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 return (!(0));
}

void testing__test__object_create_destroy_transient(int *__unused, gconstpointer __data)
{
 CK_BBOOL transient = 1;
 CK_BBOOL token = 1;
 CK_OBJECT_CLASS klass = (1UL);
 CK_CERTIFICATE_TYPE type = (0UL);

 CK_ATTRIBUTE attrs[] = {
         { (1UL), &token, sizeof (token) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 201), &transient, sizeof (transient) },
  { (0UL), &klass, sizeof (klass) },
  { (0x80UL), &type, sizeof (type) },
  { (0x11UL), certificate_data, certificate_n_data },
 };

 CK_ATTRIBUTE lookup = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 201), &transient, sizeof (transient) };
 CK_OBJECT_HANDLE handle;
 CK_RV rv;

 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (handle != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "handle != 0"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check_object_exists (handle)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "check_object_exists (handle)"); } while (0);

 transient = 0;
 rv = gkm_session_C_GetAttributeValue (session, handle, &lookup, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (transient == 1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 101, ((const char*) (__PRETTY_FUNCTION__)), "transient == CK_TRUE"); } while (0);

 rv = gkm_session_C_DestroyObject (session, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!check_object_exists (handle)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "!check_object_exists (handle)"); } while (0);
}
...
void testing__test__object_transient_transacted_fail(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  ...
  { (0x406UL), &invalid, sizeof (invalid) }
 };
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x12UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 132, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_TYPE_INVALID"); } while (0);
}
...
void testing__test__object_create_transient_bad_value(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 201), ((void *)0), 0 },
  { (0UL), &klass, sizeof (klass) },
  { (0x80UL), &type, sizeof (type) },
  { (0x11UL), certificate_data, certificate_n_data },
 };
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 152, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}
...
void testing__test__object_create_auto_destruct(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 191), &lifetime, sizeof (lifetime) },
  { (1UL), &token, sizeof (token) },
  { (0UL), &klass, sizeof (klass) },
  { (0x80UL), &type, sizeof (type) },
  { (0x11UL), certificate_data, certificate_n_data },
 ...
 CK_ATTRIBUTE lookups[] = {
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 191), &check, sizeof (check) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 201), &transient, sizeof (transient) }
 };
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (handle != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 183, ((const char*) (__PRETTY_FUNCTION__)), "handle != 0"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check_object_exists (handle)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 185, ((const char*) (__PRETTY_FUNCTION__)), "check_object_exists (handle)"); } while (0);

 transient = 0;
 rv = gkm_session_C_GetAttributeValue (session, handle, lookups, (sizeof (lookups) / sizeof ((lookups)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 189, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (transient == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 190, ((const char*) (__PRETTY_FUNCTION__)), "transient == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (&lifetime, &check, sizeof (lifetime)) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 191, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (&lifetime, &check, sizeof (lifetime)) == 0"); } while (0);

 test_module_leave ();
 testing_wait_until (2200);
 test_module_enter ();

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!check_object_exists (handle)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 197, ((const char*) (__PRETTY_FUNCTION__)), "!check_object_exists (handle)"); } while (0);
}
...
void testing__test__object_create_auto_destruct_not_transient(int *__unused, gconstpointer __data)
{
 CK_OBJECT_CLASS klass = (1UL);
 CK_CERTIFICATE_TYPE type = (0UL);
 CK_BBOOL transient = 0;
 CK_ULONG after = 1;

 CK_ATTRIBUTE attrs[] = {
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 191), &after, sizeof (after) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 201), &transient, sizeof (transient) },
  { (0UL), &klass, sizeof (klass) },
  { (0x80UL), &type, sizeof (type) },
  { (0x11UL), certificate_data, certificate_n_data },
 ...
 rv = gkm_session_C_CreateObject (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0xd1UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_TEMPLATE_INCONSISTENT"); } while (0);
}
...
void testing__test__object_expose(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 237, ((const char*) (__PRETTY_FUNCTION__)), "check == object"); } while (0);

 gkm_object_expose (object, (0));


 check = gkm_manager_find_by_handle (manager, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "check == NULL"); } while (0);
}
...
void testing__test__object_expose_transaction(int *__unused, gconstpointer __data)
{
 ...
 gkm_object_expose (object, (0));
 check = gkm_manager_find_by_handle (manager, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 262, ((const char*) (__PRETTY_FUNCTION__)), "check == NULL"); } while (0);


 gkm_object_expose_full (object, transaction, (!(0)));
 check = gkm_manager_find_by_handle (manager, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 267, ((const char*) (__PRETTY_FUNCTION__)), "check == object"); } while (0);
 ...
 check = gkm_manager_find_by_handle (manager, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-object.c", 274, ((const char*) (__PRETTY_FUNCTION__)), "check == NULL"); } while (0);
