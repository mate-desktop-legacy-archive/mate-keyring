# 1 "unit-test-memory-store.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-memory-store.c"
# 24 "unit-test-memory-store.c"
...
gboolean gkm_object_has_attribute_boolean (GkmObject *self,
                                                          ...
                                                          CK_ATTRIBUTE_TYPE type,
                                                          gboolean value);
# 33 "unit-test-memory-store.c" 2
# 1 "./../../gkm/gkm-memory-store.h" 1
# 27 "./../../gkm/gkm-memory-store.h"
# 1 "./../../gkm/gkm-store.h" 1
# 31 "./../../gkm/gkm-store.h"
enum {
...
void gkm_store_notify_attribute (GkmStore *self,
                                                           GkmObject *object,
                                                           CK_ATTRIBUTE_TYPE type);
# 28 "./../../gkm/gkm-memory-store.h" 2
# 37 "./../../gkm/gkm-memory-store.h"
...
# 35 "unit-test-memory-store.c" 2

static GkmModule *module = ((void *)0);
static GkmStore *store = ((void *)0);
static GkmObject *object = ((void *)0);
static GkmTransaction *transaction = ((void *)0);
...
test_validator (GkmObject *obj, CK_ATTRIBUTE_PTR attr)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (obj == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 48, ((const char*) (__PRETTY_FUNCTION__)), "obj == object"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 49, ((const char*) (__PRETTY_FUNCTION__)), "attr"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr->type == (3UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 50, ((const char*) (__PRETTY_FUNCTION__)), "attr->type == CKA_LABEL"); } while (0);


 data = attr->pValue;
 for (i = 0; i < attr->ulValueLen; ++i) {
  if (!((g_ascii_table[(guchar) (data[i])] & G_ASCII_PRINT) != 0) || !((g_ascii_table[(guchar) (data[i])] & G_ASCII_LOWER) != 0))
   return (0x13UL);
 }
...
void testing__setup__memory_store(int *__unused, gconstpointer __data)
{
 ...
 store = ((((GkmStore*) g_type_check_instance_cast ((GTypeInstance*) ((gkm_memory_store_new ())), ((gkm_store_get_type ()))))));

 gkm_store_register_schema (store, &attr, test_validator, 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_store_lookup_schema (store, (3UL), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 76, ((const char*) (__PRETTY_FUNCTION__)), "gkm_store_lookup_schema (store, CKA_LABEL, NULL)"); } while (0);

 attr.type = (0x11UL);
 attr.pValue = ((void *)0);
 attr.ulValueLen = 0;

 gkm_store_register_schema (store, &attr, ((void *)0), GKM_STORE_IS_SENSITIVE);

 attr.type = (0x406UL);
 attr.pValue = &twentyfour;
 attr.ulValueLen = sizeof (twentyfour);

 gkm_store_register_schema (store, &attr, ((void *)0), GKM_STORE_IS_INTERNAL);

 object = g_object_new ((gkm_object_get_type ()), "module", module, ((void *)0));
...
void testing__test__get_attribute_default(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 120, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 5"); } while (0);
 attr.pValue = buffer;
 rv = gkm_store_get_attribute (store, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 123, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 124, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 5"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, "label", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, \"label\", 5) == 0"); } while (0);
}
...
void testing__test__read_value_default(int *__unused, gconstpointer __data)
{
 ...
 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_value == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 135, ((const char*) (__PRETTY_FUNCTION__)), "n_value == 5"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (value, "label", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 136, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (value, \"label\", 5) == 0"); } while (0);

 value = gkm_store_read_value (store, object, (0x406UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 139, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_value == sizeof (CK_ULONG)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 140, ((const char*) (__PRETTY_FUNCTION__)), "n_value == sizeof (CK_ULONG)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (*((CK_ULONG_PTR)value) == 24) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 141, ((const char*) (__PRETTY_FUNCTION__)), "*((CK_ULONG_PTR)value) == 24"); } while (0);
}
...
void testing__test__read_string(int *__unused, gconstpointer __data)
{
 ...
 str = gkm_store_read_string (store, object, (3UL));
 do { const char *__s1 = (str), *__s2 = ("label"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-memory-store.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "str" " " "==" " " "\"label\"", __s1, "==", __s2); } while (0);
 g_free (str);
}
...
void testing__test__get_invalid(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_store_get_attribute (store, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x12UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_TYPE_INVALID"); } while (0);
}
...
void testing__test__get_sensitive(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_store_get_attribute (store, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x11UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_SENSITIVE"); } while (0);
}
...
void testing__test__get_internal(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_store_get_attribute (store, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x12UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 189, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_TYPE_INVALID"); } while (0);
}
...
void testing__test__set_invalid(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0x12UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 201, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_ATTRIBUTE_TYPE_INVALID"); } while (0);
}
...
void testing__test__set_internal(int *__unused, gconstpointer __data)
{
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0x12UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 214, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_ATTRIBUTE_TYPE_INVALID"); } while (0);
}
...
void testing__test__set_get_attribute(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 229, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);

 attr.pValue = buffer;
 attr.ulValueLen = 1024;
 rv = gkm_store_get_attribute (store, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 234, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 6) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 235, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 6"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, "booyah", 6) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 236, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, \"booyah\", 6) == 0"); } while (0);
}
...
void testing__test__write_read_value(int *__unused, gconstpointer __data)
{
 ...
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 253, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);

 value = gkm_store_read_value (store, object, (0x406UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 256, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_value == sizeof (five)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 257, ((const char*) (__PRETTY_FUNCTION__)), "n_value == sizeof (five)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (value, &five, sizeof (five)) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (value, &five, sizeof (five)) == 0"); } while (0);
}
...
void testing__test__set_no_validate(int *__unused, gconstpointer __data)
{
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 270, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction)"); } while (0);

 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 273, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}
...
void testing__test__set_transaction_default(int *__unused, gconstpointer __data)
{
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 289, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == attr.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 293, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == attr.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 294, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, value, n_value) == 0"); } while (0);


 gkm_transaction_fail (transaction, (0x13UL));


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == attr.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 301, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == attr.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 302, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, value, n_value) == 0"); } while (0);


 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 306, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 310, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == 5"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (value, "label", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 311, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (value, \"label\", 5) == 0"); } while (0);
}
...
void testing__test__set_transaction_revert_first(int *__unused, gconstpointer __data)
{
 ...
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 327, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == prev.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 331, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == prev.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (prev.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 332, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (prev.pValue, value, n_value) == 0"); } while (0);
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 343, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == attr.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 347, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == attr.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 348, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, value, n_value) == 0"); } while (0);
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 355, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == attr.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 359, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == attr.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 360, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, value, n_value) == 0"); } while (0);
 ...
 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == attr.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 367, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == attr.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (attr.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 368, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (attr.pValue, value, n_value) == 0"); } while (0);


 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 372, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);


 value = gkm_store_read_value (store, object, (3UL), &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value && n_value == prev.ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 376, ((const char*) (__PRETTY_FUNCTION__)), "value && n_value == prev.ulValueLen"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (prev.pValue, value, n_value) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 377, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (prev.pValue, value, n_value) == 0"); } while (0);
}

static void
notify_attribute (GkmObject *obj, CK_ATTRIBUTE_TYPE type, gpointer data)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (obj == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 383, ((const char*) (__PRETTY_FUNCTION__)), "obj == object"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == (3UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 384, ((const char*) (__PRETTY_FUNCTION__)), "type == CKA_LABEL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 385, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
...
void testing__test__set_notifies(int *__unused, gconstpointer __data)
{
 ...
 g_signal_connect_data ((object), ("notify-attribute"), (((GCallback) (notify_attribute))), (&type), ((void *)0), (GConnectFlags) 0);

 gkm_store_set_attribute (store, transaction, object, &attr);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == (3UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 404, ((const char*) (__PRETTY_FUNCTION__)), "type == CKA_LABEL"); } while (0);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 413, ((const char*) (__PRETTY_FUNCTION__)), "type == 0"); } while (0);


 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 417, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == (3UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 420, ((const char*) (__PRETTY_FUNCTION__)), "type == CKA_LABEL"); } while (0);
}
...
void testing__test__set_object_gone_first(int *__unused, gconstpointer __data)
{
 ...
 gkm_store_set_attribute (store, transaction, object, &attr);
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-memory-store.c", 433, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);
