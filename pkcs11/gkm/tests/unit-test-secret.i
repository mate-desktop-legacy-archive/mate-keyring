...
void testing__test__test_secret(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 39, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 password = gkm_secret_get_password (secret, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 42, ((const char*) (__PRETTY_FUNCTION__)), "password"); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (8); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 43, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "8", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (password, "test-pin", 8) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 44, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (password, \"test-pin\", 8) == 0"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pin", 8)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 46, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pin\", 8)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pino", 9)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 47, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pino\", 9)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, ((void *)0), 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 48, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, NULL, 0)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pin", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 49, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pin\", -1)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"", 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 50, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"\", 0)"); } while (0);
...
void testing__test__test_secret_from_login(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 62, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);
 password = gkm_secret_get_password (secret, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "password"); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (8); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 65, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "8", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (password, "test-pin", 8) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 66, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (password, \"test-pin\", 8) == 0"); } while (0);
 g_object_unref (secret);

 secret = gkm_secret_new_from_login ((guchar*)"test-pin", (CK_ULONG)-1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);
 password = gkm_secret_get_password (secret, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 72, ((const char*) (__PRETTY_FUNCTION__)), "password"); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (8); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "8", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (password, "test-pin", 8) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (password, \"test-pin\", 8) == 0"); } while (0);
 g_object_unref (secret);
}
...
void testing__test__test_null_terminated(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 85, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 password = gkm_secret_get_password (secret, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "password"); } while (0);
 do { const char *__s1 = (password), *__s2 = ("null-terminated"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret.c", 89, ((const char*) (__PRETTY_FUNCTION__)), "password" " " "==" " " "\"null-terminated\"", __s1, "==", __s2); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (strlen ("null-terminated")); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 90, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "strlen (\"null-terminated\")", __n1, "==", __n2, 'i'); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"null-terminated", strlen ("null-terminated"))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 92, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"null-terminated\", strlen (\"null-terminated\"))"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pino", 9)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pino\", 9)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, ((void *)0), 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, NULL, 0)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"null-terminated", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 95, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"null-terminated\", -1)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"", 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"\", 0)"); } while (0);
...
void testing__test__test_always_has_null(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 109, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 memory = gkm_secret_get (secret, &n_memory);
 do { guint64 __n1 = (n_memory), __n2 = (4); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 112, ((const char*) (__PRETTY_FUNCTION__)), "n_memory" " " "==" " " "4", __n1, "==", __n2, 'i'); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memory[4] == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 115, ((const char*) (__PRETTY_FUNCTION__)), "memory[4] == 0"); } while (0);
...
void testing__test__test_null(int *__unused, gconstpointer __data)
{
 ...
 secret = gkm_secret_new (((void *)0), 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 password = gkm_secret_get_password (secret, &n_password);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (password == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 130, ((const char*) (__PRETTY_FUNCTION__)), "password == NULL"); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 131, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"null-terminated", strlen ("null-terminated"))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 133, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"null-terminated\", strlen (\"null-terminated\"))"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pino", 9)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pino\", 9)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, ((void *)0), 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 135, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, NULL, 0)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"null-terminated", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 136, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"null-terminated\", -1)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"", 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"\", 0)"); } while (0);
...
void testing__test__test_empty(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 password = gkm_secret_get_password (secret, &n_password);
 do { const char *__s1 = (password), *__s2 = (""); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret.c", 152, ((const char*) (__PRETTY_FUNCTION__)), "password" " " "==" " " "\"\"", __s1, "==", __s2); } while (0);
 do { guint64 __n1 = (n_password), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret.c", 153, ((const char*) (__PRETTY_FUNCTION__)), "n_password" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"null-terminated", strlen ("null-terminated"))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 155, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"null-terminated\", strlen (\"null-terminated\"))"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"test-pino", 9)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 156, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"test-pino\", 9)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, ((void *)0), 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 157, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, NULL, 0)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 158, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"\", -1)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)"", 0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (secret, (CK_UTF8CHAR_PTR)\"\", 0)"); } while (0);
...
void testing__test__test_equal(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equal (one, two)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 170, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equal (one, two)"); } while (0);

 two = gkm_secret_new_from_password ("funny");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equal (one, two)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 173, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equal (one, two)"); } while (0);

 g_object_unref (one);
 one = gkm_secret_new_from_password ("other");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_equal (one, two)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_equal (one, two)"); } while (0);
}
