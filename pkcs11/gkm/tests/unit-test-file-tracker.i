# 1 "unit-test-file-tracker.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-file-tracker.c"
# 24 "unit-test-file-tracker.c"
...
# 1 "test-suite.h" 2
# 30 "unit-test-file-tracker.c" 2

# 1 "./../../gkm/gkm-file-tracker.h" 1
# 29 "./../../gkm/gkm-file-tracker.h"
# 1 "./../../gkm/gkm-file-tracker.h" 1
# 30 "./../../gkm/gkm-file-tracker.h" 2


# 40 "./../../gkm/gkm-file-tracker.h"
...
GType gkm_file_tracker_get_type (void) __attribute__((__const__));
...
static GkmFileTracker *the_tracker = ((void *)0);
static gchar *test_dir = ((void *)0);
static gchar *test_file = ((void *)0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("should be a non-null path" && path != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 55, ((const char*) (__PRETTY_FUNCTION__)), "\"should be a non-null path\" && path != NULL"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("should be a non-null path" && path != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 65, ((const char*) (__PRETTY_FUNCTION__)), "\"should be a non-null path\" && path != NULL"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("should be a non-null path" && path != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 75, ((const char*) (__PRETTY_FUNCTION__)), "\"should be a non-null path\" && path != NULL"); } while (0);
...
file_reset_stats (void)
{
 ...
 g_free (last_file_added);
 g_free (last_file_changed);
 last_file_removed = last_file_added = last_file_changed = ((void *)0);
...
void testing__setup__tracker(int *__unused, gconstpointer __data)
{
 ...
 test_dir = g_build_filename ("/tmp", "test-subdir", ((void *)0));

 the_tracker = gkm_file_tracker_new (test_dir, "*.woo?", ((void *)0));
 g_signal_connect_data ((the_tracker), ("file-added"), (((GCallback) (file_added))), (((void *)0)), ((void *)0), (GConnectFlags) 0);
 g_signal_connect_data ((the_tracker), ("file-removed"), (((GCallback) (file_removed))), (((void *)0)), ((void *)0), (GConnectFlags) 0);
 g_signal_connect_data ((the_tracker), ("file-changed"), (((GCallback) (file_changed))), (((void *)0)), ((void *)0), (GConnectFlags) 0);


 sleep (1);

 test_file = g_build_filename (test_dir, "my-file.woof", ((void *)0));
 g_unlink (test_file);
}
...
void testing__test__file_watch(int *__unused, gconstpointer __data)
{
 ...
 gkm_file_tracker_refresh (the_tracker, (0));

 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 122, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 123, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 124, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
 ...
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 131, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 132, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 133, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
}
...
void testing__test__watch_file(int *__unused, gconstpointer __data)
{
 ...
 ret = g_file_set_contents (test_file, "test-data", strlen ("test-data"), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 147, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);


 gkm_file_tracker_refresh (the_tracker, (0));

 do { gint64 __n1 = (1), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 152, ((const char*) (__PRETTY_FUNCTION__)), "1" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 153, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 154, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);


 do { const char *__s1 = (last_file_added), *__s2 = (test_file); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-file-tracker.c", 157, ((const char*) (__PRETTY_FUNCTION__)), "last_file_added" " " "==" " " "test_file", __s1, "==", __s2); } while (0);
 ...
 gkm_file_tracker_refresh (the_tracker, (0));
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 164, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 165, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 166, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);


 gkm_file_tracker_refresh (the_tracker, (!(0)));
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 170, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (1), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 171, ((const char*) (__PRETTY_FUNCTION__)), "1" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 172, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (last_file_changed), *__s2 = (test_file); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-file-tracker.c", 173, ((const char*) (__PRETTY_FUNCTION__)), "last_file_changed" " " "==" " " "test_file", __s1, "==", __s2); } while (0);

 file_reset_stats ();

 ret = g_file_set_contents (test_file, "test-data", strlen ("test-data"), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 178, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);


 gkm_file_tracker_refresh (the_tracker, (0));
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (1), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 183, ((const char*) (__PRETTY_FUNCTION__)), "1" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 184, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (last_file_changed), *__s2 = (test_file); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-file-tracker.c", 185, ((const char*) (__PRETTY_FUNCTION__)), "last_file_changed" " " "==" " " "test_file", __s1, "==", __s2); } while (0);
 ...
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 193, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 194, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (1), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 195, ((const char*) (__PRETTY_FUNCTION__)), "1" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (last_file_removed), *__s2 = (test_file); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-file-tracker.c", 196, ((const char*) (__PRETTY_FUNCTION__)), "last_file_removed" " " "==" " " "test_file", __s1, "==", __s2); } while (0);
}

void testing__test__nomatch(int *__unused, gconstpointer __data)
{
 gchar *file = g_build_filename (test_dir, "my-file.toot", ((void *)0));
 gboolean ret;


 sleep (1);

 ret = g_file_set_contents (file, "test-data", strlen ("test-data"), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-file-tracker.c", 208, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);
 ...
 do { gint64 __n1 = (0), __n2 = (n_files_added); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 215, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_added", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_changed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 216, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_changed", __n1, "==", __n2, 'i'); } while (0);
 do { gint64 __n1 = (0), __n2 = (n_files_removed); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-file-tracker.c", 217, ((const char*) (__PRETTY_FUNCTION__)), "0" " " "==" " " "n_files_removed", __n1, "==", __n2, 'i'); } while (0);
