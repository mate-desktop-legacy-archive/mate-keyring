# 1 "unit-test-data-asn1.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-data-asn1.c"
# 24 "unit-test-data-asn1.c"
# 1 "../../../config.h" 1
# 25 "unit-test-data-asn1.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-data-asn1.c" 2

# 1 "./../../gkm/gkm-data-asn1.h" 1
# 28 "./../../gkm/gkm-data-asn1.h"
...
gboolean gkm_data_asn1_write_mpi (GNode *asn,
                                                                gcry_mpi_t mpi);
# 29 "unit-test-data-asn1.c" 2
# 37 "unit-test-data-asn1.c"
# 1 "../../../egg/egg-asn1x.h" 1
# 30 "../../../egg/egg-asn1x.h"
...
const ASN1_ARRAY_TYPE test_asn1_tab[] = {
  { "TEST", 536872976, ((void *)0) },
  { ((void *)0), 1073741836, ((void *)0) },
  { "TestIntegers", 1610612741, ((void *)0) },
  { "mpi", 3, ((void *)0) },
  { "TestData", 536870917, ((void *)0) },
  { "data", 1073741831, ((void *)0) },
  { "boolean", 536903684, ((void *)0) },
  { ((void *)0), 131081, ((void *)0) },
  { ((void *)0), 0, ((void *)0) }
};
# 41 "unit-test-data-asn1.c" 2

static GNode *asn1_cert = ((void *)0);
static guchar *data_cert = ((void *)0);
...
void testing__setup__asn1_tree(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (asn1_cert) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 50, ((const char*) (__PRETTY_FUNCTION__)), "asn1_cert"); } while (0);
}
...
void testing__test__asn1_integers(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("asn test structure is null" && asn != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 69, ((const char*) (__PRETTY_FUNCTION__)), "\"asn test structure is null\" && asn != NULL"); } while (0);


 mpi = gcry_mpi_new (512);
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mpi) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "mpi"); return; }; }while (0);
 gcry_mpi_randomize (mpi, 512, GCRY_WEAK_RANDOM);


 ret = gkm_data_asn1_write_mpi (egg_asn1x_node (asn, "mpi", ((void *)0)), mpi);


 data = egg_asn1x_encode (asn, ((void *)0), &n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("encoding asn1 didn't work" && data != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 81, ((const char*) (__PRETTY_FUNCTION__)), "\"encoding asn1 didn't work\" && data != NULL"); } while (0);

 egg_asn1x_destroy (asn);


 asn = egg_asn1x_create_and_decode (test_asn1_tab, "TestIntegers", data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (asn) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 87, ((const char*) (__PRETTY_FUNCTION__)), "asn"); } while (0);

 ret = gkm_data_asn1_read_mpi (egg_asn1x_node (asn, "mpi", ((void *)0)), &mpt);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("couldn't read mpi from asn1" && ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 90, ((const char*) (__PRETTY_FUNCTION__)), "\"couldn't read mpi from asn1\" && ret"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("mpi returned is null" && mpt != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 91, ((const char*) (__PRETTY_FUNCTION__)), "\"mpi returned is null\" && mpt != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ("mpi is wrong number" && gcry_mpi_cmp (mpi, mpt) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-data-asn1.c", 92, ((const char*) (__PRETTY_FUNCTION__)), "\"mpi is wrong number\" && gcry_mpi_cmp (mpi, mpt) == 0"); } while (0);
