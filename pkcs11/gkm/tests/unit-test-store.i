...
# 31 "unit-test-store.c" 2

# 1 "./../../gkm/gkm-store.h" 1
# 27 "./../../gkm/gkm-store.h"
# 1 "./../../gkm/gkm-types.h" 1
# 28 "./../../gkm/gkm-store.h" 2

# 1 "../../../pkcs11/pkcs11.h" 1
# 30 "./../../gkm/gkm-store.h" 2
...
void testing__setup__store(int *__unused, gconstpointer __data)
{
 ...
 store = g_object_new ((gkm_store_get_type ()), ((void *)0));
}
...
void testing__test__store_schema(int *__unused, gconstpointer __data)
{
 ...
 gkm_store_register_schema (store, &attr, ((void *)0), 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_store_lookup_schema (store, (3UL), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-store.c", 61, ((const char*) (__PRETTY_FUNCTION__)), "gkm_store_lookup_schema (store, CKA_LABEL, NULL)"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_store_lookup_schema (store, (0x11UL), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-store.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_store_lookup_schema (store, CKA_VALUE, NULL)"); } while (0);
}
...
void testing__test__store_schema_flags(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_store_lookup_schema (store, (0x11UL), &flags)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-store.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "gkm_store_lookup_schema (store, CKA_VALUE, &flags)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (flags == GKM_STORE_IS_SENSITIVE) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-store.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "flags == GKM_STORE_IS_SENSITIVE"); } while (0);
}
