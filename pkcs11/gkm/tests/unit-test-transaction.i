# 1 "unit-test-transaction.c"
# 1 "/data/projects/mate-keyring/pkcs11/gkm/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-transaction.c"
# 24 "unit-test-transaction.c"
# 1 "test-suite.h" 1
...
# 1 "test-suite.h" 2
# 25 "unit-test-transaction.c" 2

# 1 "./../../gkm/gkm-transaction.h" 1
# 27 "./../../gkm/gkm-transaction.h"
# 1 "./../../gkm/gkm-types.h" 1
# 25 "./../../gkm/gkm-types.h"
...
# 30 "./../../gkm/gkm-transaction.h" 2
# 38 "./../../gkm/gkm-transaction.h"
...
void testing__setup__transaction_setup(int *__unused, gconstpointer __data)
{
 ...
 dir = g_dir_open (directory, 0, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (dir) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 37, ((const char*) (__PRETTY_FUNCTION__)), "dir"); } while (0);
 ...
 for (;;) {
  ...
  if (g_str_has_prefix (basename, "transaction-")) {
   filename = g_build_filename (directory, basename, ((void *)0));
   g_unlink (filename);
   g_free (filename);
  }
 }
...
void testing__test__transaction_empty(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((transaction)); GType __t = ((gkm_transaction_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 60, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_TRANSACTION (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 62, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_completed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_completed (transaction) == FALSE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);
 ...
 g_object_get (transaction, "completed", &completed, "failed", &failed, "result", &result, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "result == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "completed == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (failed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 75, ((const char*) (__PRETTY_FUNCTION__)), "failed == FALSE"); } while (0);
...
void testing__test__transaction_fail(int *__unused, gconstpointer __data)
{
 ...
 gkm_transaction_fail (transaction, (7UL));

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_completed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 89, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_completed (transaction) == FALSE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (7UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 90, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_ARGUMENTS_BAD"); } while (0);

 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_completed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 95, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_completed (transaction) == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (7UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_ARGUMENTS_BAD"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((transaction)); GType __t = ((gkm_transaction_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 105, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_TRANSACTION (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((transaction)); GType __t = ((gkm_transaction_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 115, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_TRANSACTION (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 116, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((transaction)); GType __t = ((gkm_transaction_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_TRANSACTION (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (transaction == ((((GkmTransaction*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_transaction_get_type ()))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 120, ((const char*) (__PRETTY_FUNCTION__)), "transaction == GKM_TRANSACTION (object)"); } while (0);
...
void testing__test__transaction_signals_success(int *__unused, gconstpointer __data)
{
 ...
 g_signal_connect_data ((transaction), ("complete"), (((GCallback) (completed_signal))), (&completed), ((void *)0), (GConnectFlags) 0);
 gkm_transaction_add (transaction, transaction, completed_callback, &failed);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == 3) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 138, ((const char*) (__PRETTY_FUNCTION__)), "completed == 3"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (failed == 3) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 139, ((const char*) (__PRETTY_FUNCTION__)), "failed == 3"); } while (0);

 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "completed == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (failed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "failed == FALSE"); } while (0);
...
void testing__test__transaction_signals_failure(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == 3) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "completed == 3"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (failed == 3) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 164, ((const char*) (__PRETTY_FUNCTION__)), "failed == 3"); } while (0);

 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 168, ((const char*) (__PRETTY_FUNCTION__)), "completed == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (failed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 169, ((const char*) (__PRETTY_FUNCTION__)), "failed == TRUE"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((transaction)); GType __t = ((gkm_transaction_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 179, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_TRANSACTION (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 180, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((guint) (data)) == order_value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 181, ((const char*) (__PRETTY_FUNCTION__)), "GPOINTER_TO_UINT (data) == order_value"); } while (0);
 --order_value;
 return (!(0));
}
...
void testing__test__transaction_order_is_reverse(int *__unused, gconstpointer __data)
{
 ...
 order_value = 3;
 gkm_transaction_add (transaction, transaction, order_callback, ((gpointer) (1)));
 gkm_transaction_add (transaction, transaction, order_callback, ((gpointer) (2)));
 gkm_transaction_add (transaction, transaction, order_callback, ((gpointer) (3)));
...
void testing__test__transaction_dispose_completes(int *__unused, gconstpointer __data)
{
 ...
 g_object_run_dispose (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((transaction)), (((GType) ((20) << (2)))))))));

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (completed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 210, ((const char*) (__PRETTY_FUNCTION__)), "completed == TRUE"); } while (0);
...
void testing__test__remove_file_success(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_set_contents (filename, "xxx", 3, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "g_file_set_contents (filename, \"xxx\", 3, NULL)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 221, ((const char*) (__PRETTY_FUNCTION__)), "g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);

 gkm_transaction_remove_file (transaction, filename);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 224, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 226, ((const char*) (__PRETTY_FUNCTION__)), "!g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);

 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 229, ((const char*) (__PRETTY_FUNCTION__)), "!g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);
...
void testing__test__remove_file_abort(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_set_contents (filename, "xxx", 3, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 242, ((const char*) (__PRETTY_FUNCTION__)), "g_file_set_contents (filename, \"xxx\", 3, NULL)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);

 gkm_transaction_remove_file (transaction, filename);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 246, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 248, ((const char*) (__PRETTY_FUNCTION__)), "!g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);


 gkm_transaction_fail (transaction, (6UL));

 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 254, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 255, ((const char*) (__PRETTY_FUNCTION__)), "g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, &n_data, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 257, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, &n_data, NULL)"); } while (0);
 do { guint64 __n1 = (n_data), __n2 = (3); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-transaction.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "n_data" " " "==" " " "3", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (data), *__s2 = ("xxx"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 259, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"xxx\"", __s1, "==", __s2); } while (0);
 g_free (data);
...
void testing__test__remove_file_non_exist(int *__unused, gconstpointer __data)
{
 ...
 gkm_transaction_remove_file (transaction, filename);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 276, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
...
void testing__test__write_file(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 291, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, &n_data, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 293, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, &n_data, NULL)"); } while (0);
 do { guint64 __n1 = (n_data), __n2 = (5); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-transaction.c", 294, ((const char*) (__PRETTY_FUNCTION__)), "n_data" " " "==" " " "5", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (data), *__s2 = ("value"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 295, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"value\"", __s1, "==", __s2); } while (0);
 g_free (data);

 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, &n_data, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 300, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, &n_data, NULL)"); } while (0);
 do { guint64 __n1 = (n_data), __n2 = (5); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-transaction.c", 301, ((const char*) (__PRETTY_FUNCTION__)), "n_data" " " "==" " " "5", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (data), *__s2 = ("value"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 302, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"value\"", __s1, "==", __s2); } while (0);
 g_free (data);
...
void testing__test__write_file_abort_gone(int *__unused, gconstpointer __data)
{
 ...
 gkm_transaction_write_file (transaction, filename, (const guchar*)"value", 5);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 319, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, &n_data, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 321, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, &n_data, NULL)"); } while (0);
 do { guint64 __n1 = (n_data), __n2 = (5); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-transaction.c", 322, ((const char*) (__PRETTY_FUNCTION__)), "n_data" " " "==" " " "5", __n1, "==", __n2, 'i'); } while (0);
 do { const char *__s1 = (data), *__s2 = ("value"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 323, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"value\"", __s1, "==", __s2); } while (0);
 g_free (data);

 gkm_transaction_fail (transaction, (5UL));
 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!g_file_test (filename, G_FILE_TEST_IS_REGULAR)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 329, ((const char*) (__PRETTY_FUNCTION__)), "!g_file_test (filename, G_FILE_TEST_IS_REGULAR)"); } while (0);
...
void testing__test__write_file_abort_revert(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_set_contents (filename, "my original", -1, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 341, ((const char*) (__PRETTY_FUNCTION__)), "g_file_set_contents (filename, \"my original\", -1, NULL)"); } while (0);

 gkm_transaction_write_file (transaction, filename, (const guchar*)"new value", 9);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 344, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, ((void *)0), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 346, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, NULL, NULL)"); } while (0);
 do { const char *__s1 = (data), *__s2 = ("new value"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 347, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"new value\"", __s1, "==", __s2); } while (0);
 g_free (data);

 gkm_transaction_fail (transaction, (5UL));
 gkm_transaction_complete (transaction);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_get_contents (filename, &data, ((void *)0), ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 353, ((const char*) (__PRETTY_FUNCTION__)), "g_file_get_contents (filename, &data, NULL, NULL)"); } while (0);
 do { const char *__s1 = (data), *__s2 = ("my original"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 354, ((const char*) (__PRETTY_FUNCTION__)), "data" " " "==" " " "\"my original\"", __s1, "==", __s2); } while (0);
 g_free (data);
...
void testing__test__unique_file_conflict(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_set_contents (filename, "data", -1, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 372, ((const char*) (__PRETTY_FUNCTION__)), "g_file_set_contents (filename, \"data\", -1, NULL)"); } while (0);

 result = gkm_transaction_unique_file (transaction, dirname, basename);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 375, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 377, ((const char*) (__PRETTY_FUNCTION__)), "result"); } while (0);
 do { const char *__s1 = (result), *__s2 = (basename); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 378, ((const char*) (__PRETTY_FUNCTION__)), "result" " " "!=" " " "basename", __s1, "!=", __s2); } while (0);
 do { const char *__s1 = (result), *__s2 = ("transaction-test_1"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 379, ((const char*) (__PRETTY_FUNCTION__)), "result" " " "==" " " "\"transaction-test_1\"", __s1, "==", __s2); } while (0);
...
void testing__test__unique_file_conflict_with_ext(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (g_file_set_contents (filename, "data", -1, ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 400, ((const char*) (__PRETTY_FUNCTION__)), "g_file_set_contents (filename, \"data\", -1, NULL)"); } while (0);

 result = gkm_transaction_unique_file (transaction, dirname, basename);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 403, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 405, ((const char*) (__PRETTY_FUNCTION__)), "result"); } while (0);
 do { const char *__s1 = (result), *__s2 = (basename); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 406, ((const char*) (__PRETTY_FUNCTION__)), "result" " " "!=" " " "basename", __s1, "!=", __s2); } while (0);
 do { const char *__s1 = (result), *__s2 = ("transaction-test_1.ext"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 407, ((const char*) (__PRETTY_FUNCTION__)), "result" " " "==" " " "\"transaction-test_1.ext\"", __s1, "==", __s2); } while (0);
...
void testing__test__unique_file_no_conflict(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 424, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (result) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-transaction.c", 426, ((const char*) (__PRETTY_FUNCTION__)), "result"); } while (0);
 do { const char *__s1 = (result), *__s2 = ("transaction-another"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-transaction.c", 427, ((const char*) (__PRETTY_FUNCTION__)), "result" " " "==" " " "\"transaction-another\"", __s1, "==", __s2); } while (0);
