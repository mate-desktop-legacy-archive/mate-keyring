# 1 "test-xdg-module.c"
# 1 "/data/projects/mate-keyring/pkcs11/xdg-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "test-xdg-module.c"
# 25 "test-xdg-module.c"
# 1 "../../../config.h" 1
# 26 "test-xdg-module.c" 2
...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 31 "test-xdg-module.c" 2
# 1 "./../../gkm/gkm-module.h" 1
# 32 "test-xdg-module.c" 2
...
# 35 "test-xdg-module.c" 2



static GMutex *mutex = ((void *)0);
...
test_xdg_module_initialize_and_enter (void)
{
 ...
 testing_data_to_scratch ("test-refer-1.trust", ((void *)0));
 testing_data_to_scratch ("test-certificate-1.cer", ((void *)0));
 ...
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "rv == CKR_OK"); return (((void *)0)); }; }while (0);

 module = _gkm_xdg_store_get_module_for_testing ();
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (module) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "module"); return (((void *)0)); }; }while (0);
...
test_xdg_module_leave_and_finalize (void)
{
 ...
 funcs = gkm_xdg_store_get_functions ();
 rv = (funcs->C_Finalize) (((void *)0));
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "rv == CKR_OK"); return; }; }while (0);
}

void
test_xdg_module_leave (void)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mutex) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 99, ((const char*) (__PRETTY_FUNCTION__)), "mutex"); } while (0);
 ((g_threads_got_initialized) ? (*g_thread_functions_for_glib_use . mutex_unlock) (mutex) : ((void)0));
}

void
test_xdg_module_enter (void)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mutex) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "mutex"); } while (0);
 ((g_threads_got_initialized) ? (*g_thread_functions_for_glib_use . mutex_lock) (mutex) : ((void)0));
}

GkmSession*
test_xdg_module_open_session (gboolean writable)
{
 CK_ULONG flags = (1UL << 2);
 CK_SESSION_HANDLE handle;
 GkmModule *module;
 GkmSession *session;
 CK_RV rv;
 ...
 rv = gkm_module_C_OpenSession (module, 1, flags, ((void *)0), ((void *)0), &handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 126, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 session = gkm_module_lookup_session (module, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (session) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 129, ((const char*) (__PRETTY_FUNCTION__)), "session"); } while (0);
...
void testing__setup__xdg_module_setup(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 157, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = gkm_session_C_GetSessionInfo (session, &info);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 160, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
...
void testing__test__xdg_module_find_twice_is_same(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 180, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_objects);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 184, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 do { CK_RV __v1 = (n_objects), __v2 = (0); if (__v1 > __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 186, ((const char*) (__PRETTY_FUNCTION__)), "n_objects" " " ">" " " "0", __v1, ">", __v2); } while (0);


 testing_scratch_touch ("test-refer-1.trust", 1);

 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 192, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_check);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 194, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 196, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 do { CK_RV __v1 = (n_check), __v2 = (n_objects); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 199, ((const char*) (__PRETTY_FUNCTION__)), "n_check" " " "==" " " "n_objects", __v1, "==", __v2); } while (0);
}
...
void testing__test__xdg_module_file_becomes_invalid(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 210, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_objects);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 212, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 214, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 do { CK_RV __v1 = (n_objects), __v2 = (0); if (__v1 > __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 216, ((const char*) (__PRETTY_FUNCTION__)), "n_objects" " " ">" " " "0", __v1, ">", __v2); } while (0);
 ...
 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 223, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_check);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 225, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 227, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 do { CK_RV __v1 = (n_check), __v2 = (n_objects); if (__v1 < __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 230, ((const char*) (__PRETTY_FUNCTION__)), "n_check" " " "<" " " "n_objects", __v1, "<", __v2); } while (0);
}
...
void testing__test__xdg_module_file_remove(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 241, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_objects);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 245, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 do { CK_RV __v1 = (n_objects), __v2 = (0); if (__v1 > __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 247, ((const char*) (__PRETTY_FUNCTION__)), "n_objects" " " ">" " " "0", __v1, ">", __v2); } while (0);


 testing_scratch_remove ("test-refer-1.trust");

 rv = gkm_session_C_FindObjectsInit (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 253, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, objects, (sizeof (objects) / sizeof ((objects)[0])), &n_check);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 255, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 257, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 do { CK_RV __v1 = (n_check), __v2 = (n_objects); if (__v1 < __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 260, ((const char*) (__PRETTY_FUNCTION__)), "n_check" " " "<" " " "n_objects", __v1, "<", __v2); } while (0);
}
...
void testing__test__xdg_create_and_add_object(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  ...
  { (1UL), &tval, sizeof (tval) },
  { (0x80UL), &ctype, sizeof (ctype) }
 };
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 285, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 286, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
}
...
void testing__test__xdg_destroy_object(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 303, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjects (session, &object, 1, &n_objects);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 305, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (n_objects), __v2 = (1); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-xdg-module.c", 306, ((const char*) (__PRETTY_FUNCTION__)), "n_objects" " " "==" " " "1", __v1, "==", __v2); } while (0);
 rv = gkm_session_C_FindObjectsFinal (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 308, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = gkm_session_C_DestroyObject (session, object);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 312, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = gkm_session_C_DestroyObject (session, object);
 do { CK_RV __v1 = (rv), __v2 = ((0x82UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 316, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OBJECT_HANDLE_INVALID", __v1, "==", __v2); } while (0);
}
...
void testing__test__xdg_get_slot_info(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 326, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 str = g_strstr_len ((gchar*)info.slotDescription, sizeof (info.slotDescription),
                     "User Key Storage");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (str != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 330, ((const char*) (__PRETTY_FUNCTION__)), "str != NULL"); } while (0);
}
...
void testing__test__xdg_get_token_info(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-xdg-module.c", 340, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 str = g_strstr_len ((gchar*)info.label, sizeof (info.label),
                     "User Key Storage");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (str != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-xdg-module.c", 344, ((const char*) (__PRETTY_FUNCTION__)), "str != NULL"); } while (0);
}
