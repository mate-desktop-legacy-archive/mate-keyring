# 1 "test-login-hints.c"
# 1 "/data/projects/mate-keyring/pkcs11/wrap-layer/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "test-login-hints.c"
# 22 "test-login-hints.c"
# 1 "../../../config.h" 1
# 23 "test-login-hints.c" 2
...
# 27 "test-login-hints.c" 2

# 1 "./../../wrap-layer/gkm-wrap-layer.h" 1
# 25 "./../../wrap-layer/gkm-wrap-layer.h"
# 1 "../../../pkcs11/pkcs11.h" 1
# 186 "../../../pkcs11/pkcs11.h"
...
# 26 "./../../wrap-layer/gkm-wrap-layer.h" 2
...
void testing__test__login_did_unlock_fail(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-hints.c", 39, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);

 password = gkm_wrap_login_steal_failed_password ();
 do { const char *__s1 = (password), *__s2 = ("failure"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-login-hints.c", 42, ((const char*) (__PRETTY_FUNCTION__)), "password" " " "==" " " "\"failure\"", __s1, "==", __s2); } while (0);
 ...
 ret = gkm_wrap_login_did_unlock_fail ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-hints.c", 50, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
}
