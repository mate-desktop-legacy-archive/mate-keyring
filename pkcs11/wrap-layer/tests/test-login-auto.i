# 1 "test-login-auto.c"
# 1 "/data/projects/mate-keyring/pkcs11/wrap-layer/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "test-login-auto.c"
# 22 "test-login-auto.c"
# 1 "../../../config.h" 1
# 23 "test-login-auto.c" 2
...
void gkm_assertion_message_cmpulong (const gchar *domain,
                                                    ...
                                                    const gchar *cmp,
                                                    CK_ULONG arg2);
# 28 "test-login-auto.c" 2

# 1 "./../../wrap-layer/gkm-wrap-layer.h" 1
# 29 "./../../wrap-layer/gkm-wrap-layer.h"
...
void testing__setup__login_auto(int *__unused, gconstpointer __data)
{
 ...
 CK_BBOOL always = (!(0));
 CK_ATTRIBUTE kattrs[] = {
  { (0x202UL), &always, sizeof (always) }
 };

 CK_OBJECT_CLASS fklass = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 110);
 CK_ATTRIBUTE fattrs[] = {
  { (0UL), &fklass, sizeof (fklass) },
  { (0x102UL), "other", 5 },
 };
 ...
 rv = (module->C_Initialize) (((void *)0));
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_GetSlotList) (1, &slot_id, &n_slots);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_OpenSession) (slot_id, (1UL << 2), ((void *)0), ((void *)0), &session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 76, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = (module->C_FindObjectsInit) (session, fattrs, 1);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 80, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = (module->C_FindObjects) (session, &collection, 1, &count);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 82, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (count), __v2 = (1); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-auto.c", 83, ((const char*) (__PRETTY_FUNCTION__)), "count" " " "==" " " "1", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (collection), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-auto.c", 84, ((const char*) (__PRETTY_FUNCTION__)), "collection" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
 rv = (module->C_FindObjectsFinal) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = (module->C_FindObjectsInit) (session, kattrs, 1);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 90, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = (module->C_FindObjects) (session, &key, 1, &count);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 92, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (count), __v2 = (1); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-auto.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "count" " " "==" " " "1", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (key), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-auto.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "key" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
 rv = (module->C_FindObjectsFinal) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = (module->C_SignInit) (session, &mech, key);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__teardown__login_auto(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gku_prompt_dummy_have_response ()) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-auto.c", 107, ((const char*) (__PRETTY_FUNCTION__)), "!gku_prompt_dummy_have_response ()"); } while (0);

 key = 0;
 collection = 0;

 rv = (module->C_CloseSession) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 113, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 session = 0;

 rv = (module->C_Finalize) (((void *)0));
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 117, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 module = ((void *)0);
}
...
void testing__test__login_auto_specific(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (2UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 128, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = (module->C_SignInit) (session, &mech, key);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 132, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 gku_prompt_dummy_prepare_response ();
 rv = (module->C_Login) (session, (2UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 rv = (module->C_SignInit) (session, &mech, key);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 gku_prompt_dummy_queue_ok_password ("other");
 rv = (module->C_Login) (session, (2UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_auto_user_token(int *__unused, gconstpointer __data)
{
 ...
 gku_prompt_dummy_queue_auto_password ("booo");
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = (module->C_Logout) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 161, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 gku_prompt_dummy_prepare_response ();
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 166, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = (module->C_Logout) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 168, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 gku_prompt_dummy_queue_ok_password ("other");
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_auto_unlock_keyring(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  ...
  { (0x11UL), ((void *)0), 0 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 202), &collection, sizeof (collection) },
 };


 gku_prompt_dummy_queue_auto_password ("booo");
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &credential);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 194, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 rv = (module->C_DestroyObject) (session, credential);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 196, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 gku_prompt_dummy_prepare_response ();
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &credential);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 201, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 gku_prompt_dummy_queue_ok_password ("other");
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &credential);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-auto.c", 209, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
