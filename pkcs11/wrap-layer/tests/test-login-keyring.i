# 1 "test-login-keyring.c"
# 1 "/data/projects/mate-keyring/pkcs11/wrap-layer/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "test-login-keyring.c"
# 22 "test-login-keyring.c"
# 1 "../../../config.h" 1
# 23 "test-login-keyring.c" 2
...
# 33 "test-login-keyring.c" 2
# 1 "./../../wrap-layer/gkm-wrap-login.h" 1
# 27 "./../../wrap-layer/gkm-wrap-login.h"
...
void testing__setup__login_keyring(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-keyring.c", 51, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__teardown__login_keyring(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-keyring.c", 59, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 module = ((void *)0);
}
...
void testing__test__login_is_usable(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 68, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
}
...
void testing__test__login_usable_fail_open_session(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_wrap_login_is_usable ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
}
...
void testing__test__login_usable_fail_not_trusted(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_wrap_login_is_usable ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);

 bval = 1;
 attr.type = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 218);
 attr.pValue = &bval;
 attr.ulValueLen = sizeof (bval);

 object = gkm_mock_module_find_object (0, &attr, 1);
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
 ...
 ret = gkm_wrap_login_is_usable ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 107, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
}
...
void testing__test__login_usable_fail_locked(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_wrap_login_is_usable ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 118, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 ...
 object = gkm_mock_module_find_object (0, &attr, 1);
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 126, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);

 bval = 1;
 attr.type = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 210);
 attr.pValue = &bval;
 attr.ulValueLen = sizeof (bval);
 ...
 ret = gkm_wrap_login_is_usable ();
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-keyring.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
}
...
void testing__test__login_lookup_secret_no_match(int *__unused, gconstpointer __data)
{
 ...
 password = gkm_wrap_login_lookup_secret ("invalid", "attribute",
                                          "second", "attribute", ((void *)0));
 do { const char *__s1 = (password), *__s2 = (((void *)0)); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-login-keyring.c", 146, ((const char*) (__PRETTY_FUNCTION__)), "password" " " "==" " " "NULL", __s1, "==", __s2); } while (0);
}
...
void testing__test__login_lookup_secret_and_match(int *__unused, gconstpointer __data)
{
 ...
 password = gkm_wrap_login_lookup_secret ("one", "1",
                                          "two", "2", ((void *)0));
 do { const char *__s1 = (password), *__s2 = ("mock"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "test-login-keyring.c", 156, ((const char*) (__PRETTY_FUNCTION__)), "password" " " "==" " " "\"mock\"", __s1, "==", __s2); } while (0);
...
{
 CK_OBJECT_CLASS klass = (4UL);
 CK_BBOOL tval = 1;
 CK_ATTRIBUTE attrs[] = {
  { (3UL), "Unlock password for: The label", 30 },
  { (0UL), &klass, sizeof (klass) },
  { (0x11UL), "the password", 12 },
  { (1UL), &tval, sizeof (tval) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "login", 5 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one\0" "1\0" "three\0" "3\0", 14 },
 };
 ...
 object = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
}
...
void testing__test__login_lookup_store_secret_overwrite(int *__unused, gconstpointer __data)
{
 ...
 object1 = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object1), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 206, ((const char*) (__PRETTY_FUNCTION__)), "object1" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
 ...
 object2 = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object2), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 217, ((const char*) (__PRETTY_FUNCTION__)), "object2" " " "!=" " " "0", __v1, "!=", __v2); } while (0);


 do { CK_RV __v1 = (object1), __v2 = (object2); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "object1" " " "==" " " "object2", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_lookup_store_null_secret(int *__unused, gconstpointer __data)
{
 ...
 gkm_wrap_login_attach_secret ("The label", ((void *)0),
                               "one", "1",
                               "three", "3", ((void *)0));

 object = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
}
...
void testing__test__login_lookup_store_no_attributes_not_stored(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  { (3UL), "Unlock password for: The label", 30 },
  { (0UL), &klass, sizeof (klass) },
  { (0x11UL), "the password", 0 },
  { (1UL), &tval, sizeof (tval) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "login", 5 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "", 0 },
 };

 CK_OBJECT_HANDLE object;

 gkm_wrap_login_attach_secret ("The label", "the password", ((void *)0));

 object = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 264, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "==" " " "0", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_lookup_remove_present(int *__unused, gconstpointer __data)
{
 ...
 CK_BBOOL tval = 1;
 CK_ATTRIBUTE attrs[] = {
  { (3UL), "Unlock password for: Mock", 25 },
  { (0UL), &klass, sizeof (klass) },
  { (0x11UL), "mock", 4 },
  { (1UL), &tval, sizeof (tval) },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "login", 5 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one\0" "1\0" "two\0" "2\0", 12 },
 };
 ...
 object = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 285, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);

 gkm_wrap_login_remove_secret ("one", "1", "two", "2", ((void *)0));


 object = gkm_mock_module_find_object (0, attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-login-keyring.c", 291, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "==" " " "0", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_lookup_remove_no_attributes(int *__unused, gconstpointer __data)
{
 ...
 do { guint64 __n1 = (n_objects), __n2 = (0); if (__n1 > __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-login-keyring.c", 299, ((const char*) (__PRETTY_FUNCTION__)), "n_objects" " " ">" " " "0", __n1, ">", __n2, 'i'); } while (0);


 gkm_wrap_login_remove_secret (((void *)0));

 check = gkm_mock_module_count_objects (0);
 do { guint64 __n1 = (check), __n2 = (n_objects); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "test-login-keyring.c", 305, ((const char*) (__PRETTY_FUNCTION__)), "check" " " "==" " " "n_objects", __n1, "==", __n2, 'i'); } while (0);
}
