...
# 1 "<command-line>"
# 1 "test-login-user.c"
# 22 "test-login-user.c"
# 1 "../../../config.h" 1
# 23 "test-login-user.c" 2
...
void testing__setup__login_user(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 46, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 57, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_GetSlotList) (1, &slot_id, &n_slots);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 60, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_OpenSession) (slot_id, (1UL << 2), ((void *)0), ((void *)0), &session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__teardown__login_user(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gku_prompt_dummy_have_response ()) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-login-user.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "!gku_prompt_dummy_have_response ()"); } while (0);

 rv = (module->C_CloseSession) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 session = 0;

 rv = (module->C_Finalize) (((void *)0));
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 module = ((void *)0);
}
...
void testing__test__login_fail_unsupported_so(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (0UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_skip_prompt_because_pin(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (1UL), (guchar*)"booo", 4);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_user_ok_password(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_user_bad_password_then_cancel(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 115, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_user_cancel_immediately(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_user_fail_get_session_info(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
...
void testing__test__login_user_fail_get_token_info(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_Login) (session, (1UL), ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-login-user.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
