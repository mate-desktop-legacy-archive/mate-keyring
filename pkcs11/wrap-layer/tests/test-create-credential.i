# 1 "test-create-credential.c"
# 1 "/data/projects/mate-keyring/pkcs11/wrap-layer/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "test-create-credential.c"
# 22 "test-create-credential.c"
# 1 "../../../config.h" 1
# 23 "test-create-credential.c" 2
...
void testing__setup__create_credential(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 53, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_GetSlotList) (1, &slot_id, &n_slots);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 67, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_OpenSession) (slot_id, (1UL << 2), ((void *)0), ((void *)0), &session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);


 rv = (module->C_FindObjectsInit) (session, attrs, 1);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_FindObjects) (session, &object, 1, &count);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (count), __v2 = (1); if (__v1 == __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-create-credential.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "count" " " "==" " " "1", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (object), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-create-credential.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "object" " " "!=" " " "0", __v1, "!=", __v2); } while (0);

 rv = (module->C_FindObjectsFinal) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 82, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__teardown__create_credential(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gku_prompt_dummy_have_response ()) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-create-credential.c", 89, ((const char*) (__PRETTY_FUNCTION__)), "!gku_prompt_dummy_have_response ()"); } while (0);

 object = 0;

 rv = (module->C_CloseSession) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 session = 0;

 rv = (module->C_Finalize) (((void *)0));
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 98, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 module = ((void *)0);
}
...
void testing__test__create_credential_ok_password(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attrs[] = {
  ...
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 202), &object, sizeof (object) },
  { (0x11UL), ((void *)0), 0 }
 };
 ...
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &cred);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 117, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 do { CK_RV __v1 = (cred), __v2 = (0); if (__v1 != __v2) ; else gkm_assertion_message_cmpulong (((gchar*) 0), "test-create-credential.c", 118, ((const char*) (__PRETTY_FUNCTION__)), "cred" " " "!=" " " "0", __v1, "!=", __v2); } while (0);
}
...
void testing__test__create_credential_bad_password_then_cancel(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &cred);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
...
void testing__test__create_credentiaol_cancel_immediately(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_CreateObject) (session, attrs, (sizeof (attrs) / sizeof ((attrs)[0])), &cred);
 do { CK_RV __v1 = (rv), __v2 = ((0xa0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-create-credential.c", 155, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_PIN_INCORRECT", __v1, "==", __v2); } while (0);
}
