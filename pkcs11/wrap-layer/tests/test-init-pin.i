...
void testing__setup__init_pin(int *__unused, gconstpointer __data)
{
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 46, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 ...
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 57, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_GetSlotList) (1, &slot_id, &n_slots);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 60, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_OpenSession) (slot_id, (1UL << 2), ((void *)0), ((void *)0), &session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
...
void testing__teardown__init_pin(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gku_prompt_dummy_have_response ()) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-init-pin.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "!gku_prompt_dummy_have_response ()"); } while (0);

 rv = (module->C_CloseSession) (session);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 session = 0;

 rv = (module->C_Finalize) (((void *)0));
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
 module = ((void *)0);
}
...
void testing__test__init_pin_ok_password(int *__unused, gconstpointer __data)
{
 ...
 rv = (module->C_InitPIN) (session, ((void *)0), 0);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);

 rv = (module->C_Login) (session, (1UL), (guchar*)"new", 3);
 do { CK_RV __v1 = (rv), __v2 = ((0UL)); if (__v1 == __v2) ; else gkm_assertion_message_cmprv (((gchar*) 0), "test-init-pin.c", 91, ((const char*) (__PRETTY_FUNCTION__)), "rv" " " "==" " " "CKR_OK", __v1, "==", __v2); } while (0);
}
