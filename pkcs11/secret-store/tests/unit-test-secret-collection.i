# 1 "unit-test-secret-collection.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-collection.c"
# 24 "unit-test-secret-collection.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-collection.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-collection.c" 2
# 1 "test-secret-module.h" 1
# 29 "test-secret-module.h"
# 1 "./../../gkm/gkm-types.h" 1
# 25 "./../../gkm/gkm-types.h"
...
# 30 "test-secret-module.h" 2
# 1 "./../gkm-secret-types.h" 1
# 26 "./../gkm-secret-types.h"
...
void test_secret_collection_populate (GkmSecretCollection *collection,
                                                                    GkmSecretData *sdata);
# 28 "unit-test-secret-collection.c" 2

# 1 "./../gkm-secret-data.h" 1
# 27 "./../gkm-secret-data.h"
# 1 "./../gkm-secret-types.h" 1
# 28 "./../gkm-secret-data.h" 2
# 38 "./../gkm-secret-data.h"
...
void gkm_secret_data_set_master (GkmSecretData *self,
                                                      GkmSecret *master);
# 30 "unit-test-secret-collection.c" 2
# 1 "./../gkm-secret-collection.h" 1
# 27 "./../gkm-secret-collection.h"
# 1 "./../gkm-secret-object.h" 1
# 27 "./../gkm-secret-object.h"
...
gboolean gkm_object_has_attribute_boolean (GkmObject *self,
                                                          ...
                                                          CK_ATTRIBUTE_TYPE type,
                                                          gboolean value);
# 28 "./../gkm-secret-object.h" 2
# 38 "./../gkm-secret-object.h"
...
# 28 "./../gkm-secret-collection.h" 2
# 38 "./../gkm-secret-collection.h"
...
GkmFactory* gkm_secret_collection_get_factory (void) __attribute__((__const__));
...
void gkm_secret_collection_set_lock_after (GkmSecretCollection *self,
                                                            gint lock_timeout);
# 31 "unit-test-secret-collection.c" 2
# 1 "./../gkm-secret-item.h" 1
# 28 "./../gkm-secret-item.h"
# 1 "./../gkm-secret-collection.h" 1
# 29 "./../gkm-secret-item.h" 2
# 39 "./../gkm-secret-item.h"
...
GkmFactory* gkm_secret_item_get_factory (void) __attribute__((__const__));
...
void gkm_secret_item_set_schema (GkmSecretItem *self,
                                                               const gchar *type);
# 32 "unit-test-secret-collection.c" 2

# 1 "./../../gkm/gkm-credential.h" 1
# 27 "./../../gkm/gkm-credential.h"
# 1 "./../../gkm/gkm-object.h" 1
# 28 "./../../gkm/gkm-credential.h" 2
# 39 "./../../gkm/gkm-credential.h"
...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 35 "unit-test-secret-collection.c" 2
...
# 36 "unit-test-secret-collection.c" 2
...
# 38 "unit-test-secret-collection.c" 2
...
static GkmSecretCollection *collection = ((void *)0);

void testing__setup__secret_collection(int *__unused, gconstpointer __data)
{
 CK_OBJECT_CLASS klass = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 100);
 GkmObject *cred;
 ...
 session = test_secret_module_open_session ((!(0)));

 collection = g_object_new ((gkm_secret_collection_get_type ()),
                            "module", module,
                            "identifier", "test",
                            ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((collection)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 68, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (collection)"); } while (0);


 cred = gkm_session_create_object_for_factory (session, (gkm_credential_get_factory ()), ((void *)0),
                                             attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (cred != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 73, ((const char*) (__PRETTY_FUNCTION__)), "cred != NULL"); } while (0);
 credential = gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);

 cred = gkm_session_create_object_for_factory (session, (gkm_credential_get_factory ()), ((void *)0),
                                             attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (cred != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "cred != NULL"); } while (0);
 credential2 = gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);
}
...
void testing__test__secret_collection_is_locked(int *__unused, gconstpointer __data)
{
 ...
 locked = gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_secret_object_get_type ())))))), session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (locked == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 102, ((const char*) (__PRETTY_FUNCTION__)), "locked == TRUE"); } while (0);
}
...
void testing__test__secret_collection_unlocked_data(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))), ((void *)0), 0, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 113, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);


 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_DATA (sdata)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_secret_object_get_type ())))))), session)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 120, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_object_is_locked (GKM_SECRET_OBJECT (collection), session)"); } while (0);
...
void testing__test__secret_collection_get_filename(int *__unused, gconstpointer __data)
{
 ...
 other = g_object_new ((gkm_secret_collection_get_type ()),
                       "module", module,
                       "identifier", "test",
 ...
 do { const char *__s1 = (filename), *__s2 = ("/tmp/filename.keyring"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-collection.c", 136, ((const char*) (__PRETTY_FUNCTION__)), "filename" " " "==" " " "\"/tmp/filename.keyring\"", __s1, "==", __s2); } while (0);
...
void testing__test__secret_collection_set_filename(int *__unused, gconstpointer __data)
{
 ...
 do { const char *__s1 = (filename), *__s2 = ("/tmp/filename.keyring"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-collection.c", 148, ((const char*) (__PRETTY_FUNCTION__)), "filename" " " "==" " " "\"/tmp/filename.keyring\"", __s1, "==", __s2); } while (0);
}
...
void testing__test__secret_collection_has_item(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 156, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
}
...
void testing__test__secret_collection_load_unlock_plain(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 173, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))), ((void *)0), 0, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);

 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sdata != ((void *)0) && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "sdata != NULL && GKM_IS_SECRET_DATA (sdata)"); } while (0);
...
void testing__test__secret_collection_load_unlock_encrypted(int *__unused, gconstpointer __data)
{
 ...
 res = gkm_secret_collection_load (collection);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 201, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"my-keyring-password", 19, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 206, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);

 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sdata != ((void *)0) && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 211, ((const char*) (__PRETTY_FUNCTION__)), "sdata != NULL && GKM_IS_SECRET_DATA (sdata)"); } while (0);
 test_secret_collection_validate (collection, sdata);
 g_object_unref (sdata);
}
...
void testing__test__secret_collection_load_unlock_bad_password(int *__unused, gconstpointer __data)
{
 ...
 res = gkm_secret_collection_load (collection);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 229, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"wrong", 5, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0xa0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 234, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_PIN_INCORRECT"); } while (0);
}
...
void testing__test__secret_collection_unlock_without_load(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"my-keyring-password", 19, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 251, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);

 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sdata != ((void *)0) && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 256, ((const char*) (__PRETTY_FUNCTION__)), "sdata != NULL && GKM_IS_SECRET_DATA (sdata)"); } while (0);
 test_secret_collection_validate (collection, sdata);
 g_object_unref (sdata);
}
...
void testing__test__secret_collection_twice_unlock(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"my-keyring-password", 19, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 275, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"my-keyring-password", 19, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 282, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);

 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sdata != ((void *)0) && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 287, ((const char*) (__PRETTY_FUNCTION__)), "sdata != NULL && GKM_IS_SECRET_DATA (sdata)"); } while (0);
 test_secret_collection_validate (collection, sdata);
 g_object_unref (sdata);
}
...
void testing__test__secret_collection_twice_unlock_bad_password(int *__unused, gconstpointer __data)
{
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                                (guchar*)"my-keyring-password", 19, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 306, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);
 ...
 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"wrong", 5, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0xa0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 313, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_PIN_INCORRECT"); } while (0);

 sdata = gkm_secret_collection_unlocked_use (collection, session);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (sdata != ((void *)0) && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((sdata)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 316, ((const char*) (__PRETTY_FUNCTION__)), "sdata != NULL && GKM_IS_SECRET_DATA (sdata)"); } while (0);
 test_secret_collection_validate (collection, sdata);
 g_object_unref (sdata);
}
...
void testing__test__secret_collection_memory_unlock(int *__unused, gconstpointer __data)
{
 ...
 res = gkm_secret_collection_load (collection);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 329, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             ((void *)0), 0, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 334, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 gkm_session_add_session_object (session, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((cred)), ((gkm_object_get_type ())))))));
 g_object_unref (cred);
}
...
void testing__test__secret_collection_memory_unlock_bad_password(int *__unused, gconstpointer __data)
{
 ...
 res = gkm_secret_collection_load (collection);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 347, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 rv = gkm_credential_create (module, gkm_session_get_manager (session), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))),
                             (guchar*)"wrong", 5, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0xa0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 352, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_PIN_INCORRECT"); } while (0);
}

void testing__test__secret_collection_factory(int *__unused, gconstpointer __data)
{
 CK_OBJECT_CLASS klass = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 110);
 GkmObject *object;

 CK_ATTRIBUTE attrs[] = {
  { (0UL), &klass, sizeof (klass) },
  { (3UL), "blah", 4 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 204), &credential, sizeof (credential) },
 };

 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 368, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 369, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 do { const char *__s1 = (gkm_secret_object_get_label (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))))), *__s2 = ("blah"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-collection.c", 371, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_label (GKM_SECRET_OBJECT (object))" " " "==" " " "\"blah\"", __s1, "==", __s2); } while (0);
...
void testing__test__secret_collection_factory_unnamed(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 388, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 389, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 identifier = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 do { const char *__s1 = (identifier), *__s2 = (""); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-collection.c", 392, ((const char*) (__PRETTY_FUNCTION__)), "identifier" " " "!=" " " "\"\"", __s1, "!=", __s2); } while (0);
 g_object_unref (object);
}
...
void testing__test__secret_collection_factory_token(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 412, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 413, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 identifier = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (strstr (identifier, "blah")) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 416, ((const char*) (__PRETTY_FUNCTION__)), "strstr (identifier, \"blah\")"); } while (0);
 g_object_unref (object);
}
...
void testing__test__secret_collection_factory_duplicate(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 434, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 435, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 identifier1 = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (strstr (identifier1, "blah")) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 438, ((const char*) (__PRETTY_FUNCTION__)), "strstr (identifier1, \"blah\")"); } while (0);
 g_object_unref (object);
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 445, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 446, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 identifier2 = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (strstr (identifier2, "blah")) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 449, ((const char*) (__PRETTY_FUNCTION__)), "strstr (identifier2, \"blah\")"); } while (0);
 g_object_unref (object);

 do { const char *__s1 = (identifier1), *__s2 = (identifier2); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-collection.c", 452, ((const char*) (__PRETTY_FUNCTION__)), "identifier1" " " "!=" " " "identifier2", __s1, "!=", __s2); } while (0);
}

void testing__test__secret_collection_factory_item(int *__unused, gconstpointer __data)
{
 CK_OBJECT_CLASS c_klass = ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 110);
 CK_OBJECT_CLASS i_klass = (4UL);
 const gchar *identifier;
 GkmObject *object;
 CK_BBOOL token = 1;

 CK_ATTRIBUTE c_attrs[] = {
  { (0UL), &c_klass, sizeof (c_klass) },
  { (1UL), &token, sizeof (token) },
  { (3UL), "three", 5 },
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 204), &credential, sizeof (credential) },
 };
 ...
 CK_ATTRIBUTE i_attrs[] = {
  { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), ((void *)0), 0 },
  { (0UL), &i_klass, sizeof (i_klass) },
  { (1UL), &token, sizeof (token) },
  { (3UL), "Item", 4 },
 };

 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 c_attrs, (sizeof (c_attrs) / sizeof ((c_attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 479, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 480, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);
 identifier = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 g_object_unref (object);

 i_attrs[0].pValue = (gpointer)identifier;
 i_attrs[0].ulValueLen = strlen (identifier);
 object = gkm_session_create_object_for_factory (session, (gkm_secret_item_get_factory ()), ((void *)0),
                                                 i_attrs, (sizeof (i_attrs) / sizeof ((i_attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 488, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 489, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (object)"); } while (0);
 g_object_unref (object);
}
...
void testing__test__secret_collection_token_remove(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 attrs, (sizeof (attrs) / sizeof ((attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 509, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 510, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);

 transaction = gkm_transaction_new ();
 gkm_module_remove_token_object (module, transaction, object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 514, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
...
void testing__test__secret_collection_token_item_remove(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_collection_get_factory ()), ((void *)0),
                                                 c_attrs, (sizeof (c_attrs) / sizeof ((c_attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 545, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 546, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (object)"); } while (0);
 identifier = gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_object_get_type ())))))));
 g_object_unref (object);
 ...
 object = gkm_session_create_object_for_factory (session, (gkm_secret_item_get_factory ()), ((void *)0),
                                                 i_attrs, (sizeof (i_attrs) / sizeof ((i_attrs)[0])));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 554, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 555, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (object)"); } while (0);

 transaction = gkm_transaction_new ();
 gkm_module_remove_token_object (module, transaction, object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-collection.c", 559, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 gkm_transaction_complete (transaction);
 g_object_unref (transaction);
 g_object_unref (object);
}
