# 1 "unit-test-secret-binary.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-binary.c"
# 24 "unit-test-secret-binary.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-binary.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-binary.c" 2
...
void test_secret_collection_populate (GkmSecretCollection *collection,
                                                                    GkmSecretData *sdata);
# 28 "unit-test-secret-binary.c" 2

# 1 "./../gkm-secret-binary.h" 1
# 25 "./../gkm-secret-binary.h"
...
GkmDataResult gkm_secret_binary_write (GkmSecretCollection *collection,
                                                      ...
                                                      guchar **data,
                                                      gsize *n_data);
# 30 "unit-test-secret-binary.c" 2
# 1 "./../gkm-secret-collection.h" 1
# 31 "unit-test-secret-binary.c" 2
...
void gkm_secret_data_set_master (GkmSecretData *self,
                                                      GkmSecret *master);
# 32 "unit-test-secret-binary.c" 2
...
gboolean gkm_secret_fields_get_compat_hashed_uint32 (GHashTable *fields,
                                                               const gchar *name,
                                                               guint32 *value);
# 33 "unit-test-secret-binary.c" 2
...
void gkm_secret_item_set_schema (GkmSecretItem *self,
                                                               const gchar *type);
# 34 "unit-test-secret-binary.c" 2
...
# 36 "unit-test-secret-binary.c" 2
...
# 38 "unit-test-secret-binary.c" 2
...
void testing__setup__binary(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((collection)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 68, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (collection)"); } while (0);
...
void testing__test__binary_read(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 99, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}
...
void testing__test__binary_read_wrong_format(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 112, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);
}
...
void testing__test__binary_read_wrong_master(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 130, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);
}
...
void testing__test__binary_read_sdata_but_no_master(int *__unused, gconstpointer __data)
{
 ...
 gkm_secret_data_set_master (sdata, ((void *)0));

 data = testing_data_read ("encrypted.keyring", &n_data);
 res = gkm_secret_binary_read (collection, sdata, data, n_data);
 g_free (data);

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 145, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);
}
...
void testing__test__binary_write(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 157, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 158, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);


 res = gkm_secret_binary_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}
...
void testing__test__binary_remove_unavailable(int *__unused, gconstpointer __data)
{
 ...
 data = testing_data_read ("encrypted.keyring", &n_data);
 res = gkm_secret_binary_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 175, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (2); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-binary.c", 179, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "2", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);
 ...
 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (5); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-binary.c", 187, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "5", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);


 res = gkm_secret_binary_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-binary.c", 192, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (2); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-binary.c", 196, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "2", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);
