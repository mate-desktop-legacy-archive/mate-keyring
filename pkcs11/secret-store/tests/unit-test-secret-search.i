# 1 "unit-test-secret-search.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-search.c"
# 24 "unit-test-secret-search.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-search.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-search.c" 2
...
void test_secret_collection_populate (GkmSecretCollection *collection,
                                                                    GkmSecretData *sdata);
# 28 "unit-test-secret-search.c" 2
...
void gkm_secret_collection_set_lock_after (GkmSecretCollection *self,
                                                            gint lock_timeout);
# 30 "unit-test-secret-search.c" 2
...
gboolean gkm_secret_fields_get_compat_hashed_uint32 (GHashTable *fields,
                                                               const gchar *name,
                                                               guint32 *value);
# 31 "unit-test-secret-search.c" 2
...
void gkm_secret_item_set_schema (GkmSecretItem *self,
                                                               const gchar *type);
# 32 "unit-test-secret-search.c" 2
# 1 "./../gkm-secret-search.h" 1
# 40 "./../gkm-secret-search.h"
...
GType gkm_secret_search_get_type (void) __attribute__((__const__));

GkmFactory* gkm_secret_search_get_factory (void) __attribute__((__const__));
...
# 33 "unit-test-secret-search.c" 2
...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 35 "unit-test-secret-search.c" 2
...
# 36 "unit-test-secret-search.c" 2
...
# 38 "unit-test-secret-search.c" 2
...
static GkmFactory *factory = ((void *)0);
static GkmSecretCollection *collection = ((void *)0);
static GkmSecretItem *item = ((void *)0);
...
void testing__setup__secret_search(int *__unused, gconstpointer __data)
{
 ...
 factory = (gkm_secret_search_get_factory ());
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (factory) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 58, ((const char*) (__PRETTY_FUNCTION__)), "factory"); } while (0);
 ...
 gkm_object_expose (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ())))))), (!(0)));
}
...
void testing__test__create_search_incomplete(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_complete_and_unref (transaction) == (0xd0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_complete_and_unref (transaction) == CKR_TEMPLATE_INCOMPLETE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "object == NULL"); } while (0);
}

void testing__test__create_search_bad_fields(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "bad-value", 9 },
 };
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_complete_and_unref (transaction) == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 107, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_complete_and_unref (transaction) == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 108, ((const char*) (__PRETTY_FUNCTION__)), "object == NULL"); } while (0);
}

void testing__test__create_search(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "test\0value\0two\0value2", 22 },
 };
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 126, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);

 if (!gkm_object_get_attribute_ulong (object, session, (0UL), &vulong))
  do { g_assertion_message (((gchar*) 0), "unit-test-secret-search.c", 130, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vulong == ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 111)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 131, ((const char*) (__PRETTY_FUNCTION__)), "vulong == CKO_G_SEARCH"); } while (0);

 if (!gkm_object_get_attribute_boolean (object, session, (0x170UL), &vbool))
  do { g_assertion_message (((gchar*) 0), "unit-test-secret-search.c", 134, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vbool == 1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 135, ((const char*) (__PRETTY_FUNCTION__)), "vbool == CK_TRUE"); } while (0);

 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 138, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == attrs[0].ulValueLen) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 139, ((const char*) (__PRETTY_FUNCTION__)), "vsize == attrs[0].ulValueLen"); } while (0);
 g_free (vdata);

 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 0"); } while (0);
 g_free (vdata);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 150, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 0"); } while (0);
 g_free (vdata);


 fields = gkm_secret_search_get_fields (((((GkmSecretSearch*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_search_get_type ())))))));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (fields) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 155, ((const char*) (__PRETTY_FUNCTION__)), "fields"); } while (0);
 do { const char *__s1 = (gkm_secret_fields_get (fields, "test")), *__s2 = ("value"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-search.c", 156, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_fields_get (fields, \"test\")" " " "==" " " "\"value\"", __s1, "==", __s2); } while (0);


 identifier = gkm_secret_search_get_collection_id (((((GkmSecretSearch*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_secret_search_get_type ())))))));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 160, ((const char*) (__PRETTY_FUNCTION__)), "identifier == NULL"); } while (0);
...
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "name1\0value1\0name2\0value2", 26 },
 };
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 181, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == sizeof (CK_OBJECT_HANDLE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "vsize == sizeof (CK_OBJECT_HANDLE)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 183, ((const char*) (__PRETTY_FUNCTION__)), "*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (GKM_OBJECT (item))"); } while (0);
 g_free (vdata);
...
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "name1\0value1", 13 },
 };
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 206, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 207, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 211, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 0"); } while (0);
 g_free (vdata);
 ...
 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 223, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == sizeof (CK_OBJECT_HANDLE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 224, ((const char*) (__PRETTY_FUNCTION__)), "vsize == sizeof (CK_OBJECT_HANDLE)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 225, ((const char*) (__PRETTY_FUNCTION__)), "*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (GKM_OBJECT (item))"); } while (0);
 g_free (vdata);
...
void testing__test__create_search_and_change_to_not_match(int *__unused, gconstpointer __data)
{
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 1);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 244, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 248, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == sizeof (CK_OBJECT_HANDLE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 249, ((const char*) (__PRETTY_FUNCTION__)), "vsize == sizeof (CK_OBJECT_HANDLE)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 250, ((const char*) (__PRETTY_FUNCTION__)), "*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (GKM_OBJECT (item))"); } while (0);
 g_free (vdata);
 ...
 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 260, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 0"); } while (0);
 g_free (vdata);
...
void testing__test__create_search_for_bad_collection(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "name1\0value1", 13 },
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "bad-collection", 14 },
 };
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_complete_and_unref (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 277, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_complete_and_unref (transaction) == CKR_OK"); } while (0);
...
void testing__test__create_search_for_collection(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "name1\0value1", 13 },
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "test-collection", 15 },
 };
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 2);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 294, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 295, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214) , &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 299, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 15) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 300, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 15"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (vdata, "test-collection", 15) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 301, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (vdata, \"test-collection\", 15) == 0"); } while (0);
 g_free (vdata);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vdata) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 306, ((const char*) (__PRETTY_FUNCTION__)), "vdata"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == sizeof (CK_OBJECT_HANDLE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 307, ((const char*) (__PRETTY_FUNCTION__)), "vsize == sizeof (CK_OBJECT_HANDLE)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 308, ((const char*) (__PRETTY_FUNCTION__)), "*((CK_OBJECT_HANDLE_PTR)vdata) == gkm_object_get_handle (GKM_OBJECT (item))"); } while (0);
 g_free (vdata);
...
{
 CK_ATTRIBUTE attrs[] = {
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "test\0value", 11 },
         { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), "test-collection", 15 },
 };
 ...
 ocoll = g_object_new ((gkm_secret_collection_get_type ()),
                       "module", module,
                       "manager", gkm_session_get_manager (session),
                       "identifier", "other-collection",
                       ((void *)0));
 oitem = gkm_secret_collection_new_item (ocoll, "other-item");
 gkm_object_expose (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((ocoll)), ((gkm_object_get_type ())))))), (!(0)));
 ...
 object = gkm_session_create_object_for_factory (session, factory, ((void *)0), attrs, 2);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (object != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 343, ((const char*) (__PRETTY_FUNCTION__)), "object != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_search_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 344, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_SEARCH (object)"); } while (0);


 vdata = gkm_object_get_attribute_data (object, session, ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 215), &vsize);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (vsize == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-search.c", 348, ((const char*) (__PRETTY_FUNCTION__)), "vsize == 0"); } while (0);
 g_free (vdata);
