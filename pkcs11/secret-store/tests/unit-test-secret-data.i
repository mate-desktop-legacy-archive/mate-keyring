# 1 "unit-test-secret-data.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-data.c"
# 24 "unit-test-secret-data.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-data.c" 2
...
{
 GkmSecretData *data = g_object_new ((gkm_secret_data_get_type ()), ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gkm_secret_data_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 42, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_DATA (data)"); } while (0);
 g_object_unref (data);
}
...
void testing__test__secret_data_get_set(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((check)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 56, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (check)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (secret == check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 57, ((const char*) (__PRETTY_FUNCTION__)), "secret == check"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (check, (guchar*)"barn", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 58, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (check, (guchar*)\"barn\", -1)"); } while (0);
...
void testing__test__secret_data_get_raw(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (raw) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "raw"); } while (0);
 do { guint64 __n1 = (n_raw), __n2 = (4); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-data.c", 75, ((const char*) (__PRETTY_FUNCTION__)), "n_raw" " " "==" " " "4", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (raw, "barn", 4) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 76, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (raw, \"barn\", 4) == 0"); } while (0);

 raw = gkm_secret_data_get_raw (data, "not-identifier", &n_raw);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (raw == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "raw == NULL"); } while (0);
...
void testing__test__secret_data_remove(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((secret)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (secret)"); } while (0);

 gkm_secret_data_remove_secret (data, "my-identifier");
 secret = gkm_secret_data_get_secret (data, "my-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 97, ((const char*) (__PRETTY_FUNCTION__)), "!secret"); } while (0);
...
void testing__test__secret_data_set_transacted(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 110, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 111, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);


 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 115, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 116, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);
...
void testing__test__secret_data_set_transacted_replace(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == old) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 132, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == old"); } while (0);


 gkm_secret_data_set_transacted (data, transaction, "my-identifier", secret);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 136, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);


 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 141, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 142, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);
...
void testing__test__secret_data_set_transacted_fail(int *__unused, gconstpointer __data)
{
 ...
 gkm_secret_data_set_transacted (data, transaction, "my-identifier", secret);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 158, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);


 gkm_transaction_fail (transaction, (1UL));
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 164, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 165, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == NULL"); } while (0);
...
void testing__test__secret_data_set_transacted_fail_revert(int *__unused, gconstpointer __data)
{
 ...
 gkm_secret_data_set_secret (data, "my-identifier", old);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == old) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 181, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == old"); } while (0);


 gkm_secret_data_set_transacted (data, transaction, "my-identifier", secret);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 185, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == secret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 186, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == secret"); } while (0);


 gkm_transaction_fail (transaction, (1UL));
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 191, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_data_get_secret (data, "my-identifier") == old) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 192, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_data_get_secret (data, \"my-identifier\") == old"); } while (0);
...
void testing__test__secret_data_get_set_master(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((check)); GType __t = ((gkm_secret_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 210, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET (check)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (master == check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 211, ((const char*) (__PRETTY_FUNCTION__)), "master == check"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_equals (check, (guchar*)"master", -1)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-data.c", 212, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_equals (check, (guchar*)\"master\", -1)"); } while (0);
