# 1 "unit-test-secret-object.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-object.c"
# 24 "unit-test-secret-object.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-object.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-object.c" 2
...
void test_secret_collection_populate (GkmSecretCollection *collection,
                                                                    GkmSecretData *sdata);
# 28 "unit-test-secret-object.c" 2
...
# 30 "unit-test-secret-object.c" 2
...
# 32 "unit-test-secret-object.c" 2
...
# 34 "unit-test-secret-object.c" 2
...
static GkmSecretObject *object = ((void *)0);
...
void testing__setup__secret_object(int *__unused, gconstpointer __data)
{
 ...
 object = g_object_new ((gkm_secret_object_get_type ()),
                        "module", module,
                        "identifier", "my-identifier",
                        ((void *)0));

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gkm_secret_object_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 55, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_OBJECT (object)"); } while (0);
}
...
void testing__test__secret_object_is_locked(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_object_is_locked (object, session)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 71, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_object_is_locked (object, session)"); } while (0);
}
...
void testing__test__secret_object_identifier_prop(int *__unused, gconstpointer __data)
{
 ...
 do { const char *__s1 = (identifier), *__s2 = ("my-identifier"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "identifier" " " "==" " " "\"my-identifier\"", __s1, "==", __s2); } while (0);
}
...
was_notified (GObject *obj, GParamSpec *pspec, gpointer user_data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((obj)), ((gkm_secret_object_get_type ())))))) == object) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 85, ((const char*) (__PRETTY_FUNCTION__)), "GKM_SECRET_OBJECT (obj) == object"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (user_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "user_data"); } while (0);
 *notified = (!(0));
}
...
void testing__test__secret_object_created_prop(int *__unused, gconstpointer __data)
{
 ...
 gboolean notified = (0);
 g_signal_connect_data ((object), ("notify::created"), (((GCallback) (was_notified))), (&notified), ((void *)0), (GConnectFlags) 0);


 created = gkm_secret_object_get_created (object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (created == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "created == 0"); } while (0);


 gkm_secret_object_set_created (object, 1247930171);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "notified"); } while (0);
 created = gkm_secret_object_get_created (object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (created == 1247930171) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "created == 1247930171"); } while (0);
}
...
void testing__test__secret_object_modified_prop(int *__unused, gconstpointer __data)
{
 ...
 gboolean notified = (0);
 g_signal_connect_data ((object), ("notify::modified"), (((GCallback) (was_notified))), (&notified), ((void *)0), (GConnectFlags) 0);


 modified = gkm_secret_object_get_modified (object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (modified == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 119, ((const char*) (__PRETTY_FUNCTION__)), "modified == 0"); } while (0);


 gkm_secret_object_set_modified (object, 1247930171);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 123, ((const char*) (__PRETTY_FUNCTION__)), "notified"); } while (0);
 modified = gkm_secret_object_get_modified (object);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (modified == 1247930171) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "modified == 1247930171"); } while (0);
}
...
void testing__test__secret_object_was_modified(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (tv.tv_sec == gkm_secret_object_get_modified (object)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 133, ((const char*) (__PRETTY_FUNCTION__)), "tv.tv_sec == gkm_secret_object_get_modified (object)"); } while (0);
}
...
void testing__test__secret_object_label_prop(int *__unused, gconstpointer __data)
{
 ...
 gboolean notified = (0);
 g_signal_connect_data ((object), ("notify::label"), (((GCallback) (was_notified))), (&notified), ((void *)0), (GConnectFlags) 0);


 label = gkm_secret_object_get_label (object);
 do { const char *__s1 = (label), *__s2 = (""); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 146, ((const char*) (__PRETTY_FUNCTION__)), "label" " " "==" " " "\"\"", __s1, "==", __s2); } while (0);


 gkm_secret_object_set_label (object, "hello");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 150, ((const char*) (__PRETTY_FUNCTION__)), "notified"); } while (0);
 label = gkm_secret_object_get_label (object);
 do { const char *__s1 = (label), *__s2 = ("hello"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 152, ((const char*) (__PRETTY_FUNCTION__)), "label" " " "==" " " "\"hello\"", __s1, "==", __s2); } while (0);
}

void testing__test__secret_object_identifier_get_attr(int *__unused, gconstpointer __data)
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { (0x102UL), buffer, 32 };
 CK_RV rv;

 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 162, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 13) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 13"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "my-identifier", 13) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 164, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"my-identifier\", 13) == 0"); } while (0);
}

void testing__test__secret_object_label_get_attr(int *__unused, gconstpointer __data)
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { (3UL), buffer, 32 };
 CK_RV rv;

 gkm_secret_object_set_label (object, "hello");
 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 175, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 5"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "hello", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"hello\", 5) == 0"); } while (0);
}

void testing__test__secret_object_label_set_attr(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attr = { (3UL), "hello", 5 };
 ...
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 190, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 191, ((const char*) (__PRETTY_FUNCTION__)), "!notified"); } while (0);

 do { const char *__s1 = (gkm_secret_object_get_label (object)), *__s2 = ("hello"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 193, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_label (object)" " " "==" " " "\"hello\"", __s1, "==", __s2); } while (0);

 gkm_transaction_complete (transaction);
 do { const char *__s1 = (gkm_secret_object_get_label (object)), *__s2 = ("hello"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 196, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_label (object)" " " "==" " " "\"hello\"", __s1, "==", __s2); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 197, ((const char*) (__PRETTY_FUNCTION__)), "notified"); } while (0);
...
void testing__test__secret_object_label_set_attr_fail(int *__unused, gconstpointer __data)
{
 ...
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_transaction_get_failed (transaction)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 216, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_transaction_get_failed (transaction)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 217, ((const char*) (__PRETTY_FUNCTION__)), "!notified"); } while (0);


 do { const char *__s1 = (gkm_secret_object_get_label (object)), *__s2 = ("hello"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 220, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_label (object)" " " "==" " " "\"hello\"", __s1, "==", __s2); } while (0);
 ...
 do { const char *__s1 = (gkm_secret_object_get_label (object)), *__s2 = ("old"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-object.c", 227, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_label (object)" " " "==" " " "\"old\"", __s1, "==", __s2); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!notified) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 228, ((const char*) (__PRETTY_FUNCTION__)), "!notified"); } while (0);
...
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 212), buffer, 32 };
 CK_RV rv;

 gkm_secret_object_set_modified (object, 1247930171);
 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 241, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 16) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 242, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 16"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "2009071815161100", 16) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 243, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"2009071815161100\", 16) == 0"); } while (0);
}

void testing__test__secret_object_created_get_attr(int *__unused, gconstpointer __data)
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 211), buffer, 32 };
 CK_RV rv;

 gkm_secret_object_set_created (object, 1247930171);
 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 254, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 16) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 255, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 16"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "2009071815161100", 16) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 256, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"2009071815161100\", 16) == 0"); } while (0);
}

void testing__test__secret_object_locked_get_attr(int *__unused, gconstpointer __data)
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 210), buffer, 32 };
 CK_RV rv;

 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gkm_object_get_type ())))))), session, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 266, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 267, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 1"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "\0", 1) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-object.c", 268, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"\\0\", 1) == 0"); } while (0);
}
