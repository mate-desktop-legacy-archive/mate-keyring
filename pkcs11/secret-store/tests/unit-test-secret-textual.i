# 1 "unit-test-secret-textual.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-textual.c"
# 24 "unit-test-secret-textual.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-textual.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-textual.c" 2
...
void test_secret_collection_populate (GkmSecretCollection *collection,
                                                                    GkmSecretData *sdata);
# 28 "unit-test-secret-textual.c" 2
...
void gkm_secret_collection_set_lock_after (GkmSecretCollection *self,
                                                            gint lock_timeout);
# 30 "unit-test-secret-textual.c" 2
...
void gkm_secret_data_set_master (GkmSecretData *self,
                                                      GkmSecret *master);
# 31 "unit-test-secret-textual.c" 2
...
gboolean gkm_secret_fields_get_compat_hashed_uint32 (GHashTable *fields,
                                                               const gchar *name,
                                                               guint32 *value);
# 32 "unit-test-secret-textual.c" 2
...
void gkm_secret_item_set_schema (GkmSecretItem *self,
                                                               const gchar *type);
# 33 "unit-test-secret-textual.c" 2
# 1 "./../gkm-secret-textual.h" 1
# 29 "./../gkm-secret-textual.h"
...
GkmDataResult gkm_secret_textual_write (GkmSecretCollection *collection,
                                                      ...
                                                      guchar **data,
                                                      gsize *n_data);
# 34 "unit-test-secret-textual.c" 2
...
# 36 "unit-test-secret-textual.c" 2
...
# 38 "unit-test-secret-textual.c" 2
...
static GkmSecretData *sdata = ((void *)0);
...
void testing__setup__textual(int *__unused, gconstpointer __data)
{
 ...
 sdata = g_object_new ((gkm_secret_data_get_type ()), ((void *)0));

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((collection)); GType __t = ((gkm_secret_collection_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_COLLECTION (collection)"); } while (0);
...
void testing__test__textual_read(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 94, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}
...
void testing__test__textual_read_wrong_format(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 107, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);
}
...
void testing__test__textual_read_bad_number(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 122, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 item = gkm_secret_collection_get_item (collection, "1");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((item)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (item)"); } while (0);
 value = gkm_secret_fields_get (gkm_secret_item_get_fields (item), "bad-number");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "value == NULL"); } while (0);
 value = gkm_secret_fields_get (gkm_secret_item_get_fields (item), "missing-number");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 129, ((const char*) (__PRETTY_FUNCTION__)), "value == NULL"); } while (0);
}
...
void testing__test__textual_write(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 141, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 142, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "n_data"); } while (0);


 res = gkm_secret_textual_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 147, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}
...
void testing__test__textual_remove_unavailable(int *__unused, gconstpointer __data)
{
 ...
 data = testing_data_read ("plain.keyring", &n_data);
 res = gkm_secret_textual_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (2); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-textual.c", 163, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "2", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);
 ...
 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (5); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-textual.c", 171, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "5", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);


 res = gkm_secret_textual_read (collection, sdata, data, n_data);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-textual.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 items = gkm_secret_collection_get_items (collection);
 do { gint64 __n1 = (g_list_length (items)), __n2 = (2); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-textual.c", 180, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "2", __n1, "==", __n2, 'i'); } while (0);
 g_list_free (items);
