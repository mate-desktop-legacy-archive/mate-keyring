# 1 "unit-test-secret-fields.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-fields.c"
# 24 "unit-test-secret-fields.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-fields.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-fields.c" 2

# 1 "./../gkm-secret-fields.h" 1
# 25 "./../gkm-secret-fields.h"
# 1 "./../../pkcs11.h" 1
# 186 "./../../pkcs11.h"
...
gboolean gkm_secret_fields_get_compat_hashed_uint32 (GHashTable *fields,
                                                               const gchar *name,
                                                               guint32 *value);
# 29 "unit-test-secret-fields.c" 2
...
# 31 "unit-test-secret-fields.c" 2
...
void testing__test__fields_boxed(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (boxed == check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 48, ((const char*) (__PRETTY_FUNCTION__)), "boxed == check"); } while (0);
}
...
void testing__test__fields_add_get_values(int *__unused, gconstpointer __data)
{
 ...
 gkm_secret_fields_add (fields, "three", ((void *)0));

 value = gkm_secret_fields_get (fields, "one");
 do { const char *__s1 = (value), *__s2 = ("value1"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 61, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value1\"", __s1, "==", __s2); } while (0);

 value = gkm_secret_fields_get (fields, "two");
 do { const char *__s1 = (value), *__s2 = ("value2"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value2\"", __s1, "==", __s2); } while (0);

 value = gkm_secret_fields_get (fields, "three");
 do { const char *__s1 = (value), *__s2 = (""); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 67, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"\"", __s1, "==", __s2); } while (0);
...
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one\0value1\0two\0value2\0three\0value3\0", 35 };
 GHashTable *fields;
 const gchar *value;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 80, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 do { guint64 __n1 = (g_hash_table_size (fields)), __n2 = (3); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 82, ((const char*) (__PRETTY_FUNCTION__)), "g_hash_table_size (fields)" " " "==" " " "3", __n1, "==", __n2, 'i'); } while (0);
 value = g_hash_table_lookup (fields, "one");
 do { const char *__s1 = (value), *__s2 = ("value1"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 84, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value1\"", __s1, "==", __s2); } while (0);
 value = g_hash_table_lookup (fields, "two");
 do { const char *__s1 = (value), *__s2 = ("value2"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 86, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value2\"", __s1, "==", __s2); } while (0);
 value = g_hash_table_lookup (fields, "three");
 do { const char *__s1 = (value), *__s2 = ("value3"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value3\"", __s1, "==", __s2); } while (0);
...
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "", 0 };
 GHashTable *fields;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 do { guint64 __n1 = (g_hash_table_size (fields)), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 102, ((const char*) (__PRETTY_FUNCTION__)), "g_hash_table_size (fields)" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);
...
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), ((void *)0), 5 };
 GHashTable *fields;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 114, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}

void testing__test__fields_parse_missing_value(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one", 3 };
 GHashTable *fields;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 124, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}

void testing__test__fields_parse_missing_terminator(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one\0value", 9 };
 GHashTable *fields;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}

void testing__test__fields_parse_not_utf8(int *__unused, gconstpointer __data)
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "one\0not\234utf8\0", 13 };
 GHashTable *fields;
 CK_RV rv;

 rv = gkm_secret_fields_parse (&attr, &fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x13UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_ATTRIBUTE_VALUE_INVALID"); } while (0);
}

void testing__test__fields_serialize(int *__unused, gconstpointer __data)
{
 gchar buffer[32];
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), buffer, 32 };
 GHashTable *fields;
 CK_RV rv;
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 158, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 11) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 11"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "one\0value1\0", 11) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 160, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"one\\0value1\\0\", 11) == 0"); } while (0);
...
{
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), ((void *)0), 0 };
 GHashTable *fields;
 CK_RV rv;
 ...
 rv = gkm_secret_fields_serialize (&attr, fields);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 175, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (attr.ulValueLen == 11) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 176, ((const char*) (__PRETTY_FUNCTION__)), "attr.ulValueLen == 11"); } while (0);
...
void testing__test__fields_add_get_compat_uint32(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 191, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { guint64 __n1 = (value), __n2 = (992); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 192, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "992", __n1, "==", __n2, 'i'); } while (0);
...
void testing__test__fields_get_compat_uint32_fail(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 207, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
...
void testing__test__fields_get_compat_hashed_string(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 222, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { const char *__s1 = (value), *__s2 = ("2063c1608d6e0baf80249c42e2be5804"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 223, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"2063c1608d6e0baf80249c42e2be5804\"", __s1, "==", __s2); } while (0);
 g_free (value);
...
void testing__test__fields_get_compat_hashed_already(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_secret_fields_get_compat_hashed_string (fields, "test", &value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 239, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { const char *__s1 = (value), *__s2 = ("e991664529cd0caeb6e9fce8fac3d611"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-fields.c", 240, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"e991664529cd0caeb6e9fce8fac3d611\"", __s1, "==", __s2); } while (0);
 g_free (value);
...
void testing__test__fields_get_compat_hashed_uint32(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 257, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { guint64 __n1 = (value), __n2 = (0x18273645 ^ val ^ (val << 16 | val >> 16)); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "0x18273645 ^ val ^ (val << 16 | val >> 16)", __n1, "==", __n2, 'i'); } while (0);
...
void testing__test__fields_get_compat_hashed_uint32_already(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_secret_fields_get_compat_hashed_uint32 (fields, "test", &value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 274, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { guint64 __n1 = (value), __n2 = (val); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 275, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "val", __n1, "==", __n2, 'i'); } while (0);
...
void testing__test__fields_get_names(int *__unused, gconstpointer __data)
{
 ...
 do { guint64 __n1 = (g_list_length (names)), __n2 = (3); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-fields.c", 292, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (names)" " " "==" " " "3", __n1, "==", __n2, 'i'); } while (0);

 for (l = names; l; l = ((l) ? (((GList *)(l))->next) : ((void *)0))) {
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (l->data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 295, ((const char*) (__PRETTY_FUNCTION__)), "l->data"); } while (0);
  if (!g_str_equal (l->data, "one") &&
      !g_str_equal (l->data, "two") &&
      !g_str_equal (l->data, "test"))
   do { g_assertion_message (((gchar*) 0), "unit-test-secret-fields.c", 299, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
 }
...
void testing__test__fields_match(int *__unused, gconstpointer __data)
{
 ...
 gkm_secret_fields_add_compat_hashed_string (haystack, "test", "2063c1608d6e0baf80249c42e2be5804");
 gkm_secret_fields_add_compat_hashed_uint32 (haystack, "number", 0x1bc735a5);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 326, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
...
void testing__test__fields_match_mismatch_value(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_secret_fields_match (haystack, needle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 345, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
...
void testing__test__fields_match_mismatch_field(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_secret_fields_match (haystack, needle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 364, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
...
void testing__test__fields_match_wrong_hashed(int *__unused, gconstpointer __data)
{
 ...
 ret = gkm_secret_fields_match (haystack, needle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-fields.c", 383, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);
