# 1 "unit-test-secret-item.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-item.c"
# 24 "unit-test-secret-item.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-item.c" 2
...
void gkm_secret_collection_set_lock_after (GkmSecretCollection *self,
                                                            gint lock_timeout);
# 30 "unit-test-secret-item.c" 2
# 1 "./../gkm-secret-fields.h" 1
# 52 "./../gkm-secret-fields.h"
...
unlock_collection(void)
{
 ...
 object = ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_object_get_type ()))))));
 rv = gkm_credential_create (gkm_object_get_module (object),
                             gkm_session_get_manager (session),
                             object, ((void *)0), 0, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 84, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
...
void testing__test__secret_item_new(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((item)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 95, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (item)"); } while (0);
 do { const char *__s1 = (gkm_secret_object_get_identifier (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_secret_object_get_type ())))))))), *__s2 = ("the-identifier"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-item.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_get_identifier (GKM_SECRET_OBJECT (item))" " " "==" " " "\"the-identifier\"", __s1, "==", __s2); } while (0);
}
...
void testing__test__secret_item_create(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((item)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (item)"); } while (0);
 g_object_ref (item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 108, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);

 gkm_transaction_complete (transaction);
 g_object_unref (transaction);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 114, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_unref (item);
}
...
void testing__test__secret_item_create_failed(int *__unused, gconstpointer __data)
{
 ...
 transaction = gkm_transaction_new ();
 item = gkm_secret_collection_create_item (collection, transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((item)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (item)"); } while (0);
 g_object_ref (item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 134, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_unref (item);
}
...
void testing__test__secret_item_destroy(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_ref (item);

 transaction = gkm_transaction_new ();
 gkm_secret_collection_destroy_item (collection, transaction, item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_collection_has_item (collection, item)"); } while (0);

 gkm_transaction_complete (transaction);
 g_object_unref (transaction);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 155, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_unref (item);
}
...
void testing__test__secret_item_destroy_failed(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 165, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_ref (item);

 transaction = gkm_transaction_new ();
 gkm_secret_collection_destroy_item (collection, transaction, item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 170, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_secret_collection_has_item (collection, item)"); } while (0);
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_has_item (collection, item)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_has_item (collection, item)"); } while (0);
 g_object_unref (item);
}
...
void testing__test__secret_item_collection_get(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((item)); GType __t = ((gkm_secret_item_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 186, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SECRET_ITEM (item)"); } while (0);

 check = gkm_secret_collection_get_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (item == check) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 189, ((const char*) (__PRETTY_FUNCTION__)), "item == check"); } while (0);
}
...
void testing__test__secret_item_collection_items(int *__unused, gconstpointer __data)
{
 ...
 do { guint64 __n1 = (g_list_length (items)), __n2 = (3); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-item.c", 202, ((const char*) (__PRETTY_FUNCTION__)), "g_list_length (items)" " " "==" " " "3", __n1, "==", __n2, 'i'); } while (0);
 for (l = items; l; l = ((l) ? (((GList *)(l))->next) : ((void *)0))) {
  ...
  if (!g_str_equal (identifier, "one-identifier") &&
   ...
   do { g_assertion_message (((gchar*) 0), "unit-test-secret-item.c", 208, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);
 }
...
void testing__test__secret_item_collection_remove(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_get_item (collection, "the-identifier") == item) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 219, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_get_item (collection, \"the-identifier\") == item"); } while (0);

 gkm_secret_collection_remove_item (collection, item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_collection_get_item (collection, "the-identifier") == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 222, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_collection_get_item (collection, \"the-identifier\") == NULL"); } while (0);
}
...
void testing__test__secret_item_is_locked(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_secret_object_get_type ())))))), session) == gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((collection)), ((gkm_secret_object_get_type ())))))), session)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 231, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_is_locked (GKM_SECRET_OBJECT (item), session) == gkm_secret_object_is_locked (GKM_SECRET_OBJECT (collection), session)"); } while (0);


 unlock_collection();

 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_secret_object_get_type ())))))), session) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 235, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_is_locked (GKM_SECRET_OBJECT (item), session) == FALSE"); } while (0);
}
...
void testing__test__secret_item_get_collection(int *__unused, gconstpointer __data)
{
 GkmSecretItem *item;
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_item_get_collection (item) == collection) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 242, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_item_get_collection (item) == collection"); } while (0);
}
...
void testing__test__secret_item_tracks_collection(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_secret_object_get_type ())))))), session) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 254, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_is_locked (GKM_SECRET_OBJECT (item), session) == FALSE"); } while (0);

 g_object_unref (collection);
 collection = ((void *)0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_item_get_collection (item) == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 260, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_item_get_collection (item) == NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_secret_object_is_locked (((((GkmSecretObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_secret_object_get_type ())))))), session) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 261, ((const char*) (__PRETTY_FUNCTION__)), "gkm_secret_object_is_locked (GKM_SECRET_OBJECT (item), session) == TRUE"); } while (0);
...
void testing__test__secret_item_get_set_fields(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check == fields) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 277, ((const char*) (__PRETTY_FUNCTION__)), "check == fields"); } while (0);
...
{
 gchar buffer[32];
 CK_ATTRIBUTE check = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 214), buffer, 32 };
 GkmSecretItem *item;
 CK_RV rv;

 item = gkm_secret_collection_new_item (collection, "the-identifier");
 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 291, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 4) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 292, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 4"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "test", 4) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 293, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"test\", 4) == 0"); } while (0);
}
...
void testing__test__secret_item_secret_attr(int *__unused, gconstpointer __data)
{
 ...
 CK_ATTRIBUTE attr = { (0x11UL), "hello", 5 };
 gchar buffer[32];
 CK_ATTRIBUTE check = { (0x11UL), buffer, 32 };
 GkmSecretItem *item;
 CK_RV rv;
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 309, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 311, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);

 g_object_unref (transaction);

 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 316, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 5) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 317, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 5"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "hello", 5) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 318, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"hello\", 5) == 0"); } while (0);
}
...
void testing__test__secret_item_secret_attr_locked(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 332, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0x101UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 334, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_USER_NOT_LOGGED_IN"); } while (0);

 g_object_unref (transaction);

 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0x101UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 339, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_USER_NOT_LOGGED_IN"); } while (0);
}

void testing__test__secret_item_fields_attr(int *__unused, gconstpointer __data)
{
 GkmTransaction *transaction = gkm_transaction_new ();
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "name1\0value1\0name2\0value2", 26 };
 gchar buffer[32];
 CK_ATTRIBUTE check = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), buffer, 32 };
 GkmSecretItem *item;
 GHashTable *fields;
 const gchar *value;
 CK_RV rv;
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 357, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 359, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_OK"); } while (0);

 g_object_unref (transaction);

 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 364, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 26) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 365, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 26"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "name1\0value1\0name2\0value2", 26) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 366, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"name1\\0value1\\0name2\\0value2\", 26) == 0"); } while (0);

 fields = gkm_secret_item_get_fields (item);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (fields) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 369, ((const char*) (__PRETTY_FUNCTION__)), "fields"); } while (0);
 value = gkm_secret_fields_get (fields, "name1");
 do { const char *__s1 = (value), *__s2 = ("value1"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-item.c", 371, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value1\"", __s1, "==", __s2); } while (0);
 value = gkm_secret_fields_get (fields, "name2");
 do { const char *__s1 = (value), *__s2 = ("value2"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-item.c", 373, ((const char*) (__PRETTY_FUNCTION__)), "value" " " "==" " " "\"value2\"", __s1, "==", __s2); } while (0);
}
...
void testing__test__secret_item_fields_attr_locked(int *__unused, gconstpointer __data)
{
 ...
 item = gkm_secret_collection_new_item (collection, "the-identifier");
 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 384, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == TRUE"); } while (0);
 gkm_transaction_complete (transaction);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_result (transaction) == (0x101UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 386, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_result (transaction) == CKR_USER_NOT_LOGGED_IN"); } while (0);
...
{
 GkmTransaction *transaction = gkm_transaction_new ();
 CK_ATTRIBUTE attr = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), "new\0value\0", 10 };
 gchar buffer[32];
 CK_ATTRIBUTE check = { ((((unsigned long) (1UL << 31)) | 0x474E4D45UL ) + 213), buffer, 32 };
 GkmSecretItem *item;
 GHashTable *fields;
 ...
 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 413, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 10) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 414, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 10"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "old\0value\0", 10) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 415, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"old\\0value\\0\", 10) == 0"); } while (0);


 gkm_object_set_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, transaction, &attr);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_transaction_get_failed (transaction) == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 419, ((const char*) (__PRETTY_FUNCTION__)), "gkm_transaction_get_failed (transaction) == FALSE"); } while (0);


 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 423, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 10) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 424, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 10"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "new\0value\0", 10) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 425, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"new\\0value\\0\", 10) == 0"); } while (0);


 gkm_transaction_fail (transaction, (1UL));
 gkm_transaction_complete (transaction);


 rv = gkm_object_get_attribute (((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((item)), ((gkm_object_get_type ())))))), session, &check);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 433, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (check.ulValueLen == 10) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 434, ((const char*) (__PRETTY_FUNCTION__)), "check.ulValueLen == 10"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (buffer, "old\0value\0", 10) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-item.c", 435, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (buffer, \"old\\0value\\0\", 10) == 0"); } while (0);
