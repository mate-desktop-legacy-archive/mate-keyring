# 1 "unit-test-secret-compat.c"
# 1 "/data/projects/mate-keyring/pkcs11/secret-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-secret-compat.c"
# 24 "unit-test-secret-compat.c"
# 1 "../../../config.h" 1
# 25 "unit-test-secret-compat.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-secret-compat.c" 2

# 1 "./../gkm-secret-compat.h" 1
# 27 "./../gkm-secret-compat.h"
typedef enum {
...
# 29 "unit-test-secret-compat.c" 2
...
void testing__test__access_free(int *__unused, gconstpointer __data)
{
 ...
 ac = (GkmSecretAccess *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (GkmSecretAccess); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (2147483647 * 2U + 1U) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
...
void testing__test__parse_item_type(int *__unused, gconstpointer __data)
{
 ...
 do { guint64 __n1 = (type), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 70, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);
 type = gkm_secret_compat_parse_item_type ("org.mate.keyring.NetworkPassword");
 do { guint64 __n1 = (type), __n2 = (1); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 72, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "1", __n1, "==", __n2, 'i'); } while (0);
 type = gkm_secret_compat_parse_item_type ("org.mate.keyring.Note");
 do { guint64 __n1 = (type), __n2 = (2); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "2", __n1, "==", __n2, 'i'); } while (0);
 type = gkm_secret_compat_parse_item_type ("org.mate.keyring.ChainedKeyring");
 do { guint64 __n1 = (type), __n2 = (3); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 76, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "3", __n1, "==", __n2, 'i'); } while (0);
 type = gkm_secret_compat_parse_item_type ("org.mate.keyring.EncryptionKey");
 do { guint64 __n1 = (type), __n2 = (4); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "4", __n1, "==", __n2, 'i'); } while (0);
 type = gkm_secret_compat_parse_item_type ("org.mate.keyring.PkStorage");
 do { guint64 __n1 = (type), __n2 = (0x100); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 80, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "0x100", __n1, "==", __n2, 'i'); } while (0);


 type = gkm_secret_compat_parse_item_type ("invalid");
 do { guint64 __n1 = (type), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 84, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);


 type = gkm_secret_compat_parse_item_type (((void *)0));
 do { guint64 __n1 = (type), __n2 = (0); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-secret-compat.c", 88, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "0", __n1, "==", __n2, 'i'); } while (0);
}
...
void testing__test__format_item_type(int *__unused, gconstpointer __data)
{
 ...
 do { const char *__s1 = (type), *__s2 = ("org.freedesktop.Secret.Generic"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 96, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.freedesktop.Secret.Generic\"", __s1, "==", __s2); } while (0);
 type = gkm_secret_compat_format_item_type (1);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.NetworkPassword"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 98, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.NetworkPassword\"", __s1, "==", __s2); } while (0);
 type = gkm_secret_compat_format_item_type (2);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.Note"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 100, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.Note\"", __s1, "==", __s2); } while (0);
 type = gkm_secret_compat_format_item_type (3);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.ChainedKeyring"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 102, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.ChainedKeyring\"", __s1, "==", __s2); } while (0);
 type = gkm_secret_compat_format_item_type (4);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.EncryptionKey"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.EncryptionKey\"", __s1, "==", __s2); } while (0);
 type = gkm_secret_compat_format_item_type (0x100);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.PkStorage"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.PkStorage\"", __s1, "==", __s2); } while (0);


 type = gkm_secret_compat_format_item_type (0xF0000001);
 do { const char *__s1 = (type), *__s2 = ("org.mate.keyring.NetworkPassword"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-secret-compat.c", 110, ((const char*) (__PRETTY_FUNCTION__)), "type" " " "==" " " "\"org.mate.keyring.NetworkPassword\"", __s1, "==", __s2); } while (0);


 type = gkm_secret_compat_format_item_type (32);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-secret-compat.c", 114, ((const char*) (__PRETTY_FUNCTION__)), "type == NULL"); } while (0);
}
