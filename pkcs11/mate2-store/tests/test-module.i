...
# 1 "./../gkm-mate2-store.h" 1
# 25 "./../gkm-mate2-store.h"
# 1 "../../../pkcs11/pkcs11.h" 1
# 186 "../../../pkcs11/pkcs11.h"
...
# 26 "./../gkm-mate2-store.h" 2

CK_FUNCTION_LIST_PTR gkm_mate2_store_get_functions (void);
# 27 "test-module.c" 2
...
void testing__external__user_module(void)
{
 CK_FUNCTION_LIST_PTR funcs = gkm_mate2_store_get_functions ();
