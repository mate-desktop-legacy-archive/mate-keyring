# 1 "unit-test-mate2-file.c"
# 1 "/data/projects/mate-keyring/pkcs11/mate2-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-mate2-file.c"
# 24 "unit-test-mate2-file.c"
# 1 "test-suite.h" 1
...
# 102 "/usr/lib/gcc/i686-linux-gnu/4.4.5/include/stdarg.h" 3 4
...
gboolean gkm_object_has_attribute_boolean (GkmObject *self,
                                                          ...
                                                          CK_ATTRIBUTE_TYPE type,
                                                          gboolean value);
# 29 "unit-test-mate2-file.c" 2

# 1 "./../gkm-mate2-file.h" 1
# 27 "./../gkm-mate2-file.h"
# 1 "./../../gkm/gkm-data-types.h" 1
...
# 28 "./../gkm-mate2-file.h" 2
# 1 "./../../gkm/gkm-secret.h" 1
# 38 "./../../gkm/gkm-secret.h"
...
# 35 "unit-test-mate2-file.c" 2


static GkmMate2File *data_file = ((void *)0);
static gchar *public_filename = ((void *)0);
static gchar *private_filename = ((void *)0);
static gchar *write_filename = ((void *)0);
static int write_fd = -1;
static int public_fd = -1;
static int private_fd = -1;
static GkmSecret *login = ((void *)0);

void testing__setup__file_store(int *__unused, gconstpointer __data)
{
 ...
 public_fd = open (public_filename, 00, 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (public_fd != -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 57, ((const char*) (__PRETTY_FUNCTION__)), "public_fd != -1"); } while (0);

 private_fd = open (private_filename, 00, 0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (private_fd != -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 60, ((const char*) (__PRETTY_FUNCTION__)), "private_fd != -1"); } while (0);

 write_fd = open (write_filename, 02 | 0100 | 01000, 0400 | 0200);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (write_fd != -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 63, ((const char*) (__PRETTY_FUNCTION__)), "write_fd != -1"); } while (0);

 login = gkm_secret_new ((guchar*)"booo", 4);
}

void testing__teardown__file_store(int *__unused, gconstpointer __data)
{
...
void testing__test__test_file_create(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 97, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__test_file_write_value(int *__unused, gconstpointer __data)
{
 GkmDataResult res;


 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "public-label", 12);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 106, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);

 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 109, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "public-label", 12);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 113, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__test_file_read_value(int *__unused, gconstpointer __data)
{
 gconstpointer value = ((void *)0);
 GkmDataResult res;
 gsize n_value;
 guint number = 7778;
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 125, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_write_value (data_file, "ident", (3UL), "TWO-label", 10);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 127, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_write_value (data_file, "ident", (0x11UL), &number, sizeof (number));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 129, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_read_value (data_file, "non-existant", (3UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 133, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);


 res = gkm_mate2_file_read_value (data_file, "ident", (0x102UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 137, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);


 res = gkm_mate2_file_read_value (data_file, "ident", (0x11UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 141, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 142, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_value == sizeof (number)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 143, ((const char*) (__PRETTY_FUNCTION__)), "n_value == sizeof (number)"); } while (0);
 do { guint64 __n1 = (*((guint*)value)), __n2 = (number); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-mate2-file.c", 144, ((const char*) (__PRETTY_FUNCTION__)), "*((guint*)value)" " " "==" " " "number", __n1, "==", __n2, 'i'); } while (0);


 res = gkm_mate2_file_read_value (data_file, "ident", (3UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 148, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 149, ((const char*) (__PRETTY_FUNCTION__)), "value"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (n_value == 10) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 150, ((const char*) (__PRETTY_FUNCTION__)), "n_value == 10"); } while (0);
 do { const char *__s1 = ((const gchar*)value), *__s2 = ("TWO-label"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-mate2-file.c", 151, ((const char*) (__PRETTY_FUNCTION__)), "(const gchar*)value" " " "==" " " "\"TWO-label\"", __s1, "==", __s2); } while (0);
}

void testing__test__test_file_read(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 159, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__test_file_lookup(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 guint section;
 gboolean ret;
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 170, ((const char*) (__PRETTY_FUNCTION__)), "ret == FALSE"); } while (0);


 res = gkm_mate2_file_create_entry (data_file, "test-ident", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 174, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 ret = gkm_mate2_file_lookup_entry (data_file, "test-ident", &section);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 177, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (section == GKM_MATE2_FILE_SECTION_PUBLIC) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 178, ((const char*) (__PRETTY_FUNCTION__)), "section == GKM_MATE2_FILE_SECTION_PUBLIC"); } while (0);


 ret = gkm_mate2_file_lookup_entry (data_file, "test-ident", ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 182, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
}

void testing__test__file_read_private_without_login(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 guint section;
 gconstpointer value;
 ...
 res = gkm_mate2_file_read_fd (data_file, private_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 194, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 ret = gkm_mate2_file_lookup_entry (data_file, "identifier-private", &section);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 198, ((const char*) (__PRETTY_FUNCTION__)), "ret"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (section == GKM_MATE2_FILE_SECTION_PRIVATE) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 199, ((const char*) (__PRETTY_FUNCTION__)), "section == GKM_MATE2_FILE_SECTION_PRIVATE"); } while (0);


 ret = gkm_mate2_file_read_value (data_file, "identifier-private", (3UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 203, ((const char*) (__PRETTY_FUNCTION__)), "ret == GKM_DATA_LOCKED"); } while (0);


 res = gkm_mate2_file_create_entry (data_file, "dummy-private", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 207, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);


 res = gkm_mate2_file_write_fd (data_file, write_fd, login);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 211, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);


 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 215, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_create_entry (data_file, "dummy-private", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 219, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__test_file_write(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 227, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "public-label", 12);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 230, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_create_entry (data_file, "identifier-two", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 233, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_write_fd (data_file, write_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 236, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__cant_write_private_without_login(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_create_entry (data_file, "identifier_private", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 244, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_write_fd (data_file, write_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 247, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);
}

void testing__test__write_private_with_login(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gulong value;

 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 256, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "public-label", 12);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 258, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_create_entry (data_file, "identifier-two", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 261, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_write_value (data_file, "identifier-two", (3UL), "TWO-label", 9);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 263, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 value = 555;
 res = gkm_mate2_file_write_value (data_file, "identifier-two", (0x11UL), &value, sizeof (value));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 266, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_create_entry (data_file, "identifier-private", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 269, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_write_value (data_file, "identifier-private", (3UL), "private-label", 13);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 271, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 res = gkm_mate2_file_write_fd (data_file, write_fd, login);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 274, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
}

void testing__test__read_private_with_login(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gconstpointer value;
 gsize n_value;
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 284, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_read_value (data_file, "identifier-private", (3UL), &value, &n_value);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 288, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { guint64 __n1 = (n_value), __n2 = (13); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-mate2-file.c", 289, ((const char*) (__PRETTY_FUNCTION__)), "n_value" " " "==" " " "13", __n1, "==", __n2, 'i'); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (memcmp (value, "private-label", 13) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 290, ((const char*) (__PRETTY_FUNCTION__)), "memcmp (value, \"private-label\", 13) == 0"); } while (0);
}

void testing__test__destroy_entry(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_destroy_entry (data_file, "non-existant");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 298, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);

 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 301, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_lookup_entry (data_file, "identifier-public", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 304, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_lookup_entry (data_file, \"identifier-public\", NULL)"); } while (0);

 res = gkm_mate2_file_destroy_entry (data_file, "identifier-public");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 307, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_mate2_file_lookup_entry (data_file, "identifier-public", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 310, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_mate2_file_lookup_entry (data_file, \"identifier-public\", NULL)"); } while (0);
}

void testing__test__destroy_entry_by_loading(int *__unused, gconstpointer __data)
{
 GkmDataResult res;


 res = gkm_mate2_file_create_entry (data_file, "my-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 319, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 res = gkm_mate2_file_create_entry (data_file, "my-private", GKM_MATE2_FILE_SECTION_PRIVATE);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 321, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 325, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_mate2_file_lookup_entry (data_file, "my-public", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 328, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_mate2_file_lookup_entry (data_file, \"my-public\", NULL)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_mate2_file_lookup_entry (data_file, "my-private", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 329, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_mate2_file_lookup_entry (data_file, \"my-private\", NULL)"); } while (0);
}


void testing__test__destroy_private_without_login(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_read_fd (data_file, private_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 338, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_lookup_entry (data_file, "identifier-private", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 341, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_lookup_entry (data_file, \"identifier-private\", NULL)"); } while (0);


 res = gkm_mate2_file_destroy_entry (data_file, "identifier-private");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_LOCKED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 345, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_LOCKED"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_lookup_entry (data_file, "identifier-private", ((void *)0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 348, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_lookup_entry (data_file, \"identifier-private\", NULL)"); } while (0);
}

static void
entry_added_one (GkmMate2File *df, const gchar *identifier, gboolean *added)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((df)); GType __t = ((gkm_mate2_file_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 354, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_MATE2_FILE (df)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (df == data_file) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 355, ((const char*) (__PRETTY_FUNCTION__)), "df == data_file"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 356, ((const char*) (__PRETTY_FUNCTION__)), "identifier"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (added) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 357, ((const char*) (__PRETTY_FUNCTION__)), "added"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!*added) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 360, ((const char*) (__PRETTY_FUNCTION__)), "!*added"); } while (0);
 *added = (!(0));
}

void testing__test__entry_added_signal(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gboolean added;

 g_signal_connect_data ((data_file), ("entry-added"), (((GCallback) (entry_added_one))), (&added), ((void *)0), (GConnectFlags) 0);


 added = (0);
 res = gkm_mate2_file_create_entry (data_file, "identifier-public", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 374, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (added == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 375, ((const char*) (__PRETTY_FUNCTION__)), "added == TRUE"); } while (0);


 added = (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 380, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (added == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 381, ((const char*) (__PRETTY_FUNCTION__)), "added == TRUE"); } while (0);
}

static void
entry_changed_one (GkmMate2File *df, const gchar *identifier, gulong type, gboolean *changed)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((df)); GType __t = ((gkm_mate2_file_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 387, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_MATE2_FILE (df)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (df == data_file) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 388, ((const char*) (__PRETTY_FUNCTION__)), "df == data_file"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 389, ((const char*) (__PRETTY_FUNCTION__)), "identifier"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 390, ((const char*) (__PRETTY_FUNCTION__)), "changed"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (type == (3UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 391, ((const char*) (__PRETTY_FUNCTION__)), "type == CKA_LABEL"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!*changed) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 394, ((const char*) (__PRETTY_FUNCTION__)), "!*changed"); } while (0);
 *changed = (!(0));
}

void testing__test__entry_changed_signal(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gboolean changed;

 g_signal_connect_data ((data_file), ("entry-changed"), (((GCallback) (entry_changed_one))), (&changed), ((void *)0), (GConnectFlags) 0);


 changed = (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 408, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 409, ((const char*) (__PRETTY_FUNCTION__)), "changed == FALSE"); } while (0);


 changed = (0);
 res = gkm_mate2_file_write_value (data_file, "non-existant", (3UL), "new-value", 10);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 414, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 415, ((const char*) (__PRETTY_FUNCTION__)), "changed == FALSE"); } while (0);


 changed = (0);
 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "new-value", 10);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 420, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 421, ((const char*) (__PRETTY_FUNCTION__)), "changed == TRUE"); } while (0);


 changed = (0);
 res = gkm_mate2_file_write_value (data_file, "identifier-public", (3UL), "new-value", 10);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 426, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 427, ((const char*) (__PRETTY_FUNCTION__)), "changed == FALSE"); } while (0);


 changed = (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (lseek (public_fd, 0, 0) != -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 431, ((const char*) (__PRETTY_FUNCTION__)), "lseek (public_fd, 0, SEEK_SET) != -1"); } while (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 433, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (changed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 434, ((const char*) (__PRETTY_FUNCTION__)), "changed == TRUE"); } while (0);
}

static void
entry_removed_one (GkmMate2File *df, const gchar *identifier, gboolean *removed)
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((df)); GType __t = ((gkm_mate2_file_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 440, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_MATE2_FILE (df)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (df == data_file) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 441, ((const char*) (__PRETTY_FUNCTION__)), "df == data_file"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 442, ((const char*) (__PRETTY_FUNCTION__)), "identifier"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (removed) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 443, ((const char*) (__PRETTY_FUNCTION__)), "removed"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!*removed) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 446, ((const char*) (__PRETTY_FUNCTION__)), "!*removed"); } while (0);
 *removed = (!(0));
}

void testing__test__entry_removed_signal(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gboolean removed;

 g_signal_connect_data ((data_file), ("entry-removed"), (((GCallback) (entry_removed_one))), (&removed), ((void *)0), (GConnectFlags) 0);


 removed = (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 460, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (removed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 461, ((const char*) (__PRETTY_FUNCTION__)), "removed == FALSE"); } while (0);


 removed = (0);
 res = gkm_mate2_file_destroy_entry (data_file, "non-existant");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_UNRECOGNIZED) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 466, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_UNRECOGNIZED"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (removed == (0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 467, ((const char*) (__PRETTY_FUNCTION__)), "removed == FALSE"); } while (0);


 removed = (0);
 res = gkm_mate2_file_destroy_entry (data_file, "identifier-public");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 472, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (removed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 473, ((const char*) (__PRETTY_FUNCTION__)), "removed == TRUE"); } while (0);


 res = gkm_mate2_file_create_entry (data_file, "extra-dummy", GKM_MATE2_FILE_SECTION_PUBLIC);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 477, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 removed = (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (lseek (public_fd, 0, 0) != -1) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 481, ((const char*) (__PRETTY_FUNCTION__)), "lseek (public_fd, 0, SEEK_SET) != -1"); } while (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 483, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (removed == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 484, ((const char*) (__PRETTY_FUNCTION__)), "removed == TRUE"); } while (0);
}
...
foreach_entry (GkmMate2File *df, const gchar *identifier, gpointer data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (data) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 494, ((const char*) (__PRETTY_FUNCTION__)), "data"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 495, ((const char*) (__PRETTY_FUNCTION__)), "identifier"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((df)); GType __t = ((gkm_mate2_file_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 496, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_MATE2_FILE (df)"); } while (0);


 for (i = 0; i < array->len; ++i) {
  ident = ((array)->pdata)[i];
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ident) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 501, ((const char*) (__PRETTY_FUNCTION__)), "ident"); } while (0);
  do { const char *__s1 = (ident), *__s2 = (identifier); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-mate2-file.c", 502, ((const char*) (__PRETTY_FUNCTION__)), "ident" " " "!=" " " "identifier", __s1, "!=", __s2); } while (0);
 }
...
void testing__test__data_file_foreach(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 GPtrArray *array;

 res = gkm_mate2_file_read_fd (data_file, private_fd, login);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 515, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);

 array = g_ptr_array_new ();
 gkm_mate2_file_foreach_entry (data_file, foreach_entry, array);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (array->len == 4) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 519, ((const char*) (__PRETTY_FUNCTION__)), "array->len == 4"); } while (0);

 g_ptr_array_add (array, ((void *)0));
 g_strfreev ((gchar**)g_ptr_array_free (array, (0)));
}

void testing__test__unique_entry(int *__unused, gconstpointer __data)
{
 GkmDataResult res;
 gchar *identifier;

 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 531, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 identifier = g_strdup ("identifier-public");
 res = gkm_mate2_file_unique_entry (data_file, &identifier);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 536, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { const char *__s1 = (identifier), *__s2 = ("identifier-public"); if (g_strcmp0 (__s1, __s2) != 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-mate2-file.c", 537, ((const char*) (__PRETTY_FUNCTION__)), "identifier" " " "!=" " " "\"identifier-public\"", __s1, "!=", __s2); } while (0);
 g_free (identifier);


 identifier = g_strdup ("identifier-unique");
 res = gkm_mate2_file_unique_entry (data_file, &identifier);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 543, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { const char *__s1 = (identifier), *__s2 = ("identifier-unique"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-mate2-file.c", 544, ((const char*) (__PRETTY_FUNCTION__)), "identifier" " " "==" " " "\"identifier-unique\"", __s1, "==", __s2); } while (0);
 g_free (identifier);


 identifier = ((void *)0);
 res = gkm_mate2_file_unique_entry (data_file, &identifier);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 550, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 551, ((const char*) (__PRETTY_FUNCTION__)), "identifier != NULL"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (identifier[0] != 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 552, ((const char*) (__PRETTY_FUNCTION__)), "identifier[0] != 0"); } while (0);
 g_free (identifier);
}

void testing__test__have_sections(int *__unused, gconstpointer __data)
{
 GkmDataResult res;

 res = gkm_mate2_file_read_fd (data_file, public_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 561, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 564, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 565, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)"); } while (0);


 res = gkm_mate2_file_read_fd (data_file, private_fd, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 569, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 572, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 573, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (lseek (private_fd, 0, 0) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 576, ((const char*) (__PRETTY_FUNCTION__)), "lseek (private_fd, 0, SEEK_SET) == 0"); } while (0);
 res = gkm_mate2_file_read_fd (data_file, private_fd, login);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 578, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 581, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 582, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (lseek (public_fd, 0, 0) == 0) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 585, ((const char*) (__PRETTY_FUNCTION__)), "lseek (public_fd, 0, SEEK_SET) == 0"); } while (0);
 res = gkm_mate2_file_read_fd (data_file, public_fd, login);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (res == GKM_DATA_SUCCESS) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 587, ((const char*) (__PRETTY_FUNCTION__)), "res == GKM_DATA_SUCCESS"); } while (0);


 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 590, ((const char*) (__PRETTY_FUNCTION__)), "gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PUBLIC)"); } while (0);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-mate2-file.c", 591, ((const char*) (__PRETTY_FUNCTION__)), "!gkm_mate2_file_have_section (data_file, GKM_MATE2_FILE_SECTION_PRIVATE)"); } while (0);
}
