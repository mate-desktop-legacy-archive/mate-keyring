# 1 "unit-test-private-key.c"
# 1 "/data/projects/mate-keyring/pkcs11/ssh-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-private-key.c"
# 24 "unit-test-private-key.c"
# 1 "test-suite.h" 1
...
# 1 "test-suite.h" 2
# 25 "unit-test-private-key.c" 2
# 1 "test-ssh-module.h" 1
# 29 "test-ssh-module.h"
# 1 "./../../gkm/gkm-types.h" 1
# 25 "./../../gkm/gkm-types.h"
...
CK_RV gkm_session_C_GenerateRandom (GkmSession* self,
                                                                         ...
                                                                         CK_ULONG random_len);
# 29 "unit-test-private-key.c" 2
# 1 "./../../gkm/gkm-module.h" 1
# 30 "unit-test-private-key.c" 2

# 1 "./../../ssh-store/gkm-ssh-private-key.h" 1
# 27 "./../../ssh-store/gkm-ssh-private-key.h"
# 1 "./../../ssh-store/gkm-ssh-public-key.h" 1
# 27 "./../../ssh-store/gkm-ssh-public-key.h"
# 1 "./../../gkm/gkm-public-xsa-key.h" 1
# 27 "./../../gkm/gkm-public-xsa-key.h"
# 1 "./../../gkm/gkm-sexp-key.h" 1
# 27 "./../../gkm/gkm-sexp-key.h"
# 1 "./../../gkm/gkm-sexp.h" 1
# 31 "./../../gkm/gkm-sexp.h"
...
# 28 "./../../gkm/gkm-sexp-key.h" 2
# 38 "./../../gkm/gkm-sexp-key.h"
...
GkmSexp* gkm_sexp_key_acquire_crypto_sexp (GkmSexpKey *self,
                                                           GkmSession *session);
# 28 "./../../gkm/gkm-public-xsa-key.h" 2
# 39 "./../../gkm/gkm-public-xsa-key.h"
...
GkmSexp* gkm_public_xsa_key_create_sexp (GkmSession *session,
                                                                 ...
                                                                 CK_ATTRIBUTE_PTR attrs,
                                                                 CK_ULONG n_attrs);
# 28 "./../../ssh-store/gkm-ssh-public-key.h" 2
# 36 "./../../ssh-store/gkm-ssh-public-key.h"
...
void gkm_ssh_public_key_set_label (GkmSshPublicKey *key,
                                                               const gchar *label);
# 28 "./../../ssh-store/gkm-ssh-private-key.h" 2

# 1 "./../../gkm/gkm-private-xsa-key.h" 1
# 39 "./../../gkm/gkm-private-xsa-key.h"
...
GkmSexp* gkm_private_xsa_key_create_sexp (GkmSession *session,
                                                                   ...
                                                                   CK_ATTRIBUTE_PTR attrs,
                                                                   CK_ULONG n_attrs);
# 30 "./../../ssh-store/gkm-ssh-private-key.h" 2
# 38 "./../../ssh-store/gkm-ssh-private-key.h"
...
void testing__setup__private_key_setup(int *__unused, gconstpointer __data)
{
 ...
 session = test_ssh_module_open_session ((!(0)));
}
...
void testing__test__private_key_parse_plain(int *__unused, gconstpointer __data)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((key)); GType __t = ((gkm_ssh_private_key_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-private-key.c", 58, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SSH_PRIVATE_KEY (key)"); } while (0);

 pub_path = testing_data_filename ("id_dsa_plain.pub");
 priv_path = testing_data_filename ("id_dsa_plain");

 ret = gkm_ssh_private_key_parse (key, pub_path, priv_path, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-private-key.c", 64, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);
...
void testing__test__private_key_parse_and_unlock(int *__unused, gconstpointer __data)
{
 ...
 key = gkm_ssh_private_key_new (module, "my-unique");
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((key)); GType __t = ((gkm_ssh_private_key_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-private-key.c", 81, ((const char*) (__PRETTY_FUNCTION__)), "GKM_IS_SSH_PRIVATE_KEY (key)"); } while (0);

 pub_path = testing_data_filename ("id_dsa_encrypted.pub");
 priv_path = testing_data_filename ("id_dsa_encrypted");

 ret = gkm_ssh_private_key_parse (key, pub_path, priv_path, ((void *)0));
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (ret == (!(0))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-private-key.c", 87, ((const char*) (__PRETTY_FUNCTION__)), "ret == TRUE"); } while (0);

 g_free (pub_path);
 g_free (priv_path);

 rv = gkm_credential_create (module, ((void *)0), ((((GkmObject*) g_type_check_instance_cast ((GTypeInstance*) ((key)), ((gkm_object_get_type ())))))), (guchar*)"password", 8, &cred);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-private-key.c", 93, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);
