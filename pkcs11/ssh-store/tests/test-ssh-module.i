...
# 1 "<command-line>"
# 1 "test-ssh-module.c"
# 24 "test-ssh-module.c"
# 1 "../../../config.h" 1
# 25 "test-ssh-module.c" 2
# 1 "test-ssh-module.h" 1
# 27 "test-ssh-module.h"
...
# 26 "./../../gkm/gkm-module.h" 2

# 1 "../../../pkcs11/pkcs11.h" 1
# 28 "./../../gkm/gkm-module.h" 2
...
CK_RV gkm_module_C_Logout (GkmModule *self,
                                                                   CK_SESSION_HANDLE session);
# 28 "test-ssh-module.c" 2

# 1 "./../../ssh-store/gkm-ssh-store.h" 1
# 27 "./../../ssh-store/gkm-ssh-store.h"
CK_FUNCTION_LIST_PTR gkm_ssh_store_get_functions (void);
# 30 "test-ssh-module.c" 2
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mutex) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-ssh-module.c", 74, ((const char*) (__PRETTY_FUNCTION__)), "mutex"); } while (0);
...
{
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (mutex) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-ssh-module.c", 81, ((const char*) (__PRETTY_FUNCTION__)), "mutex"); } while (0);
...
test_ssh_module_open_session (gboolean writable)
{
 ...
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (rv == (0UL)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-ssh-module.c", 101, ((const char*) (__PRETTY_FUNCTION__)), "rv == CKR_OK"); } while (0);

 session = gkm_module_lookup_session (module, handle);
 do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (session) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "test-ssh-module.c", 104, ((const char*) (__PRETTY_FUNCTION__)), "session"); } while (0);
