# 1 "unit-test-ssh-openssh.c"
# 1 "/data/projects/mate-keyring/pkcs11/ssh-store/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "unit-test-ssh-openssh.c"
# 24 "unit-test-ssh-openssh.c"
# 1 "../../../config.h" 1
# 25 "unit-test-ssh-openssh.c" 2
...
# 1 "test-suite.h" 2
# 27 "unit-test-ssh-openssh.c" 2

# 1 "./../gkm-ssh-openssh.h" 1
...
void testing__test__parse_public(int *__unused, gconstpointer __data)
{
 ...
 for (i = 0; i < (sizeof (PUBLIC_FILES) / sizeof ((PUBLIC_FILES)[0])); ++i) {

  data = testing_data_read (PUBLIC_FILES[i], &n_data);

  res = gkm_ssh_openssh_parse_public_key (data, n_data, &sexp, &comment);
  if (res != GKM_DATA_SUCCESS) {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "couldn't parse public key: %s", PUBLIC_FILES[i]);
   do { gint64 __n1 = (res), __n2 = (GKM_DATA_SUCCESS); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-ssh-openssh.c", 71, ((const char*) (__PRETTY_FUNCTION__)), "res" " " "==" " " "GKM_DATA_SUCCESS", __n1, "==", __n2, 'i'); } while (0);
  }

  if (!gkm_sexp_parse_key (sexp, &algorithm, &is_private, ((void *)0)))
   do { g_assertion_message (((gchar*) 0), "unit-test-ssh-openssh.c", 75, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);

  do { const char *__s1 = (comment), *__s2 = ("A public key comment"); if (g_strcmp0 (__s1, __s2) == 0) ; else g_assertion_message_cmpstr (((gchar*) 0), "unit-test-ssh-openssh.c", 77, ((const char*) (__PRETTY_FUNCTION__)), "comment" " " "==" " " "COMMENT", __s1, "==", __s2); } while (0);
  do { gint64 __n1 = (algorithm), __n2 = (0); if (__n1 != __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-ssh-openssh.c", 78, ((const char*) (__PRETTY_FUNCTION__)), "algorithm" " " "!=" " " "0", __n1, "!=", __n2, 'i'); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (!is_private) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-ssh-openssh.c", 79, ((const char*) (__PRETTY_FUNCTION__)), "!is_private"); } while (0);
...
void testing__test__parse_private(int *__unused, gconstpointer __data)
{
 ...
 for (i = 0; i < (sizeof (PRIVATE_FILES) / sizeof ((PRIVATE_FILES)[0])); ++i) {

  data = testing_data_read (PRIVATE_FILES[i], &n_data);

  res = gkm_ssh_openssh_parse_private_key (data, n_data, "password", 8, &sexp);
  if (res != GKM_DATA_SUCCESS) {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "couldn't parse private key: %s", PRIVATE_FILES[i]);
   do { gint64 __n1 = (res), __n2 = (GKM_DATA_SUCCESS); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-ssh-openssh.c", 105, ((const char*) (__PRETTY_FUNCTION__)), "res" " " "==" " " "GKM_DATA_SUCCESS", __n1, "==", __n2, 'i'); } while (0);
  }

  if (!gkm_sexp_parse_key (sexp, &algorithm, &is_private, ((void *)0)))
   do { g_assertion_message (((gchar*) 0), "unit-test-ssh-openssh.c", 109, ((const char*) (__PRETTY_FUNCTION__)), ((void *)0)); } while (0);

  do { gint64 __n1 = (algorithm), __n2 = (0); if (__n1 != __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unit-test-ssh-openssh.c", 111, ((const char*) (__PRETTY_FUNCTION__)), "algorithm" " " "!=" " " "0", __n1, "!=", __n2, 'i'); } while (0);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (is_private) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "unit-test-ssh-openssh.c", 112, ((const char*) (__PRETTY_FUNCTION__)), "is_private"); } while (0);
